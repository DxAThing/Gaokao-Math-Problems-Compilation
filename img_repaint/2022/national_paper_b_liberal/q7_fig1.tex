...
\begin{tikzpicture}[
  ...
  % Merge the return branch well clear of the update box before its single shaft arrow.
  \coordinate (loopJoin) at (0,6.87);
  % Stop the return arrow before the main-shaft junction; finish with a plain shaft.
  \coordinate (loopArrowTip) at (-0.45,6.87);
