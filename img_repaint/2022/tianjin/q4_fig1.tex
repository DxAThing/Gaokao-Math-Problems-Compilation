...
\begin{tikzpicture}[baseline]
  \begin{axis}[
    ...
    \node[anchor=east,font=\normalsize,inner sep=0pt] at (axis cs:-0.08,0) {0};
    \node[anchor=east,font=\normalsize,inner sep=0pt] at (axis cs:-0.08,0.40) {0.40};
    ...
    \node[anchor=east,font=\normalsize,inner sep=0pt] at (axis cs:-0.08,1.30) {1.30};
    \node[anchor=east,font=\normalsize,inner sep=0pt] at (axis cs:-0.08,1.55) {1.55};
    % Keep the first decimal tick visible at the axis crossing.
    \node[anchor=north east,font=\normalsize,inner sep=0pt] at (axis cs:0,-0.035) {13.55};
  \end{axis}
\end{tikzpicture}
