...
\begin{tikzpicture}[
  ...
  % Keep the return segment clear of init; stop its arrow before the junction.
  \coordinate (loopjoin) at (0,5.42);
  \coordinate (looptip) at (0.35,5.42);
  ...
  \draw (update.north) -- (3.75,5.42);
  \draw[flowarrow] (3.75,5.42) -- (looptip);
  \draw (looptip) -- (loopjoin);
