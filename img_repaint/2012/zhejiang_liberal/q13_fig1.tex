...
\begin{tikzpicture}[
  ...
  \node[process,minimum width=1.95cm,minimum height=1.00cm] (divide) at (0,-2.58) {$T=\dfrac{T}{i}$};
  ...
  \draw (init.south) -- (0,-2.00);
  \draw[->] (0,-2.00) -- (divide.north);
  ...
  \coordinate (merge-level) at (0,-2.00);
  \draw (test.east) -- node[above=2pt] {否} (loop-right) -- (2.45,-2.00);
  \draw[->] (2.45,-2.00) -- (merge-level);
\end{tikzpicture}
