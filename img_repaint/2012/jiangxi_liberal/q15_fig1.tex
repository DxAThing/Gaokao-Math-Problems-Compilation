...
\begin{tikzpicture}[
  ...
  \draw[flowarrow] (azero.south) -- (assignright) -- (assignTip);
  \draw (assignTip) -- (assignjoin);
  ...
  \draw[flowarrow] (returntop) -- (returnTip);
  \draw (returnTip) -- (firstjoin);
