...
\begin{tikzpicture}[
  ...
  % Keep the loop return 2.8 mm below init's lower edge; its arrow ends at the
  % shared merge before the independent main-stem arrow.
  ...
  \draw[->] (loop-arrow-start) -- (loop-arrow-tip) -- (merge-level);
