...
\begin{tikzpicture}[
  ...
  % The return arrowhead sits on the outer horizontal leg, not at the shared
  % merge connector; the final horizontal join is unarrowed.
  \draw (updateN.south) -- (updateN.south |- 0,0.55)
    -- (-2.05,0.55);
  \draw (-2.05,0.55) -- (-2.05,6.15);
  \draw[->] (-2.05,6.15) -- (-0.55,6.15);
  \draw (-0.55,6.15) -- (merge);
