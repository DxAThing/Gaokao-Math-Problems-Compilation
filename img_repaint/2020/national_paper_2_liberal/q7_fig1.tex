...
\begin{tikzpicture}[
  ...
  \draw[flow] (2.64,6.78) -- (2.64,6.35);
  \draw[->,flow] (2.64,6.35) -- (updatea.north);
  ...
  \coordinate (loop-bend) at (1.75,6.35);
  \coordinate (loop-merge) at (2.64,6.35);
  \draw[flow] (check.west) -- (loop-left) -- (loop-top);
  \draw[flow] (loop-top) -- (loop-bend);
  \draw[->,flow] (loop-bend) -- (loop-merge);
