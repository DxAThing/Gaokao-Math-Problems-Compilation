...
\begin{tikzpicture}[>=stealth, line width=0.45pt]
  ...
  \draw[flow] (-1.80,6.90) -- (1.90,6.90) -- (1.70,6.20) -- (-2.00,6.20) -- cycle;
  ...
  \draw[flow] (test.west) -- (-2.55,4.10) -- (-2.55,4.97)
        node[pos=0.02, above right=1pt] {是};
  \draw[->,flow] (-2.55,4.97) -- (inc.south);
  \draw[flow] (inc.north) -- (-2.55,5.82);
  \draw[->,flow] (-2.55,5.82) -- (0,5.82);
  \draw[flow] (0,5.82) -- (sum.north);
\end{tikzpicture}
