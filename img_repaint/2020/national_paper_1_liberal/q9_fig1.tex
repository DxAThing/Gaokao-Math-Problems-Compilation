...
\begin{tikzpicture}[>=stealth, line width=0.45pt]
  ...
  \draw[flow] (0,6.20) -- (0,5.90);
  \draw[->,flow] (0,5.90) -- (sum.north);
  ...
  % the shaft's own arrow continues into the sum box.
  \draw[flow] (-2.55,5.90) -- (-0.75,5.90);
  \draw[->,flow] (-0.75,5.90) -- (0,5.90);
\end{tikzpicture}
