...
\begin{tikzpicture}[baseline=(current bounding box.center), x=1cm, y=1.18cm,
  ...
  \draw[line width=0.45pt] (even.east) -- (3.10,-2.50) -- (3.10,-3.65);
  \draw[flowarrow] (3.10,-3.65) -- (sodd.north);
  ...
  \draw[line width=0.45pt] (seven.south) -- (0,-6.34);
  \draw[flowarrow] (sodd.south) -- (3.10,-6.34) -- (0,-6.34);
  \draw[flowarrow] (0,-6.34) -- (inc.north);
  ...
  \draw[flowarrow] (-3.30,-1.60) -- (0,-1.60);
