...
\begin{axis}[
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:0,-0.018) {0};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:1,-0.018) {1.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:2,-0.018) {2.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:3,-0.018) {3.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4,-0.018) {4.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:5,-0.018) {5.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:6,-0.018) {6.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:7,-0.018) {7.5};
    ...
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.05) {0.05};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.10) {0.10};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.15) {0.15};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.20) {0.20};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.30) {0.30};

    \node[anchor=south west,inner sep=0pt,font=\normalsize]
      at (axis cs:0.25,0.345) {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt,font=\normalsize] at (axis cs:7.05,0.045) {百分比};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4.0,-0.09) {甲离子残留百分比直方图};
