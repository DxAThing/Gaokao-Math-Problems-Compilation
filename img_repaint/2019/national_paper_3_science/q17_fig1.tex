...
\begin{axis}[scaled ticks=false,exam statistical histogram,
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:1,-0.012000) {1.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:2,-0.012000) {2.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:3,-0.012000) {3.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:4,-0.012000) {4.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:5,-0.012000) {5.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:6,-0.012000) {6.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:7,-0.012000) {7.5};
    ...
    \node[anchor=east,inner sep=0pt,font=\normalsize,xshift=-4pt] at (axis cs:-0.100000,0.10) {0.10};
    \node[anchor=east,inner sep=0pt,font=\normalsize,xshift=-4pt] at (axis cs:-0.100000,0.15) {0.15};
    \node[anchor=east,inner sep=0pt,font=\normalsize,xshift=-4pt] at (axis cs:-0.100000,0.20) {0.20};
    \node[anchor=east,inner sep=0pt,font=\normalsize,xshift=-4pt] at (axis cs:-0.100000,0.30) {0.30};

    \examstatylabel{\(\dfrac{\text{频率}}{\text{组距}}\)};
    \examstatxlabel{百分比};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:4.0,-0.09) {甲离子残留百分比直方图};
