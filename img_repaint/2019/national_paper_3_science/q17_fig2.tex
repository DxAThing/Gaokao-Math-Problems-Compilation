...
\begin{axis}[
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:1,-0.018) {2.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:2,-0.018) {3.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:3,-0.018) {4.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4,-0.018) {5.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:5,-0.018) {6.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:6,-0.018) {7.5};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:7,-0.018) {8.5};
    ...
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.10) {$b$};
    \draw[line width=0.4pt] (axis cs:0,0.30) -- (axis cs:-0.10,0.30);
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.05,0.30) {$a$};
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4.0,-0.09) {乙离子残留百分比直方图};
