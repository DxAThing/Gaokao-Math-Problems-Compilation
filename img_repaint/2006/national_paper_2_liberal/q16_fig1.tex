...
\begin{axis}[
    ...
    \fill[white] (axis cs:60,0) -- (axis cs:140,-0.000012) -- (axis cs:220,0.000008)
        -- (axis cs:300,-0.000012) -- (axis cs:380,0.000008) -- (axis cs:440,0)
        -- (axis cs:440,-0.000018) -- (axis cs:60,-0.000018) -- cycle;
    \draw[white,line width=1.8pt] (axis cs:60,0) -- (axis cs:440,0);
    \draw[line width=0.75pt] (axis cs:60,0) -- (axis cs:140,-0.000012) -- (axis cs:220,0.000008)
        -- (axis cs:300,-0.000012) -- (axis cs:380,0.000008) -- (axis cs:440,0);
    ...
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-20,0) {0};
    \draw[line width=0.45pt] (axis cs:500,0) -- (axis cs:500,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:500,-0.000018) {1000};
    \draw[line width=0.45pt] (axis cs:1000,0) -- (axis cs:1000,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:1000,-0.000018) {1500};
    \draw[line width=0.45pt] (axis cs:1500,0) -- (axis cs:1500,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:1500,-0.000018) {2000};
    \draw[line width=0.45pt] (axis cs:2000,0) -- (axis cs:2000,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:2000,-0.000018) {2500};
    \draw[line width=0.45pt] (axis cs:2500,0) -- (axis cs:2500,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:2500,-0.000018) {3000};
    \draw[line width=0.45pt] (axis cs:3000,0) -- (axis cs:3000,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:3000,-0.000018) {3500};
    \draw[line width=0.45pt] (axis cs:3500,0) -- (axis cs:3500,-0.000014);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:3500,-0.000018) {4000};

    \draw[line width=0.45pt] (axis cs:0,0.0001) -- (axis cs:-55,0.0001);
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-70,0.0001) {0.0001};
    \draw[line width=0.45pt] (axis cs:0,0.0002) -- (axis cs:-55,0.0002);
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-70,0.0002) {0.0002};
    \draw[line width=0.45pt] (axis cs:0,0.0003) -- (axis cs:-55,0.0003);
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-70,0.0003) {0.0003};
    \draw[line width=0.45pt] (axis cs:0,0.0004) -- (axis cs:-55,0.0004);
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-70,0.0004) {0.0004};
    \draw[line width=0.45pt] (axis cs:0,0.0005) -- (axis cs:-55,0.0005);
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-70,0.0005) {0.0005};
\end{axis}
\end{tikzpicture}
