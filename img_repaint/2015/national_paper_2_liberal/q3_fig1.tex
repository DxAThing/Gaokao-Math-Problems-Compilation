...
\begin{axis}[
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:1,1885) {2004};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:2,1885) {2005};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:3,1885) {2006};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4,1885) {2007};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:5,1885) {2008};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:6,1885) {2009};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:7,1885) {2010};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:8,1885) {2011};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:9,1885) {2012};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:10,1885) {2013};
\end{axis}
\end{tikzpicture}
