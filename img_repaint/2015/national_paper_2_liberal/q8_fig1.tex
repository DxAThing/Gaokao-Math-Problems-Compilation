...
\begin{tikzpicture}[
    ...
    \node[decision] (neq) at (0,6.28) {$a\ne b$};
    \node[decision, minimum width=3.30cm] (gt) at (-1.65,4.72) {$a>b$};
    ...
    \coordinate (no-turn) at (2.60,6.28);
    ...
    \draw[->] (gt.east) -- node[above=2pt] {否} (bsub.north);
    ...
    \coordinate (loop-top) at (-4.45,6.98);
