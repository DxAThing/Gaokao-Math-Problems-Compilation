...
\begin{axis}[exam statistical histogram,scaled ticks=false,
    ...
    \examstatxlabel{满意度评分};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:35.000000,0.005) {0.005};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:35.000000,0.010) {0.010};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:35.000000,0.015) {0.015};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:35.000000,0.020) {0.020};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:34.500000,0.025) {0.025};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:35.000000,0.030) {0.030};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:34.500000,0.035) {0.035};
    \node[anchor=east,inner sep=1pt,xshift=-4pt] at (axis cs:34.500000,0.040) {0.040};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:40,0.000000) {40};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:50,0.000000) {50};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:60,0.000000) {60};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:70,0.000000) {70};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:80,0.000000) {80};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:90,0.000000) {90};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-4pt] at (axis cs:100,0.000000) {100};
\end{axis}
\end{tikzpicture}
