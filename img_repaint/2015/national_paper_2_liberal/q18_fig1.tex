...
\begin{axis}[
    ...
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:40,-0.001) {40};
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:50,-0.001) {50};
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:60,-0.001) {60};
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:70,-0.001) {70};
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:80,-0.001) {80};
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:90,-0.001) {90};
    \node[anchor=north,inner sep=0pt,font=\scriptsize] at (axis cs:100,-0.001) {100};
\end{axis}
\end{tikzpicture}
