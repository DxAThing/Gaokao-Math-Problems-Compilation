...
\begin{tikzpicture}[
  ...
  % The no branch goes right, up, then left into the s,t connector.  Keep
  % its arrowhead clear of the degree-3 merge junction.
  \draw[flowarrow] (test.east) -- (3.30,2.50) -- (3.30,7.30) -- (0.35,7.30);
  \draw (0.35,7.30) -- (0,7.30);
  % Main connector continues from the loop junction into the s,t box.
  \draw[flowarrow] (init.south) -- (0,7.30) -- (st.north);
