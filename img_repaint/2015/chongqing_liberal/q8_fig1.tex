...
\begin{tikzpicture}[
    ...
    % Keep the merge below the initialization box (>=2.5 mm clearance).
    \coordinate (merge-level) at (0,8.60);
    ...
    \coordinate (merge-pre) at (0.40,8.60);
    % Stop the loop arrow before the merge and finish with a plain connector.
    \draw[->] (add.north) -- (2.55,8.60) -- (merge-pre);
