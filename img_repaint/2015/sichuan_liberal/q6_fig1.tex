...
\begin{tikzpicture}[baseline,>=Stealth,font=\normalsize,line width=0.45pt,
  ...
  % The loop return joins the incoming connector above k=k+1; its leftward
  % arrowhead lands on the stem, followed by one separate downward arrow.
  \coordinate (merge-level) at (0,-1.72);
  ...
  \draw (test.east) -- (1.65,-3.48) -- (1.65,-1.72);
  \draw[->] (1.65,-1.72) -- (merge-level);
  \node[flowtext,inner xsep=1pt,inner ysep=1pt] at (1.55,-3.12) {否};
