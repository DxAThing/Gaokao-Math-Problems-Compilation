...
\begin{tikzpicture}[
  ...
  \coordinate (looppre) at (0.40,7.42);
  ...
  % Keep the main stem a single segment; the loop arrow ends 4 mm before the
  % stem and an unarrowed short segment completes the connection.
  ...
  \draw[flowarrow] (inc.west) -- (looppre);
