...
\begin{tikzpicture}[
  ...
  % The return arrow ends 4 mm before the main stem; an unarrowed short segment
  % completes the connection without an arrow tip at the junction.
  \coordinate (merge) at (0,6.00);
  \coordinate (mergepre) at (0.40,6.00);
  ...
  \draw[->] (inc.north) -- (3.80,6.00) -- (mergepre);
  \draw (mergepre) -- (merge);
