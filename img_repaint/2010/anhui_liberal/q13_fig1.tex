...
\begin{tikzpicture}[
  ...
  % One arrowhead is kept just before the merge; the final stem has one arrow.
  \coordinate (return-tip) at (0.40,9.00);
  \draw[->] (top-route) -- (return-tip);
  \draw (return-tip) -- (entry);
