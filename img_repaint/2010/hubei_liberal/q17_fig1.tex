...
\begin{axis}[
    ...
    \draw[line width=0.8pt] (axis cs:0.30,-0.13) -- (axis cs:0.45,0.13) -- (axis cs:0.60,-0.13) -- (axis cs:0.75,0.13) -- (axis cs:0.90,-0.13);
    ...
    \node[anchor=north,inner sep=0pt] at (axis cs:0,-0.16) {0};
    \node[anchor=north,inner sep=0pt] at (axis cs:1,-0.16) {1.00};
    \node[anchor=north,inner sep=0pt] at (axis cs:2,-0.16) {1.05};
    \node[anchor=north,inner sep=0pt] at (axis cs:3,-0.16) {1.10};
    \node[anchor=north,inner sep=0pt] at (axis cs:4,-0.16) {1.15};
    \node[anchor=north,inner sep=0pt] at (axis cs:5,-0.16) {1.20};
    \node[anchor=north,inner sep=0pt] at (axis cs:6,-0.16) {1.25};
    \node[anchor=north,inner sep=0pt] at (axis cs:7,-0.16) {1.30};

    % y-axis ticks and labels.
    \draw[line width=0.45pt] (axis cs:0,0.4) -- (axis cs:-0.16,0.4);
    \node[anchor=east,inner sep=0pt] at (axis cs:-0.24,0.4) {0.4};
    \draw[line width=0.45pt] (axis cs:0,1) -- (axis cs:-0.16,1);
    \node[anchor=east,inner sep=0pt] at (axis cs:-0.24,1) {1};
    \draw[line width=0.45pt] (axis cs:0,3) -- (axis cs:-0.16,3);
    \node[anchor=east,inner sep=0pt] at (axis cs:-0.24,3) {3};
    \draw[line width=0.45pt] (axis cs:0,4) -- (axis cs:-0.16,4);
    \node[anchor=east,inner sep=0pt] at (axis cs:-0.24,4) {4};
    \draw[line width=0.45pt] (axis cs:0,5.6) -- (axis cs:-0.16,5.6);
    \node[anchor=east,inner sep=0pt] at (axis cs:-0.24,5.6) {5.6};
    \draw[line width=0.45pt] (axis cs:0,6) -- (axis cs:-0.16,6);
    \node[anchor=east,inner sep=0pt] at (axis cs:-0.24,6) {6};

    \node[anchor=south west,inner sep=0pt] at (axis cs:0.28,7.06) {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt] at (axis cs:7.45,0.40) {质量 (kg)};
\end{axis}
\end{tikzpicture}
