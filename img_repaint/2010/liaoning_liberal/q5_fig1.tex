...
\begin{tikzpicture}[
  ...
  \coordinate (incrementbottom) at (3.60,5.26);
  \coordinate (righttop) at (3.60,6.55);
  ...
  \draw[flowarrow] (test.east) -- (branchright) -- node[right=3pt,pos=.55] {是} (incrementbottom) -- (increment.south);
  \draw (increment.north) -- (righttop);
