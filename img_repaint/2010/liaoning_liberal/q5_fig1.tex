...
\begin{tikzpicture}[
  ...
  % completes the connection without placing an arrow tip at the junction.
  \coordinate (loopjoin) at (0,6.80);
  \coordinate (looppre) at (0.40,6.80);
  \coordinate (branchright) at (3.60,4.55);
  \coordinate (righttop) at (3.80,6.80);
  ...
  \draw[flowarrow] (increment.north) -- (righttop) -- (looppre);
