...
\begin{tikzpicture}[
    ...
    flowbox/.style={draw,text centered,anchor=center,inner xsep=4pt,inner ysep=2.5pt},
    ...
    \draw[->] (test.east) -- (output-turn) -- (output.north);
    \node[anchor=south west,inner sep=0pt] at (2.45,5.90) {否};
    ...
    % The source shows a right-pointing arrow at the loop junction and a
    % separate downward arrow into the decision node.
