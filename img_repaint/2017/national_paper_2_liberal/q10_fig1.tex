...
\begin{tikzpicture}[x=1cm,y=1cm,baseline,
  ...
  % Clear shared junction above the decision.
  \coordinate (loopJoin) at (0,-2.68);
  ...
  \draw (inc.west) -- (-2.25,-6.98) -- (-2.25,-2.68);
  \draw[flowarrow] (-2.25,-2.68) -- (loopJoin);
  % The no branch exits right, runs down, then turns left to the output stem.
  \draw (test.east) -- (2.55,-3.45) -- (2.55,-7.40) -- (0,-7.40);
  \draw[flowarrow] (0,-7.40) -- (output.north);
