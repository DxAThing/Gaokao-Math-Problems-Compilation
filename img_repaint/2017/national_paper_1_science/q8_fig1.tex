...
\begin{tikzpicture}[
    ...
    \draw (loopassign.north) -- (-3.25,6.10) -- (-0.12,6.10);
    \draw[->] (-0.12,6.10) -- (0,6.10);
    \draw[->] (0,6.10) -- (assign.north);
\end{tikzpicture}
