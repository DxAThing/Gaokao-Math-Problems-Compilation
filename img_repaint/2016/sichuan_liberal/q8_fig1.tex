...
\begin{tikzpicture}[
  ...
  \node[process,minimum width=1.72cm] (update) at (3.72,4.90) {$v=vx+i$};
  \node[process,minimum width=1.62cm] (decrement) at (3.72,6.00) {$i=i-1$};
  ...
  \draw[-] (test.east) -- (3.72,3.58) -- (3.72,4.55);
  \draw[->] (3.72,4.55) -- (update.south);
  \draw[->] (update.north) -- (decrement.south);
  \draw[->] (decrement.west) -- (1.60,6.00) -- (1.60,4.95);
