...
\begin{tikzpicture}[
  ...
  % its arrow ends at the junction with the independent main stem.
  % Keep a visible stem between the loop arrowhead and the computation box.
  \draw[->] (inc.north) -- (-3.20,5.50) -- (0,5.50);
