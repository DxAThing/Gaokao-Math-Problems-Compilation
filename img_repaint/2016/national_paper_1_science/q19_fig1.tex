...
\begin{axis}[
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:1.5,-2.0) {8};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:2.5,-2.0) {9};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:3.5,-2.0) {10};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4.5,-2.0) {11};

    \draw[line width=0.5pt] (axis cs:0,20) -- (axis cs:-0.35,20);
    \draw[line width=0.5pt] (axis cs:0,40) -- (axis cs:-0.35,40);
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.45,20) {20};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:-0.45,40) {40};
\end{axis}
\end{tikzpicture}
