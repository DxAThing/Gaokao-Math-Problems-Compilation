...
\begin{tikzpicture}[x=1cm,y=1cm,baseline,
  ...
  % Keep the branch arrowhead clear of the three-way merge, then use one
  % centered shaft into the increment box.
  \draw[flowarrow] (doubleS.south) -- (-2.55,-5.85) -- (-0.45,-5.85);
  \draw[-] (-0.45,-5.85) -- (0,-5.85);
  ...
  \draw[flowarrow] (testN.east) -- (3.05,-8.00) -- (3.05,-3.05) -- (0,-3.05);
