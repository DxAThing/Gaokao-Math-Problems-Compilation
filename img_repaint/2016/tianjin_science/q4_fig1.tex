...
\begin{tikzpicture}[x=1cm,y=1cm,baseline,
  ...
  \draw[flowarrow] (doubleS.south) -- (-2.55,-6.00) -- (0,-6.00);
  \draw (subtract.south) -- (0,-6.00);
  \draw (0,-6.00) -- (0,-6.15);
  \draw[flowarrow] (0,-6.15) -- (inc.north);

  % n>3 否 returns to the first decision; the output route stays independent.
  \draw[flowarrow] (testN.east) -- (3.05,-8.00) -- (3.05,-2.95) -- (0,-2.95);
