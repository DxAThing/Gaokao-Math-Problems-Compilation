...
\begin{tikzpicture}[font=\small]
  \begin{axis}[
    ...
    \node[anchor=north east, inner sep=1pt, font=\scriptsize] at (axis cs:90,0) {0};
    \node[anchor=north, inner sep=1pt] at (axis description cs:0.52,-0.27) {患病者};
    \node[anchor=west, inner sep=1pt] at (axis description cs:1.01,0.03) {指标};
    \node[anchor=south, inner sep=1pt] at (axis description cs:0.03,1.01) {\(\dfrac{\text{频率}}{\text{组距}}\)};
  \end{axis}
  ...
  \begin{scope}[xshift=7.15cm]
    \begin{axis}[
      ...
      \node[anchor=north east, inner sep=1pt, font=\scriptsize] at (axis cs:65,0) {0};
