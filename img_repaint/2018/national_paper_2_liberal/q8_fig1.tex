...
\begin{tikzpicture}[
  ...
  \coordinate (trunkjoin) at (0,8.75);
  \coordinate (testentry) at (0,8.75);
  ...
  % The return shaft traverses the horizontal re-entry to its visible endpoint;
  % the separate arrow after the turn then enters the decision diamond.
  \draw (inc.west) -- (-3.90,3.65) -- (-3.90,8.40);
  \draw[->] (-3.90,8.40) -- (testentry);
\end{tikzpicture}
