...
\begin{tikzpicture}[
  ...
  % The loop return traverses the horizontal re-entry to its visible endpoint;
  % the separate arrow after the turn then enters the decision diamond.
  \coordinate (loopjoin) at (0,5.45);
  \coordinate (testentry) at (0,5.45);
  ...
  \draw (increment.west) -- (-4.85,0.35) -- (-4.85,5.10);
  \draw[->] (-4.85,5.10) -- (testentry);
