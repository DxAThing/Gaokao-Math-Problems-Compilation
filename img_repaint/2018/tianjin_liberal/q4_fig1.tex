...
\begin{tikzpicture}[
    ...
    \coordinate (divNoMerge) at (2.35,4.90);
    \coordinate (divNoJoin) at (0,4.90);
    ...
    % i>=5 no branch returns left and re-enters the first decision.
    \coordinate (loopLeft) at (-2.55,2.63);
    % Separate the horizontal return arrowhead from the main-chain arrowhead.
    \coordinate (loopTop) at (-2.55,7.98);
    \coordinate (loopJoin) at (0,7.98);
