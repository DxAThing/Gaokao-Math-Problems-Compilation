...
\begin{tikzpicture}[
  ...
  % Keep the true-branch label clear of the output trapezium's top border.
  \draw[flowline] (test.south) -- node[pos=0.20,right=1.5pt] {是} (output.north);
  ...
  \draw (2.30,0.30) -- (2.30,4.05);
  \draw[flowline] (2.30,4.05) -- (0,4.05);
