...
\begin{tikzpicture}[
  ...
  % Branches merge as plain lines; the single directed edge below carries
  % the only arrowhead into the following decision node.
  \draw (odd.south) -- (4.00,4.30) -- (4.00,4.00) -- (branchmerge);
  \draw (even.south) -- (0,4.30) -- (branchmerge);
  ...
  \draw[->] (test.west) -- (loop-left) -- (loop-entry) -- (-0.40,8.28) -- (preinc);
