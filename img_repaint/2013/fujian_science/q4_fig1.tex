...
\begin{axis}[
    ...
    \fill[white] (axis cs:3.5,-0.002) -- (axis cs:4.5,0.002) -- (axis cs:5.5,-0.002)
        -- (axis cs:6.5,0.002) -- (axis cs:7.5,-0.002) -- cycle;
    \draw[line width=0.75pt] (axis cs:3.5,-0.002) -- (axis cs:4.5,0.002)
        -- (axis cs:5.5,-0.002) -- (axis cs:6.5,0.002) -- (axis cs:7.5,-0.002);

    \node[anchor=south west,inner sep=0pt,font=\small] at (axis cs:0.8,0.0305)
        {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt,font=\small] at (axis cs:72,0.0015) {分数};

    \draw[line width=0.4pt] (axis cs:0,0) -- (axis cs:0,-0.0015);
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.8,-0.0020) {0};
    \draw[line width=0.4pt] (axis cs:10,0) -- (axis cs:10,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:10,-0.0020) {40};
    \draw[line width=0.4pt] (axis cs:20,0) -- (axis cs:20,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:20,-0.0020) {50};
    \draw[line width=0.4pt] (axis cs:30,0) -- (axis cs:30,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:30,-0.0020) {60};
    \draw[line width=0.4pt] (axis cs:40,0) -- (axis cs:40,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:40,-0.0020) {70};
    \draw[line width=0.4pt] (axis cs:50,0) -- (axis cs:50,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:50,-0.0020) {80};
    \draw[line width=0.4pt] (axis cs:60,0) -- (axis cs:60,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:60,-0.0020) {90};
    \draw[line width=0.4pt] (axis cs:70,0) -- (axis cs:70,-0.0015);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:70,-0.0020) {100};
