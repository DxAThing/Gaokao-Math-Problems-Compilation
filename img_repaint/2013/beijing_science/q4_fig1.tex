...
\begin{tikzpicture}[
  ...
  \node[flowbox,minimum width=2.85cm] (init) at (0,7.90) {$i=0,S=1$};
  \node[flowbox,minimum width=3.75cm,minimum height=1.20cm] (update) at (0,6.10)
  ...
  % Return level is centered in the widened gap, >=2.5 mm from init and update.
  \draw (test.east) -- (3.75,3.05) node[pos=0.22,above] {否}
    -- (3.75,7.18) -- (1.50,7.18);
  \draw[flowline] (1.50,7.18) -- (0,7.18);
\end{tikzpicture}
