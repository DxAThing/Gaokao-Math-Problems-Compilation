...
\begin{tikzpicture}[
  ...
  \node[flowbox,minimum width=4.05cm] (init) at (0,6.48)
    {$F_0=1,F_1=2,n=1$};
  \node[flowbox,minimum width=2.85cm] (sum1) at (0,5.10)
    {$F_1=F_0+F_1$};
  ...
  % Keep the return arrowhead clear of the shared entry; the final unarrowed
  % stub preserves the same directed edge without stacking tips at loopjoin.
  \draw[flowarrow] (loop-right) -- (0.35,5.80);
  \draw (0.35,5.80) -- (loopjoin);
