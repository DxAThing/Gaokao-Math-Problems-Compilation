...
\begin{tikzpicture}[
  ...
  \node[process, minimum width=3.75cm] (init) at (0,8.00) {$k=1, S=0, T=1$};
  \node[process, minimum width=1.95cm, minimum height=1.05cm] (divide) at (0,6.10)
    {$T=\dfrac{T}{k}$};
  ...
  \draw[->] (test.east) -- node[above=2pt] {否} (loopRight) -- (2.65,7.10)
    -- (0.40,7.10);
  \draw[-] (0.40,7.10) -- (loopJoin);
\end{tikzpicture}
