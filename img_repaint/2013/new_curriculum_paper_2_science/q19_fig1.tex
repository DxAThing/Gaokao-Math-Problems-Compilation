...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:100,-0.0009) {100};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:110,-0.0009) {110};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:120,-0.0009) {120};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:130,-0.0009) {130};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:140,-0.0009) {140};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:150,-0.0009) {150};
    ...
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:96.55,0.010) {0.010};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:96.55,0.015) {0.015};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:96.55,0.020) {0.020};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:96.55,0.025) {0.025};
    \node[anchor=east,inner sep=0pt,font=\normalsize] at (axis cs:96.55,0.030) {0.030};
  \end{axis}
\end{tikzpicture}
