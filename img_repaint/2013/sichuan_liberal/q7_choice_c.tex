% Source: source/普通高考/2013/2013四川文.pdf, page 1 (lower middle-left option C).
...
% 0.01, 0.03, 0.035, 0.025.  Bars share edges and rise from the baseline;
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[/tikz/ybar interval,draw=black,fill=white,mark=none] coordinates {
      (0,0.01) (10,0.03) (20,0.035) (30,0.025) (40,0)
    };
  \end{axis}
\end{tikzpicture}
