% Source: source/普通高考/2013/2013四川文.pdf, page 1 (upper middle-left option A).
...
% 0.01, 0.01, 0.04, 0.02, 0.04, 0.03, 0.03, 0.02.  Bars share edges and rise
% from the baseline; axes have arrowheads, y ticks are 0.01--0.04, and the
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[/tikz/ybar interval,draw=black,fill=white,mark=none] coordinates {
      (0,0.01) (5,0.01) (10,0.04) (15,0.02) (20,0.04)
      (25,0.03) (30,0.03) (35,0.02) (40,0)
    };
  \end{axis}
\end{tikzpicture}
