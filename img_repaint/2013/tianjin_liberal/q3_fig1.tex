...
\begin{tikzpicture}[
  ...
  % Keep the return arrow clear of the shared loop junction; the final plain
  % stub preserves the original left-pointing return topology.
  \draw[flowarrow] (3.70,8.25) -- (0.35,8.25);
  \draw (0.35,8.25) -- (0,8.25);
