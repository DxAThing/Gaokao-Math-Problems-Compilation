...
\begin{tikzpicture}[
  ...
  \node[process,minimum width=1.80cm,minimum height=.90cm] (divide) at (0,-3.62)
    {$T=\dfrac{T}{k}$};
  ...
  \coordinate (merge-level) at (0,-3.02);
  \coordinate (loop-right) at (2.20,-7.35);
  \draw (test.east) -- (loop-right) -- (2.20,-3.02);
  \draw[->] (2.20,-3.02) -- (merge-level);
