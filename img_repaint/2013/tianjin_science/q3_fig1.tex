...
\begin{tikzpicture}[
  ...
  % Stop the loopback arrow just before the shared junction; the short
  % unarrowed continuation enters the same stem without a second edge.
  \draw[->] (double.north) -- (4.35,10.55) -- (-0.35,10.55);
  \draw (-0.35,10.55) -- (merge);
