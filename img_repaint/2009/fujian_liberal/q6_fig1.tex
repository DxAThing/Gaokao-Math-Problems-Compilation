...
\begin{tikzpicture}[baseline,>=stealth,inner sep=1pt,
  ...
  % The no branch loops left and re-enters the update node's west side;
  % routing directly to that side avoids the narrow gap between initn/updateS.
  \draw[flowarrow] (test.west) -- (-2.30,-6.30) -- (-2.30,-3.55) -- (updateS.west);
