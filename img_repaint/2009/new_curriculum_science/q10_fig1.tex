% Original PDF: source/普通高考/2009/2009新课标理(海南,宁夏).pdf, question 10.
% Program-flow topology read from the original figure; it is the same graph as
% the liberal-arts version, with the original science-paper proportions retained.
\begin{tikzpicture}[
  >=Stealth,
  line width=0.55pt,
  line cap=round,
  ...
  \node[anchor=east] at (-2.00,8.42) {是};
  ...
  \node[anchor=east] at (1.05,7.08) {是};
  \draw[flowarrow] (testone.east) -- (4.20,6.90) -- (yone.north);
  \node[anchor=west] at (3.50,7.08) {否};
  ...
  % Route below the decision, then leave a visible upward shaft into x=x+h.
  \draw[-] (testtwo.east) -- (6.00,2.00) -- (6.00,2.45)
    -- (4.65,2.45);
  \draw[flowarrow] (4.65,2.45) -- (increment.south);
  \node[anchor=west] at (1.85,2.28) {否};
  \draw[flowarrow] (increment.north) -- (4.65,4.05) -- (6.00,4.05)
    -- (6.00,9.00) -- (entry);
