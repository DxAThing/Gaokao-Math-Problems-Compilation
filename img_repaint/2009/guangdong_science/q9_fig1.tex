...
\begin{tikzpicture}[
  ...
  % The return branch leaves the increment box from its west side, matching the source
  % flowchart and keeping the arrow clear of the node text.
  \draw[->] (inc.west) -- (0,6.95);
\end{tikzpicture}
