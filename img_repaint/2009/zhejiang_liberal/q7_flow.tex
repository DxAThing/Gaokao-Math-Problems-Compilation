% Source PDF: source/普通高考/2009/2009浙江文.pdf, page 1 (question 7).
...
\begin{tikzpicture}[
    ...
    \path[use as bounding box] (-3.55,-0.55) rectangle (4.10,10.55);
    ...
    \node[io,minimum width=1.95cm] (output) at (2.85,4.55) {输出 $k$};
    \node[terminal] (finish) at (2.85,2.95) {结束};
    ...
    \draw[->] (check.east) -- node[branchlabel,above=2pt] {否} (2.85,6.00)
        -- (2.85,4.93) -- (output.north);
