...
\begin{axis}[
    ...
    xtick={0,0.45,0.85,1.25,1.65,2.05,2.45,2.85},
...
\node[anchor=south west,inner sep=0pt] at (axis cs:0.08,1.02) {\(\dfrac{\text{频率}}{\text{组距}}\)};
\node[anchor=south east,inner sep=0pt] at (axis cs:3.08,0.10) {纤度};
...
\draw[black,line width=0.45pt]
    (axis cs:0.18,0) -- (axis cs:0.22,0.07) -- (axis cs:0.26,-0.07) --
    (axis cs:0.30,0.07) -- (axis cs:0.34,-0.07) -- (axis cs:0.38,0.07) -- (axis cs:0.40,0);
\end{axis}
\end{tikzpicture}
