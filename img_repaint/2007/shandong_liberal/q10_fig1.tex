...
\begin{tikzpicture}[
    ...
    \path[use as bounding box] (-4.50,-1.00) rectangle (5.00,10.60);
    ...
    \node[process,minimum width=2.65cm] (dec2) at (0,0.30)
        {$n=n-1$};
    \node[io,minimum width=2.55cm] (output) at (3.25,4.05)
        {输出 $S,T$};
    \node[terminal] (finish) at (3.25,2.70) {结束};
