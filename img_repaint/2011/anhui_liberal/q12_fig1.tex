...
\begin{tikzpicture}[
  ...
  \node[process,minimum width=3.10cm] (init) at (0,-1.12) {$T=0,k=0$};
  \node[process,minimum width=2.40cm] (sum) at (0,-2.28) {$T=T+k$};
  ...
  \coordinate (merge-level) at (0,-1.78);
