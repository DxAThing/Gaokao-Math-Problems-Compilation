...
\begin{tikzpicture}[
  ...
  % The return arrow stops before the three-way junction; the final short
  % connector is unarrowed so only one arrowhead is present at this merge.
  \draw[->] (loop-right) -- (return-entry);
