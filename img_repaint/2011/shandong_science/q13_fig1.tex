...
\begin{tikzpicture}[
  ...
  % The directed return path ends at the formula-stem entry.
  \draw[flowarrow] (3.25,5.95) -- (return-arrow-tip) -- (return-level);
  ...
  \draw[flowarrow] (const.south) -- (outleft) -- (outleft-arrow) -- (outjoin);
  \draw (test2.south) -- (outdown-arrow) -- (outjoin);
