...
\begin{tikzpicture}[
  ...
  \coordinate (return-entry) at (-0.60,7.45);
  ...
  % The return arrow reaches the main-stem junction; the downward arrow
  % remains on the separate stem into the decision node.
  \draw[->] (loop-left) -- (return-entry) -- (loopjoin);
