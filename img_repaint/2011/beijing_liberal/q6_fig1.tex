...
\begin{tikzpicture}[
  ...
  \coordinate (return-entry) at (-0.35,7.45);
  ...
  % Stop the return arrow before the three-way junction, then continue into
  % the shared stem without adding a second arrowhead at the merge.
  \draw[->] (loop-left) -- (return-entry);
  \draw (return-entry) -- (loopjoin);
