...
\begin{tikzpicture}[
  ...
  \node[process,minimum width=3.25cm] (init) at (0,-2.30) {$k=1,p=1$};
  ...
  \node[io,minimum width=2.25cm] (output) at (0,-6.65) {输出 $p$};
  \node[terminal] (finish) at (0,-7.95) {结束};
