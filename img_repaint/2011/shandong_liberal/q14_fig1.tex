...
\begin{tikzpicture}[
  ...
  \node[io,minimum width=1.70cm] (output) at (0,2.35) {输出 $y$};
  ...
  \coordinate (outjoin) at (0,3.35);
  \draw[->] (const.south) -- (-3.55,3.35) -- (outjoin);
  ...
  \draw (test.south) -- node[branchlabel,right=2pt] {否} (outjoin);
  \draw[->] (outjoin) -- (output.north);
