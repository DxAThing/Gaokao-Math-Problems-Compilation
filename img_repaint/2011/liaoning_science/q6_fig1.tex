...
\begin{tikzpicture}[
  ...
  \coordinate (stem) at (0,7.10);
  \draw (init.south) -- (stem);
  \draw[->] (stem) -- (test.north);
  ...
  \coordinate (loop-bottom) at (0,1.10);
  \coordinate (loop-left) at (-2.60,1.10);
  \coordinate (loop-entry) at (-2.60,7.10);
  \draw[->] (inc.south) -- (loop-bottom) -- (loop-left) -- (loop-entry) -- (-0.80,7.10) -- (stem);
