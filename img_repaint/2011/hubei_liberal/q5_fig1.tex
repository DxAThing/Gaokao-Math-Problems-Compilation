...
\begin{axis}[
    ...
    \node[anchor=south west,inner sep=0pt,font=\small] at (axis cs:0.18,0.205) {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt,font=\small] at (axis cs:12.95,-0.001) {样本数据};

    \draw[line width=0.4pt] (axis cs:0,0) -- (axis cs:0,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:0,-0.006) {0};
    \draw[line width=0.4pt] (axis cs:2,0) -- (axis cs:2,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:2,-0.006) {2};
    \draw[line width=0.4pt] (axis cs:4,0) -- (axis cs:4,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:4,-0.006) {4};
    \draw[line width=0.4pt] (axis cs:6,0) -- (axis cs:6,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:6,-0.006) {6};
    \draw[line width=0.4pt] (axis cs:8,0) -- (axis cs:8,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:8,-0.006) {8};
    \draw[line width=0.4pt] (axis cs:10,0) -- (axis cs:10,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:10,-0.006) {10};
    \draw[line width=0.4pt] (axis cs:12,0) -- (axis cs:12,-0.005);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:12,-0.006) {12};
