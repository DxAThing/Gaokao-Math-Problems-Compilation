...
\begin{axis}[
    ...
    \draw[line width=0.75pt]
      (axis cs:2.8,0) -- (axis cs:4.2,0.045) -- (axis cs:5.6,-0.045) --
      (axis cs:7.0,0.045) -- (axis cs:8.4,-0.045) -- (axis cs:9.8,0);

    \node[anchor=south west,inner sep=0pt,font=\small,align=center]
      at (axis cs:-2,0.70) {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt,font=\small] at (axis cs:62,0.12) {成绩（分）};

    \draw[line width=0.45pt] (axis cs:0,0) -- (axis cs:0,-0.065);
    \node[anchor=north east,inner sep=0pt,font=\small] at (axis cs:-0.2,-0.08) {0};
    \draw[line width=0.45pt] (axis cs:10,0) -- (axis cs:10,-0.065);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:10,-0.08) {50};
    \draw[line width=0.45pt] (axis cs:20,0) -- (axis cs:20,-0.065);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:20,-0.08) {60};
    \draw[line width=0.45pt] (axis cs:30,0) -- (axis cs:30,-0.065);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:30,-0.08) {70};
    \draw[line width=0.45pt] (axis cs:40,0) -- (axis cs:40,-0.065);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:40,-0.08) {80};
    \draw[line width=0.45pt] (axis cs:50,0) -- (axis cs:50,-0.065);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:50,-0.08) {90};
    \draw[line width=0.45pt] (axis cs:60,0) -- (axis cs:60,-0.065);
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:60,-0.08) {100};
