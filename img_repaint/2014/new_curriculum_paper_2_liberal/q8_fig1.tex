...
\begin{tikzpicture}[
  ...
  % Keep the arrow tip clear of the degree-3 merge; the short unarrowed
  % continuation preserves the same single loop-entry connection.
  \draw[flowarrow] (-4.00,6.62) -- (-0.60,6.62);
  \draw (-0.60,6.62) -- (0,6.62);
