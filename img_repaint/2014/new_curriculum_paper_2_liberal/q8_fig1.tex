...
\begin{tikzpicture}[
  ...
  \draw[flowarrow] (test.west) -- (-2.30,5.72) -- (multiply.north);
  ...
  \draw[flowarrow] (test.east) -- (3.35,5.72) -- (output.north);
  ...
  \draw[flowarrow] (-4.00,6.62) -- (0,6.62);

  \node[branchlabel] at (-2.78,6.15) {是};
  \node[branchlabel] at (2.42,6.15) {否};
\end{tikzpicture}
