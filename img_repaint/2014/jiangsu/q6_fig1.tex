...
\begin{axis}[
    ...
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.14,0.010) {0.010};
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.14,0.015) {0.015};
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.14,0.020) {0.020};
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.14,0.025) {0.025};
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.14,0.030) {0.030};
    \node[anchor=south west,inner sep=0pt,font=\small,align=center]
        at (axis cs:0.18,0.033) {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt,font=\small] at (axis cs:6.45,0.001) {底部周长/cm};
    ...
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:1.00,-0.0065) {80};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:2.00,-0.0065) {90};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:3.00,-0.0065) {100};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:4.00,-0.0065) {110};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:5.00,-0.0065) {120};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:6.00,-0.0065) {130};
\end{axis}
\end{tikzpicture}
