...
%   test --否--> assign -> main entry above calc. The loop return joins the
%   main stem without a duplicate arrowhead; the downward main arrow into calc
%   remains independent. All borders/connectors are solid.
...
\begin{tikzpicture}[
  ...
  \coordinate (merge-level) at (0,7.40);
  ...
  \draw (assign.north) -- (3.45,7.40) -- (merge-level);
\end{tikzpicture}
