% Source: source/普通高考/2014/2014陕西文.pdf, page 1, question 4.
...
\begin{tikzpicture}[
  ...
  % The initialization shaft and the return edge meet at one junction;
  % the return joins an unarrowed segment; the downward edge carries the arrow.
  \coordinate (loopJoin) at (0,8.55);
  ...
  % The negative branch returns to the single vertical entry above a_i.
  \coordinate (loopLeft) at (-3.25,3.35);
  \coordinate (loopTop) at (-3.25,8.55);
