...
\begin{axis}[
  ...
  xlabel={质量指标值},
  xlabel style={at={(axis description cs:1.06,-0.03)},anchor=west},
  ylabel={},
  clip=false,
]
\node[anchor=south] at (axis description cs:0.05,1.03) {\(\dfrac{\text{频率}}{\text{组距}}\)};
% 原卷在 0 与 75 之间使用断轴锯齿，覆盖连续基线后补回锯齿。
\draw[white,line width=1.3pt] (axis cs:0.18,0) -- (axis cs:0.80,0);
\draw[line width=0.45pt]
  (axis cs:0.18,0) -- (axis cs:0.28,0.00045) --
  (axis cs:0.38,-0.00005) -- (axis cs:0.48,0.00045) --
  (axis cs:0.58,-0.00005) -- (axis cs:0.68,0.00045) --
  (axis cs:0.80,0);
\end{axis}
\end{tikzpicture}
