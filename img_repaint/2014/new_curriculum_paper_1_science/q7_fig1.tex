...
\begin{tikzpicture}[
  ...
  % Keep the left-pointing return arrowhead at least 3 mm from the merge.
  \coordinate (merge-pre) at (0.35,7.40);
  ...
  \draw[->] (increment.east) -- (3.25,0.72) -- (3.25,7.40) -- (merge-pre);
