...
\begin{axis}[
    ...
    \node[anchor=south west,inner sep=0pt,font=\small] at (axis cs:0.12,53.5) {近视率/\%};
    \node[anchor=west,inner sep=0pt,font=\small] at (axis cs:4.15,1.2) {年级};
    \node[anchor=north east,inner sep=0pt,font=\small] at (axis cs:-0.08,-0.5) {O};
    ...
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:1,-2.0) {小学};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:2,-2.0) {初中};
    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:3,-2.0) {高中};
    ...
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.12,10) {10};
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.12,30) {30};
    \node[anchor=east,inner sep=0pt,font=\small] at (axis cs:-0.12,50) {50};

    \node[anchor=north,inner sep=0pt,font=\small] at (axis cs:2,-16.5) {图2};
\end{axis}
\end{tikzpicture}
