...
\begin{axis}[
    ...
    \node[anchor=south west,inner sep=0pt,font=\normalsize,align=center] at (axis cs:0.45,0.137) {\(\dfrac{\text{频率}}{\text{组距}}\)};
    \node[anchor=west,inner sep=0pt,font=\normalsize] at (axis cs:16.0,0.018) {阅读时间};
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:0,-0.0075) {0};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:2,-0.0075) {2};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:4,-0.0075) {4};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:6,-0.0075) {6};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:8,-0.0075) {8};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:10,-0.0075) {10};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:12,-0.0075) {12};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:14,-0.0075) {14};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:16,-0.0075) {16};
    \node[anchor=north,inner sep=0pt,font=\normalsize] at (axis cs:18,-0.0075) {18};
\end{axis}
\end{tikzpicture}
