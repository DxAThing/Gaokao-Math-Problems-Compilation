...
\begin{axis}[exam statistical histogram,
    ...
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:0,-0.007000) {0};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:2,-0.007000) {2};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:4,-0.007000) {4};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:6,-0.007000) {6};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:8,-0.007000) {8};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:10,-0.007000) {10};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:12,-0.007000) {12};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:14,-0.007000) {14};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:16,-0.007000) {16};
    \node[anchor=north,inner sep=0pt,font=\normalsize,yshift=-2pt] at (axis cs:18,-0.007000) {18};
\end{axis}
\end{tikzpicture}
