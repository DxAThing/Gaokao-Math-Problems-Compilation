...
% The return joins the connector above the update box without an extra arrowhead;
% one downward arrow enters that box; all node text is locally zero-indented and centered.
\begin{tikzpicture}[
    x=0.90cm,
    y=1.12cm,
    >=Stealth,
    ...
    \coordinate (loop-right-top) at (3.25,6.92);
    \coordinate (loop-top) at (0,6.92);
