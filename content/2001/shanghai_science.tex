...
\end{cases} \)，则满足 \( f(x) = \frac{1}{4} \) 的 \( x \) 值为\fillinblank{}.
\end{problem}
...
\begin{problem}
直线 \( y = 2x - \frac{1}{2} \) 与曲线 \( \begin{cases}
x = \sin \varphi,\\
y = \cos 2\varphi.
...
\begin{solution}
\(\dfrac{|PF_{1}|}{|PF_{2}|}=\dfrac{7}{2}\) 或 \(2\).
\end{solution}
...
\begin{enumerate}
\item \(A'F \perp C'E\).
\item 二面角的大小为 \(\arctan\left(2\sqrt{2}\right)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(M_a=\left\{\frac{\sqrt{2}}{2}(1+\i),\frac{\sqrt{2}}{2}(1-\i),-\frac{\sqrt{2}}{2}(1+\i),-\frac{\sqrt{2}}{2}(1-\i)\right\}\)，\(P=\dfrac{1}{3}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(f(0)=1\)，表示没有用水清洗时，蔬菜上的农药量将保持原样.
\item \(f(1)=\dfrac{1}{2}\)，且在 \([0,+\infty)\) 上单调递减，\(0<f(x)\leqslant 1\).
\item 当 \(a>2\sqrt{2}\) 时，两次清洗后残留农药较少；当 \(a=2\sqrt{2}\) 时两种方案效果相同；当 \(0<a<2\sqrt{2}\) 时，一次清洗后残留农药较少.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(x_0=\dfrac{49}{65}\)，\(x_1=\dfrac{11}{19}\)，\(x_2=\dfrac{1}{5}\)，\(x_3=-1\).
\item \(x_0=1\) 或 \(x_0=2\).
\item \(x_0\in(1,2)\).
\end{enumerate}
\end{solution}
