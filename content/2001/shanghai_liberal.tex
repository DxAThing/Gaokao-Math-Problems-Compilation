...
展开式的通项为
\[
\mathrm C_5^k x^{5-k}\left(-\frac{1}{x^2}\right)^k=(-1)^k\mathrm C_5^k x^{5-3k},\quad k=0,1,2,3,4,5.
\]
...
\[
E=(a,t,0),\quad F=(a-t,a,0),\quad A'=(a,0,a),\quad C'=(0,a,a).
\]
于是
\[
\overrightarrow{A'F}=(-t,a,-a),\qquad \overrightarrow{C'E}=(a,t-a,-a),
\]
从而
\[
...
x^2-\sqrt{2}x+1=0,
\]
即 \(\left(x-\dfrac{\sqrt{2}}{2}\right)^2=0\)，所以 \(a=\dfrac{\sqrt{2}}{2}=\dfrac{1}{\sqrt{2}}\). 因而
\[
M_a=\left\{\frac{1}{\sqrt{2}},\frac{1}{2\sqrt{2}},\frac{1}{4\sqrt{2}},\frac{1}{8\sqrt{2}},\ldots\right\}.
\]
其中每个元素都为正数，所以从中任取两个数时其和不可能为零，故 \(P=0\).
\item 取
\[
...
\bitmapinlinefigure[6.2cm][max width=6.2cm]{img/2001/shanghai_liberal/q22_fig1.png}
\end{problem}
...
\]
\[
x_2=f\left(\frac{11}{19}\right)=\frac{\frac{44}{19}-2}{\frac{11}{19}+1}=\frac{1}{5},\qquad x_3=f\left(\frac{1}{5}\right)=\frac{\frac{4}{5}-2}{\frac{1}{5}+1}=-1.
\]
