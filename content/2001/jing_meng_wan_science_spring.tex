...
\begin{problem}
\(\lim\limits_{n\to\infty}\frac{\mathrm C_{2n}^{n}}{\mathrm C_{2n+2}^{n+1}}=\)（\quad）
...
\bitmapfigure[max width=0.36\linewidth,max totalheight=4.8cm]{img/2001/jing_meng_wan_science_spring/q11_fig1.png}
...
\end{enumerate}
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.8cm]{img/2001/jing_meng_wan_science_spring/q19_fig1.png}
\end{problem}
