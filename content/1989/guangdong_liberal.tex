...
\begin{solution}
\begin{enumerate}
\item 如图，作 \(SD \perp \beta\) 于 \(D\)，连结 \(AD\)，\(BD\). 由已知 \(AD = BD\)，所以 \(SA = SB\). 因此 \(\mathrm{Rt}\triangle SAO \cong \mathrm{Rt}\triangle SBO\)，故 \(AO = BO\).
\item 由三垂线定理的逆定理，可知 \(\angle DAO = \angle DBO = 90^\circ\). 又 \(\angle AOB = 90^\circ\)，且 \(AO = BO\)，所以四边形 \(AOBD\) 是正方形，因此 \(OD = AB = 4\mathrm{~cm}\). 又 \(SD = 3\mathrm{~cm}\)，所以 \(SO = \sqrt{3^2 + 4^2} = 5\mathrm{~cm}\).
\end{enumerate}
...
\item 因为 \(z = 1 - 2\i\)，所以 \(|az - \i| = \sqrt{5a^2 + 4a + 1}\). 由已知不等式可得
\[
\begin{cases}
\dfrac{\sqrt{5a^2 + 4a + 1}}{\sqrt{a + 1}} \geqslant \sqrt{\dfrac{1}{2}},\\
a + 1 > 0,\\
\dfrac{\sqrt{5a^2 + 4a + 1}}{\sqrt{a + 1}} > 0.
\end{cases}
\]
...
\begin{solution}
\begin{enumerate}
\item 圆 \(O\) 的圆心为 \(C\left(\cos\theta,-1-2\sin\theta\right)\). 令圆心坐标为 \((x,y)\)，消去 \(\theta\) 得
\[
x^2+\frac{(y+1)^2}{4}=1
\]
即
...
4x^2+(y+1)^2=4.
\]
因此圆心轨迹是中心为 \((0,-1)\)、半轴长分别为 \(1\) 和 \(2\) 的椭圆.
