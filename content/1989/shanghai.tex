...
\bitmapfigure[max width=0.30\linewidth]{img/1989/shanghai/q5_solution_fig1.png}
...
\bitmapfigure[max width=0.24\linewidth]{img/1989/shanghai/q6_solution_fig1.png}
...
\bitmapfigure[max width=0.22\linewidth]{img/1989/shanghai/q7_solution_fig1.png}
...
\bitmapfigure[max width=0.22\linewidth]{img/1989/shanghai/q7_solution_fig2.png}
...
令 \(k=\tan\theta\left( -\frac{\pi}{2}<\theta<\frac{\pi}{2} \right)\)，由 \(\tan^2\theta>\frac{1-p^2}{p^2}\)，得 \(0<\cos\theta<p\). 则 \(|MN|=\frac{p^2}{\cos\theta (p-\cos\theta)}\).
以下同法一.
\end{solution}
