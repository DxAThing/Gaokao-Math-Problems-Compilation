...
\choices
    {\choicebitmap[max width=0.22\linewidth,max totalheight=3.2cm]{img/1995/national_liberal/q2_optA.png}}
    {\choicebitmap[max width=0.22\linewidth,max totalheight=3.2cm]{img/1995/national_liberal/q2_optB.png}}
    {\choicebitmap[max width=0.22\linewidth,max totalheight=3.2cm]{img/1995/national_liberal/q2_optC.png}}
    {\choicebitmap[max width=0.22\linewidth,max totalheight=3.2cm]{img/1995/national_liberal/q2_optD.png}}
...
\bitmapfigure[max width=\linewidth,max totalheight=5.4cm]{img/1995/national_liberal/q5_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=5.6cm]{img/1995/national_liberal/q10_fig1.png}
...
\begin{problem}
等差数列 \(\{a_{n}\}\)，\(\{b_{n}\}\) 的前 \(n\) 项和分别为 \(S_{n}\) 与 \(T_{n}\)，若 \(\frac{S_{n}}{T_{n}} = \frac{2n}{3n + 1}\)，则 \(\lim\limits_{n\to \infty}\frac{a_n}{b_n}\) 等于（\quad）
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=5.2cm]{img/1995/national_liberal/q24_fig1.png}
