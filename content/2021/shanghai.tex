...
\item 因为 \(b=2c\)，所以由正弦定理得 \(\sin B=2\sin C\). 又 \(2\sin B-\sin C=1\)，所以 \(\sin C=\frac13\)，\(\sin B=\frac23\). 因为 \(\sin C<\sin B\)，所以 \(C<B\)，故 \(C\) 为锐角，\(\cos C=\sqrt{1-\left( \frac13 \right)^2}=\frac{2\sqrt2}{3}\). 由余弦定理得 \(c^2=a^2+b^2-2ab\cos C\). 又 \(a=3\)，\(b=2c\)，所以 \(c^2=9+4c^2-8\sqrt2\,c\)，即 \(3c^2-8\sqrt2\,c+9=0\)，解得 \(c=\frac{4\sqrt2\pm \sqrt5}{3}\).
