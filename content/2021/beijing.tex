...
\bitmapfigure[max width=6.0cm]{img/2021/beijing/q4_fig1.png}
...
\solutionfigure{\bitmapfigure[max width=4.6cm]{img/2021/beijing/q4_solution_fig1.png}}
...
\bitmapfigure[max width=6.0cm]{img/2021/beijing/q8_fig1.png}
...
\bitmapfigure[max width=6.0cm]{img/2021/beijing/q17_fig1.png}
...
\solutionfigure{\bitmapfigure[max width=4.8cm]{img/2021/beijing/q17_solution_fig1.png}}
...
\solutionfigure{\bitmapfigure[max width=4.8cm]{img/2021/beijing/q17_solution_fig2.png}}
...
\begin{enumerate}
    \item
    \begin{enumerate}
        \item 若采用“10 合 1 检测法”，且两名患者同一组，求总检测次数；
        \item 已知 \(10\) 人分成一组，分 \(10\) 组，两名感染患者在同一组的概率为 \(\frac{1}{11}\)，定义随机变量 \(X\) 为总检测次数，求检测次数 \(X\) 的分布列和数学期望 \(E(X)\)；
    \end{enumerate}
...
\begin{solution}
（1）（i）对每组进行检测，需要 \(10\) 次；再对结果为阳性的组每个人进行检测，需要 \(10\) 次；
所以总检测次数为 \(20\) 次.

（ii）由题意，\(X\) 可以取 \(20\)，\(30\)，\(P(X=20)=\frac{1}{11}\)，\(P(X=30)=1-\frac{1}{11}=\frac{10}{11}\).
则 \(X\) 的分布列为：
...
\solutionfigure{\bitmapfigure[max width=5.6cm]{img/2021/beijing/q20_solution_fig1.png}}
