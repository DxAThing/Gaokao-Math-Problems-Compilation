...
\begin{center}
\bitmapinclude[max width=4.6cm,max totalheight=4.8cm]{img/2021/national_paper_A_liberal/q2_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=7cm,max totalheight=4.8cm]{img/2021/national_paper_A_liberal/q7_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=4.2cm,max totalheight=4.8cm]{img/2021/national_paper_A_liberal/q15_fig1.png}
\end{center}
...
因为 \(AB\perp BB_1\)，\(BC\perp AB\)，且 \(BB_1\cap BC=B\)，所以 \(AB\perp \text{平面 }BCC_1B_1\).
又 \(BF\subset \text{平面 }BCC_1B_1\)，故 \(AB\perp BF\).
...
\begin{center}
\bitmapinclude[max width=5.8cm,max totalheight=4.8cm]{img/2021/national_paper_A_liberal/q23_solution_fig1.png}
\end{center}
...
因为 \(a>0\)，故舍去 \(a=-\frac{5}{2}\).

因此至少要将 \(y=f(x)\) 向左平移 \(\frac{11}{2}\) 个单位，故
 \(a\ge \frac{11}{2}\).
所以 \(a\) 的取值范围为
