...
\section{单选题}
\begin{problem}
设集合 \(M = \{(x, y) \mid x^2 + y^2 = 1, x \in \R, y \in \R\}\)，\(N = \{(x, y) | x^2 - y = 0, x \in \R, y \in \R\}\)，则集合 \(M \cap N\) 中元素的个数为（\quad）
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2004/guangxi_liberal/q21_fig1.png}
\end{problem}
