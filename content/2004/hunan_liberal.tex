...
\begin{problem}
某公司在甲，乙，丙，丁四个地区分别有 \(150\text{ 个}\)，\(120\text{ 个}\)，\(180\text{ 个}\)，\(150\text{ 个}\)销售点. 公司为了调查产品销售的情况，需从这 \(600\text{ 个}\)销售点中抽取一个容量为 \(100\) 的样本，记这项调查为\(\circled{1}\)；在丙地区中有 \(20\text{ 个}\)特大型销售点，要从中抽取 \(7\) 个调查其销售收入和售后服务情况，记这项调查为\(\circled{2}\). 则完成\(\circled{1}\)，\(\circled{2}\)这两项调查宜采用的抽样方法依次是（\(\quad\)）

\begin{circlelist}
\item 从这 \(600\text{ 个}\)销售点中抽取一个容量为 \(100\) 的样本；
\item 在丙地区中有 \(20\text{ 个}\)特大型销售点，要从中抽取 \(7\) 个调查其销售收入和售后服务情况.
\end{circlelist}
...
\choices
    {\(4200\text{ 元}\) \textasciitilde{} \(4400\text{ 元}\)}
    {\(4400\text{ 元}\) \textasciitilde{} \(4600\text{ 元}\)}
    {\(4600\text{ 元}\) \textasciitilde{} \(4800\text{ 元}\)}
    {\(4800\text{ 元}\) \textasciitilde{} \(5000\text{ 元}\)}
\end{problem}
