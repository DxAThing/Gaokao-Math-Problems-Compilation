...
\begin{problem}
数列 \(\{a_n\}\) 中，\(a_1=\frac{1}{5}\)，\(a_n+a_{n+1}=\frac{6}{5^{n+1}}\)，\(n\in \mathbf{N}^{*}\)，则 \(\lim_{n\to\infty}(a_1+a_2+\cdots+a_n)=\)（\quad）
...
\section{填空题}
\begin{problem}
已知向量 \(a=(\cos\theta,\sin\theta)\)，向量 \(b=(\sqrt{3},-1)\)，则 \(\left|2a-b\right|\) 的最大值是 \fillinblank{}.
\end{problem}
...
\begin{enumerate}
\item 证明: \(x_{n+1}-1=\frac{1}{2^n}(x_n-1)\)，\(n\in\mathbf{N}^{*}\);
\item 求数列 \(\{x_n\}\) 的通项公式;
\item 比较 \(3\left|PP_n\right|^{2}\) 与 \(4k^{2}\left|PP_1\right|^{2}+5\) 的大小.
\end{enumerate}
\end{problem}
