...
\begin{solution}
短答案：\(\tan A = 2\tan B\)；\(AB\) 边上的高为 \(2 + \sqrt{6}\).
\end{solution}
...
\begin{solution}
短答案：\(\left\{\frac{S_n}{n}\right\}\) 的公比为 \(2\)；\(S_{n+1} = 4a_n\).
\end{solution}
...
\begin{solution}
短答案：\(CD \perp\) 平面 \(BDM\)；二面角的大小为 \(\displaystyle\pi - \arccos\frac{\sqrt{3}}{3}\).
\end{solution}
...
\begin{solution}
短答案：\(\displaystyle\pi - \arccos\frac{3\sqrt{41}}{41}\)；\(\displaystyle\left[-\frac{4}{3}, -\frac{3}{4}\right] \cup \left[\frac{3}{4}, \frac{4}{3}\right]\).
\end{solution}
