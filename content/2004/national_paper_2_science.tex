...
\section{填空题}
\begin{problem}
从装有 3 个红球，2 个白球的袋中随机取出 2 个球，设其中有 \(\xi\) 个红球，则随机变量 \(\xi\) 的概率分布为：
\begin{center}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2004/jilin_science/q20_fig1.png}
...
\item 设 \(FB = \lambda AF\)，若 \(\lambda \in [4,9]\)，求 \(l\) 在 \(y\) 轴上截距的变化范围.
\end{enumerate}
\end{problem}
