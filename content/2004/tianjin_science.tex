...
\begin{center}
\bitmapinclude[max width=0.34\linewidth,max totalheight=4.8cm]{img/2004/tianjin_science/q6_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=0.42\linewidth,max totalheight=4.8cm]{img/2004/tianjin_science/q10_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=0.42\linewidth,max totalheight=4.8cm]{img/2004/tianjin_science/q19_fig1.png}
\end{center}
\end{problem}
...
\item 求数列 \(\{a_{n}\}\) 的通项公式；
\item 当 \(|k| < 1\) 时，求 \(\lim\limits_{n \to \infty} a_n\).
\end{enumerate}
\end{problem}
