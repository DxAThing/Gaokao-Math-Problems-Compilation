...
\begin{solution}
\begin{enumerate}
\item 从 \(6\) 人中任选 \(3\) 人，共有 \(\mathrm C_6^3=20\) 种等可能结果. 随机变量 \(\xi\) 的可能取值为 \(0,1,2\). 于是 \(P(\xi=0)=\frac{\mathrm C_4^3}{\mathrm C_6^3}=\frac15\)，\(P(\xi=1)=\frac{\mathrm C_2^1\mathrm C_4^2}{\mathrm C_6^3}=\frac35\)，\(P(\xi=2)=\frac{\mathrm C_2^2\mathrm C_4^1}{\mathrm C_6^3}=\frac15\). 因此 \(\xi\) 的分布列为上述三组概率.
...
\begin{center}
\bitmapinlinefigure[13.3cm][]{img/2004/tianjin_science/q19_fig1.png}
\end{center}
\end{problem}
...
\[
D=(0,0,0),\quad C=(s,0,0),\quad A=(0,s,0),\quad B=(s,s,0),\quad P=(0,0,s).
\]
...
\[
\frac{x^2}{a^2}+\frac{y^2}{2}=1,\qquad c^2=a^2-2.
\]
对应于右焦点 \(F(c,0)\) 的准线为 \(l:x=\frac{a^2}{c}\)，所以
\[
A=\left(\frac{a^2}{c},0\right),\qquad |FA|=\frac{a^2}{c}-c=\frac{a^2-c^2}{c}=\frac2c.
\]
...
\[
x_P+x_Q=\frac{18m^2}{1+3m^2},\qquad x_Px_Q=\frac{27m^2-6}{1+3m^2}.
\]
...
\[
u^2+3v^2=\frac3\lambda,\qquad 1+\lambda=-\frac{6u}{u^2+3v^2}=-2\lambda u.
\]
