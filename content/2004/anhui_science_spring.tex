...
\begin{problem}
\(\lim\limits_{n\to\infty}\frac{(n-2)^2(2+3n)^3}{(1-n)^5}=\)（\quad）
...
\begin{problem}
解关于 \(x\) 的不等式：\(\log_a^3x<3\log_ax\)（\(a>0\) 且 \(a\ne1\)）.
\end{problem}
...
\bitmapfigure[max width=0.45\linewidth,max totalheight=5.0cm]{img/2004/anhui_science_spring/q20_fig1.png}
\end{problem}
