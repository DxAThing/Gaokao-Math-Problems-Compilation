...
\begin{circlelist}
\item \(\begin{cases}\alpha&\parallel\beta,\\ m&\subset\alpha,\end{cases}\Rightarrow m\parallel\beta;\)
\item \(\begin{cases}m&\parallel n,\\ m&\parallel\beta,\end{cases}\Rightarrow n\parallel\beta;\)
\item \(\begin{cases}m&\subset\alpha,\\ n&\subset\beta,\end{cases}\Rightarrow m,n\) 异面；
\item \(\begin{cases}\alpha&\perp\beta,\\ m&\parallel\alpha,\end{cases}\Rightarrow m\perp\beta.\)
\end{circlelist}
...
\begin{center}
\bitmapinclude[max width=0.46\linewidth,max totalheight=4.8cm]{img/2004/chongqing_liberal/q12_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=0.36\linewidth,max totalheight=4.8cm]{img/2004/chongqing_liberal/q19_fig1.png}
\end{center}
\end{problem}
