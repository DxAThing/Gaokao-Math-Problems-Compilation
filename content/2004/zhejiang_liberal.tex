...
\bitmapfigure[max width=3.1cm]{img/2004/zhejiang_liberal/q10_fig1.png}
...
记
\(S=\overrightarrow{AB}\cdot\overrightarrow{BC}+\overrightarrow{BC}\cdot\overrightarrow{CA}+\overrightarrow{CA}\cdot\overrightarrow{AB}\). 代入三条边长 \(3\)，\(4\)，\(5\)，得到
