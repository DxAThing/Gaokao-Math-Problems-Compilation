...
\begin{problem}
设函数 \(f(x) = \begin{cases} (x + 1)^2, & x < 1, \\ 4 - \sqrt{x - 1}, & x \geqslant 1, \end{cases}\) 则使得 \(f(x) \geqslant 1\) 的自变量 \(x\) 的取值范围为（\quad）
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2004/national_paper_3_science/q20_fig1.png}
\end{problem}
