...
\begin{solution}
因为 \(x=\sqrt{5k+1}\) 为有理数，且 \(5k+1\) 是整数，所以 \(x\) 必为整数. 又 \(x\leqslant6\)，故只需考察 \(x=1,2,3,4,5,6\). 由 \(k=(x^2-1)/5\in\N\)，可得 \(x=1,4,6\)，从而 \(A\cap B=\{1,4,6\}\)，故选 D.
\end{solution}
...
\begin{solution}
命题 \(\circled{1}\) 把“\(A\not\subseteq B\)”错误地表述成对任意 \(x\in A\) 都有 \(x\notin B\)，而 \(A\not\subseteq B\) 的正确含义只是存在至少一个 \(x\in A\) 不属于 \(B\)，所以 \(\circled{1}\) 不是真命题.
...
\begin{enumerate}
\item 有 \(\overrightarrow{A_1C}=\left(1,1,-1\right)\)，\(\overrightarrow{DB}=\left(1,-1,0\right)\)，\(\overrightarrow{DC_1}=\left(1,0,1\right)\). 因此 \(\overrightarrow{A_1C}\cdot\overrightarrow{DB}=0\)，\(\overrightarrow{A_1C}\cdot\overrightarrow{DC_1}=0\). 直线 \(DB\) 与 \(DC_1\) 是平面 \(BDC_1\) 内相交的两条直线，所以 \(A_1C\perp\) 平面 \(BDC_1\).
...
\[
0<c<(2-\sqrt{3})^2=7-4\sqrt{3}\quad\text{或}\quad c>(2+\sqrt{3})^2=7+4\sqrt{3}.
\]
