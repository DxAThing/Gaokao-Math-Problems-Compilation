...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2004/beijing_liberal_spring/q17_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.46\linewidth,max totalheight=4.8cm]{img/2004/beijing_liberal_spring/q18_fig1.png}
\end{problem}
...
\item 当销售商一次订购 \(400\) 件服装时，该服装厂获得的利润是多少元？（服装厂售出一件服装的利润=实际出厂单价−成本）
\end{enumerate}
\end{problem}
