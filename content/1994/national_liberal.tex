...
\begin{problem}
有甲、乙、丙三项任务，甲需\(2\text{ 人}\)承担，乙、丙各需\(1\text{ 人}\)承担. 从\(10\) 人中选派\(4\) 人承担这三项任务，不同的选法共有（\quad）
...
\begin{solution}
当 \(a>1\) 时，\(\frac{1}{2}[f(x_1)+f(x_2)]\leqslant f\left(\frac{x_1+x_2}{2}\right)\)；当 \(0<a<1\) 时，\(\frac{1}{2}[f(x_1)+f(x_2)]\geqslant f\left(\frac{x_1+x_2}{2}\right)\). 当且仅当 \(x_1=x_2\) 时取等号.
\end{solution}
...
\begin{solution}
轨迹方程为 \((\lambda^2-1)(x^2+y^2)-4\lambda^2x+1+4\lambda^2=0\). 当 \(\lambda=1\) 时，轨迹为直线 \(x=\frac{5}{4}\)；当 \(\lambda\neq1\) 时，轨迹为圆，圆心为 \(\left(\frac{2\lambda^2}{\lambda^2-1},0\right)\)，半径为 \(\frac{\sqrt{3\lambda^2+1}}{|\lambda^2-1|}\).
\end{solution}
