...
\bitmapfigure[max width=0.88\linewidth,max totalheight=6.0cm,trim=0 2.46cm 0 0,clip]{img/1994/national_science/q12_options.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm,trim=0 5.29cm 0 0,clip]{img/1994/national_science/q23_fig1.png}
...
\item 令 \(b_{n} = \frac{1}{2}\left(\frac{a_{n}}{a_{n+1}} + \frac{a_{n+1}}{a_{n}}\right)\)（\(n \in \mathbb{N}\)），求 \(\displaystyle\lim_{n \to \infty}(b_{1} + b_{2} + \cdots + b_{n} - n)\).
\end{enumerate}
\end{problem}
