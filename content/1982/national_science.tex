...
\begin{enumerate}
\item \(\left| \begin{array}{ccc} 2x & 1 & 1 \\ -3y & 2 & 3 \\ 6 & 3 & 4 \end{array} \right|=0\)；
\item \(\left\{\begin{aligned} x&=1+\cos \varphi \\ y&=2\sin \varphi \end{aligned}\right.\).
\end{enumerate}
