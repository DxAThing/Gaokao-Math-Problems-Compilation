...
\begin{center}
\bitmapinclude[max width=0.42\linewidth,max totalheight=3.0cm]{img/2002/beijing_science_autumn/q11_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=0.95\linewidth,max totalheight=3.0cm]{img/2002/beijing_science_autumn/q12_fig1.png}
\end{center}
...
\begin{flushright}
\bitmapinclude[max width=0.52\linewidth,max totalheight=6.0cm]{img/2002/beijing_science_autumn/q18_fig1.png}
\end{flushright}
\end{problem}
...
\item 若数列 \(\{x_n\}\) 的极限存在，且大于零，求 \(\displaystyle\lim_{n\to\infty}x_n\) 的值.
\end{enumerate}
\end{problem}
