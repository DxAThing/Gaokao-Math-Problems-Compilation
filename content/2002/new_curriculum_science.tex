...
\begin{solution}
\(\cos \left(2\alpha + \frac{\pi}{4}\right)=-\frac{31\sqrt{2}}{50}\).
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 可取 \(A(0,0,0)\)，\(B(0,a,0)\)，\(A_{1}(0,0,\sqrt{2}a)\)，\(C_{1}\left(-\frac{\sqrt{3}}{2}a,\frac{a}{2},\sqrt{2}a\right)\).
\item \(AC_{1}\) 与侧面 \(ABB_{1}A_{1}\) 所成的角为 \(30^{\circ}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(MN=\sqrt{\left(a-\frac{\sqrt{2}}{2}\right)^{2}+\frac{1}{2}}\).
\item 当 \(a=\frac{\sqrt{2}}{2}\) 时，\(MN\) 的长最小，最小值为 \(\frac{\sqrt{2}}{2}\).
\item \(\alpha=\arccos\left(-\frac{1}{3}\right)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 至少 \(3\) 人同时上网的概率为 \(\frac{21}{32}\).
\item 至少 \(5\) 人同时上网时，该概率小于 \(0.3\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item 切线 \(l\) 的方程为
\(y-\frac{1-ax_{1}}{x_{1}}=-\frac{1}{x_{1}^{2}}(x-x_{1})\).

\item \(x_{2}=x_{1}(2-ax_{1})\).
\begin{enumerate}
\item \(0<x_{2}\leqslant\frac{1}{a}\).
\item 当 \(x_{1}<\frac{1}{a}\) 时，\(x_{1}<x_{2}<\frac{1}{a}\).
\end{enumerate}
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 点 \(P\) 的轨迹是以原点为圆心、\(\sqrt{3}\) 为半径的右半圆：\(x^{2}+y^{2}=3\)，\(x>0\).
\item \(\tan\theta=\lvert y_{0}\rvert=\sqrt{3-x_{0}^{2}}\).
\end{enumerate}
\end{solution}
