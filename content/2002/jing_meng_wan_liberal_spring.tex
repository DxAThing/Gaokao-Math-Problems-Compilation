...
\bitmapfigure[max width=0.48\linewidth,max totalheight=4.8cm]{img/2002/jing_meng_wan_liberal_spring/q15_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.40\linewidth,max totalheight=4.8cm]{img/2002/jing_meng_wan_liberal_spring/q19_fig1.png}
\end{problem}
...
\item 求 \(\displaystyle\lim_{n\to\infty}x_{n}\).
\end{enumerate}
\end{problem}
