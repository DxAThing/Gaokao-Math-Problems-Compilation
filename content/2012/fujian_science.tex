...
\begin{problem}
在平面直角坐标系中，以坐标原点 \(O\) 为极点，\(x\) 轴的正半轴为极轴建立极坐标系. 已知直线 \(l\) 上两点 \(M,N\) 的极坐标分别为 \((2,0)\)，\(\left(\frac{2\sqrt{3}}{3},\frac{\pi}{2}\right)\)，圆 \(C\) 的参数方程为 \(\left\{\begin{aligned}x &= 2 + 2\cos\theta,\\ y &= -\sqrt{3} + 2\sin\theta,\end{aligned}\right.\)（\(\theta\) 为参数）.
