...
\end{enumerate}
\begin{solution}
短答案：\(x=15\)，\(y=20\)；平均结算时间为 \(1.9\) 分钟；概率为 \(\frac{7}{10}\).
\end{solution}
\end{problem}
...
\begin{solution}
短答案：\(f(x)=2\sin\left(2x+\frac{\pi}{6}\right)\)；\(g(x)\) 的单调递增区间为 \(\left[k\pi-\frac{\pi}{12},k\pi+\frac{5\pi}{12}\right]\)，\(k\in\Z\).
\end{solution}
\end{problem}
...
\end{enumerate}
\begin{solution}
短答案：\(a_{1}=3000-d\)，\(a_{2}=\frac{3}{2}a_{1}-d\)，且 \(a_{n+1}=\frac{3}{2}a_{n}-d\)；\(d=\dfrac{1000\left(3^{m}-2^{m+1}\right)}{3^{m}-2^{m}}\).
\end{solution}
\end{problem}
...
\end{enumerate}
\begin{solution}
短答案：椭圆方程为 \(\dfrac{x^{2}}{16}+\dfrac{y^{2}}{12}=1\)；\(P\) 的坐标为 \((-2,3)\)、\((-2,-3)\)、\(\left(\frac{18}{5},\frac{\sqrt{57}}{5}\right)\)、\(\left(\frac{18}{5},-\frac{\sqrt{57}}{5}\right)\).
\end{solution}
\end{problem}
