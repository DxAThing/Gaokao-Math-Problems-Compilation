...
\bitmapfigure[scale=1.35,max width=0.42\linewidth,max totalheight=7.2cm]{img/2012/tianjin_science/q3_fig1.png}
...
\begin{problem}
已知抛物线的参数方程为 \(\begin{cases}x = 2pt^2,\\ y = 2pt,\end{cases}\)（\(t\) 为参数），其中 \(p > 0\)，焦点为 \(F\)，准线为 \(l\)，过抛物线上一点 \(M\) 作 \(l\) 的垂线，垂足为 \(E\)，若 \(|EF| = |MF|\)，点 \(M\) 的横坐标是 3，则 \(p = \)\fillinblank{}.
\end{problem}
