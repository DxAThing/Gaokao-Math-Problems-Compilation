...
\bitmapfigure[max width=0.70\linewidth]{img/2012/anhui_liberal/q6_fig1.png}
...
\bitmapfigure[max width=0.58\linewidth]{img/2012/anhui_liberal/q12_fig1.png}
\end{problem}
...
\begin{solution}
短答案：第（1）问为 \(A=\frac{\pi}{3}\)，第（2）问为 \(AD=\frac{\sqrt{7}}{2}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问缺少的数据依次为 \(5\)，\(0.16\)，\(25\)，\(0.20\)，\(2\)，\(0.04\)；第（2）问为 \(0.70\)；第（3）问为 \(1980\) 件.
\end{solution}
...
\bitmapfigure[max width=0.42\linewidth]{img/2012/anhui_liberal/q19_fig1.png}
\end{problem}

\begin{solution}
短答案：第（1）问为 \(BD \perp EC_{1}\)，第（2）问为 \(AA_{1}=3\sqrt{2}\).
\end{solution}
...
\bitmapfigure[max width=0.42\linewidth]{img/2012/anhui_liberal/q20_fig1.png}
\end{problem}

\begin{solution}
短答案：第（1）问离心率为 \(\frac{1}{2}\)，第（2）问为 \(a=10\)，\(b=5\sqrt{3}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问为 \(x_n=-\frac{2\pi}{3}+2n\pi\)，\(n\in\mathbb{N}_{+}\)；第（2）问为 \(\sin S_n=\sin\left(-\frac{2n\pi}{3}\right)\).
\end{solution}
