...
\begingroup
\bitmappreparecaption{img/2012/jiangxi_science/q14_flowchart.png}%
\begin{center}
\adjustbox{max width=0.62\linewidth,max totalheight=7.0cm}{\includegraphics{img/2012/jiangxi_science/q14_flowchart.png}}
\bitmapinsertcaption
\end{center}
\endgroup
\end{problem}
