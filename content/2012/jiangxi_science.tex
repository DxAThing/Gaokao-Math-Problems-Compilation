...
\begin{solution}
\begin{enumerate}
\item 短答案：\(k=4\)，\(a_{1}=\frac{7}{2}\)，\(a_{n}=\frac{9}{2}-n\)（\(n\geqslant2\)）.
\item 短答案：\(T_{n}=4-\frac{n+2}{2^{n-1}}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(B-C=\frac{\pi}{2}\).
\item 短答案：\(\triangle ABC\) 的面积为 \(\frac{1}{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：存在点 \(E\)，且 \(AE=\frac{\sqrt{5}}{5}\).
\item 短答案：平面 \(A_{1}B_{1}C\) 与平面 \(BB_{1}C_{1}C\) 夹角的余弦值为 \(\frac{\sqrt{30}}{10}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：曲线 \(C\) 的方程为 \(x^{2}=4y\).
\item 短答案：存在定点，\(t=-1\)，且 \(\triangle QAB\) 与 \(\triangle PDE\) 的面积之比为 \(2\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：函数 \(h(x)\) 是补函数.
\item 短答案：\(\lambda\in[3,+\infty)\).
\item 短答案：\(p\in(1,+\infty)\).
\end{enumerate}
\end{solution}
