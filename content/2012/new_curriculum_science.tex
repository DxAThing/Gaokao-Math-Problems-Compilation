...
\item
\begin{enumerate}
\item \(P(X=60)=0.1\)，\(P(X=70)=0.2\)，\(P(X=80)=0.7\)，\(E(X)=76\)，\(D(X)=44\).
\item 应购进 \(17\) 枝；其数学期望利润为 \(76.4\) 元，购进 \(16\) 枝的数学期望利润为 \(76\) 元.
\end{enumerate}
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(DC_{1}\perp BC\).
\item 二面角 \(A_{1}-BD-C_{1}\) 的大小为 \(30^{\circ}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(f(x)=\e^{x}-x+\frac{1}{2}x^{2}\)，单调递减区间为 \((-\infty,0)\)，单调递增区间为 \((0,+\infty)\).
\item \((a+1)b\) 的最大值为 \(\frac{\e}{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 解集为 \(\{x\mid x\leqslant1\text{ 或 }x\geqslant4\}\).
\item \(a\in[-3,0]\).
\end{enumerate}
\end{solution}
