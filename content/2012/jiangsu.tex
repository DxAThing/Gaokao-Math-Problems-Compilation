...
\begin{problem}
设 \(f(x)\) 是定义在 \(\R\) 上且周期为 \(2\) 的函数，且在区间 \([-1,1]\) 上，
\[
f(x)=\begin{cases}
ax+1, & -1 \leqslant x < 0,\\
...
\begin{problem}
设集合 \(P_n = \{1,2,\cdots,n\}\)，\(n \in \mathbf{N}^*\). 记 \(f(n)\) 为同时满足下列条件的集合 \(A\) 的个数：\(\circled{1}\) \(A \subseteq P_n\)；\(\circled{2}\) 若 \(x \in A\)，则 \(2x \notin A\)；\(\circled{3}\) 若 \(x \in C_{P_n}A\)，则 \(2x \notin C_{P_n}A\).
