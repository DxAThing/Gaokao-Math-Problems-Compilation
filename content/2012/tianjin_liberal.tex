...
\item
\begin{enumerate}
\item \(\{1,2\}\)，\(\{1,3\}\)，\(\{1,a\}\)，\(\{1,b\}\)，\(\{1,A\}\)，\(\{2,3\}\)，\(\{2,a\}\)，\(\{2,b\}\)，\(\{2,A\}\)，\(\{3,a\}\)，\(\{3,b\}\)，\(\{3,A\}\)，\(\{a,b\}\)，\(\{a,A\}\)，\(\{b,A\}\).
\item \(\frac{1}{3}\).
\end{enumerate}
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\sin C=\frac{\sqrt{7}}{4}\)，\(b=1\).
\item \(\cos\left(2A+\frac{\pi}{3}\right)=\frac{-3+\sqrt{21}}{8}\).
\end{enumerate}
\end{solution}
...
\end{enumerate}
\bitmapfigure[max width=0.46\linewidth]{img/2012/tianjin_liberal/q17_fig1.png}
\end{problem}
...
\item 平面 \(PDC\perp\) 平面 \(ABCD\).

\item \(\frac{\sqrt{39}}{13}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_n=3n-1\)，\(b_n=2^n\).
\item \(T_n-8=a_{n-1}b_{n+1}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 增区间为 \((-\infty,-1)\) 和 \((a,+\infty)\)，减区间为 \((-1,a)\).
\item \(a\in\left(0,\frac{1}{3}\right)\).
\item 最小值为 \(\frac{4}{3}\).
\end{enumerate}
\end{solution}
