...
\begin{solution}
\begin{enumerate}
\item \(\cos B=\dfrac{1}{2}\).
\item \(\sin A\sin C=\dfrac{3}{4}\).
\end{enumerate}
\end{solution}
...
没有理由认为“体育迷”与性别有关.
\item \(X\sim B\left(3,\dfrac{1}{4}\right)\)，且
\begin{center}
...
\begin{solution}
\begin{enumerate}
\item \( \dfrac{x^{2}}{a^{2}}-\dfrac{y^{2}}{b^{2}}=1 \)，其中 \(x<-a\)，\(y<0\).
\item \(t_{1}^{2}+t_{2}^{2}=a^{2}+b^{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C_{1}\)：\(\rho=2\)，\(C_{2}\)：\(\rho=4\cos\theta\)；交点坐标为 \(\left(2,\dfrac{\pi}{3}\right)\)，\(\left(2,\dfrac{5\pi}{3}\right)\).
\item 公共弦的参数方程为
\[
\begin{cases}
x=1,\\
