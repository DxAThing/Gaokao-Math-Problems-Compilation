...
短答案：
\begin{enumerate}
\item \(x=15\)，\(y=20\)，\(P(X=1)=\frac{3}{20}\)，\(P(X=1.5)=\frac{3}{10}\)，\(P(X=2)=\frac{1}{4}\)，\(P(X=2.5)=\frac{1}{5}\)，\(P(X=3)=\frac{1}{10}\)，\(E(X)=1.9\).
\item \(\frac{9}{80}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{enumerate}
\item \(CD\perp\) 平面 \(PAE\).
\item 四棱锥 \(P-ABCD\) 的体积为 \(\frac{128\sqrt{5}}{15}\).
\end{enumerate}
\end{solution}
\end{problem}
...
短答案：
\begin{enumerate}
\item \(T_A(x)=\frac{1000}{x}\)，\(T_B(x)=\frac{2000}{kx}\)，\(T_C(x)=\frac{1500}{200-(1+k)x}\)，其中 \(0<x<\frac{200}{1+k}\)，\(x\in\N^*\).
\item \(k=2\) 时完成时间最短，人数分组为 \(44\)，\(88\)，\(68\)，最短时间为 \(\frac{250}{13}\) 天.
\end{enumerate}
\end{solution}
\end{problem}
