...
\centering
\bitmapinclude[max width=\linewidth,max totalheight=3.0cm]{img/1987/national_science/q8_optA.png}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}
\centering
\bitmapinclude[max width=\linewidth,max totalheight=3.0cm]{img/1987/national_science/q8_optB.png}
\end{minipage}
...
\begin{minipage}[t]{0.48\linewidth}
\centering
\bitmapinclude[max width=\linewidth,max totalheight=3.0cm]{img/1987/national_science/q8_optC.png}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}
\centering
\bitmapinclude[max width=\linewidth,max totalheight=3.0cm]{img/1987/national_science/q8_optD.png}
\end{minipage}
\end{center}
...
求极限：\(\lim\limits_{n \to \infty}\left(\frac{1}{n^2 + 1} + \frac{2}{n^2 + 1} + \frac{3}{n^2 + 1} + \cdots + \frac{2n}{n^2 + 1}\right)\).
...
\item 当 \(0 < b < 1\) 时，求极限 \(\lim\limits_{n\to\infty} S_n\).
\end{enumerate}
...
求极限：\(\lim\limits_{n\to\infty}\left(1 - \frac{1}{2x}\right)^x\).
