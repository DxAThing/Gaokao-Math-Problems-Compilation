...
\begin{solution}
\(2+\sqrt{3}\i\) 或 \(\frac{1}{2}-\frac{\sqrt{3}}{2}\i\).
\end{solution}
...
\begin{solution}
\(|z_1 + A||z_2 + A| = |A|^2\)，且 \(\frac{z_1 + A}{z_2 + A} = \left|\frac{z_1 + A}{z_2 + A}\right|\).
\end{solution}
...
\begin{solution}
\(a_n=-\frac{k^{n-1}}{(k-1)^n}\)（\(k\neq 0\)）；当 \(k=0\) 时，\(a_1=1\)，\(a_n=0\)（\(n>1\)）. 当 \(\displaystyle\lim_{n\to\infty}S_n=1\) 时，\(k<\frac{1}{2}\).
\end{solution}
