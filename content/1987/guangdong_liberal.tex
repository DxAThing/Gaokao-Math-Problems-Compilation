...
\begin{aligned}
S_{2n}
&=\tan\theta-\tan^{3}\theta+\cdots+(-1)^{n+1}\tan^{2n-1}\theta\\
&=\frac{\tan\theta[1+(-1)^{n+1}\tan^{2n}\theta]}{1+\tan^{2}\theta}
=\frac12\sin2\theta[1+(-1)^{n+1}\tan^{2n}\theta]
\end{aligned}
\]

\item
当 \(n=2k\) 时，\(a_n=0\)，且 \(a_{n-1}a_{n+1}=(-1)^{2k+1}\tan^{4k}\theta=-\tan^{4k}\theta\).

又 \((-1)^n(a_1^n)^2=\tan^{4k}\theta\)，两项相消.

当 \(n=2k-1\) 时，\(a_{n-1}a_{n+1}=0\)，而 \(a_n^2=\tan^{4k-2}\theta\)，\((-1)^n(a_1^n)^2=-\tan^{4k-2}\theta\)，故等式均成立.
\end{enumerate}
\end{solution}
