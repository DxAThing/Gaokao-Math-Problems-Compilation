...
\begin{solution}
\begin{enumerate}
    \item 平面 \(AMD\perp\) 平面 \(BMC\).
    \item 存在，且 \(P\) 为线段 \(AM\) 的中点.
\end{enumerate}
\end{solution}
...
\begin{enumerate}
    \item \(k< -\dfrac12\).
    \item \(2\left|\overrightarrow{FP}\right|=\left|\overrightarrow{FA}\right|+\left|\overrightarrow{FB}\right|\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
    \item \(\alpha\in\left(\dfrac\pi4,\dfrac{3\pi}4\right)\).
    \item 中点 \(P\) 的轨迹参数方程为
    \[
    x=\dfrac{\sqrt2}{2}\sin2\alpha,\qquad
    y=-\dfrac{\sqrt2}{2}-\dfrac{\sqrt2}{2}\cos2\alpha,
    \quad \dfrac\pi4<\alpha<\dfrac{3\pi}4.
    \]
\end{enumerate}
\end{solution}
