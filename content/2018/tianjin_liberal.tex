...
\bitmapfigure[max width=6.0cm,max totalheight=6.2cm]{img/2018/tianjin_liberal/q4_fig1.png}
...
\bitmapfigure[max width=6.0cm,max totalheight=3cm]{img/2018/tianjin_liberal/q8_fig1.png}
...
\bitmapfigure[max width=6.0cm,max totalheight=3.5cm]{img/2018/tianjin_liberal/q11_fig1.png}
...
\begin{problem}
已知 \(a\in\R\)，函数 \(f(x)= \begin{cases} x^2+2x+a-2,x\le0, -x^2+2x-2a,x>0. \end{cases}\)
...
\bitmapfigure[max width=6.0cm,max totalheight=3cm]{img/2018/tianjin_liberal/q17_fig1.png}
