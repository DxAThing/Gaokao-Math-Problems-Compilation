...
\bitmapfigure[max width=3.2cm,max totalheight=5.4cm]{img/2018/tianjin_liberal/q4_fig1.png}
...
\bitmapfigure[max width=3.2cm,max totalheight=3cm]{img/2018/tianjin_liberal/q8_fig1.png}
...
\bitmapfigure[max width=3.1cm,max totalheight=3.5cm]{img/2018/tianjin_liberal/q11_fig1.png}
...
（ii）不妨设来自甲年级的是 \(A,B,C\)，来自乙年级的是 \(D,E\)，来自丙年级的是 \(F,G\). 则抽取的 \(2\) 名同学来自同一年级的所有可能结果为 \(\{A,B\}\)，\(\{A,C\}\)，\(\{B,C\}\)，\(\{D,E\}\)，\(\{F,G\}\)，共 \(5\) 种. 所以 \(P(M)=\frac5{21}\).
\end{solution}
\begin{problem}
...
\bitmapfigure[max width=4.2cm,max totalheight=3cm]{img/2018/tianjin_liberal/q17_fig1.png}
