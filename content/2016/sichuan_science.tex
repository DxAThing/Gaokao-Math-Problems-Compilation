...
\begin{enumerate}
\item \(a=0.3\).
\item 估计全市居民中月均用水量不低于 \(3\) 吨的人数为 \(3.6\) 万.
\item \(x=2.9\) 吨.
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item 取 \(M=AB\cap CD\).
\item 直线 \(PA\) 与平面 \(PCE\) 所成角的正弦值为 \(\dfrac{1}{3}\).
\end{enumerate}
\end{solution}
...
短答案：
\begin{enumerate}
\item 椭圆方程为 \(\dfrac{x^2}{6}+\dfrac{y^2}{3}=1\)，\(T=(2,1)\).
\item \(\lambda=\dfrac54\).
\end{enumerate}
\end{solution}
...
短答案：
\begin{enumerate}
\item 当 \(a\leqslant0\) 时，\(f(x)\) 在 \((0,+\infty)\) 上单调递减；当 \(a>0\) 时，\(f(x)\) 在 \(\left(0,\dfrac{1}{\sqrt{2a}}\right)\) 上单调递减，在 \(\left(\dfrac{1}{\sqrt{2a}},+\infty\right)\) 上单调递增.
\item \(a\geqslant\dfrac12\).
\end{enumerate}
\end{solution}
