...
\bitmapfigure[max width=6.0cm,max totalheight=4.4cm]{img/2016/shanghai_science/q6_fig1.png}
...
\begin{problem}
设 \(a>0\)，\(b>0\)，若关于 \(x,y\) 的方程组 \(\begin{cases} ax+y=1, x+by=1 \end{cases}\)
...
\bitmapfigure[max width=6.0cm,max totalheight=3.3cm]{img/2016/shanghai_science/q12_fig1.png}
...
\bitmapfigure[max width=6.0cm,max totalheight=4cm]{img/2016/shanghai_science/q14_fig1.png}
...
\bitmapfigure[max width=6.0cm,max totalheight=3.4cm]{img/2016/shanghai_science/q16_fig1.png}
...
\item 若 \(f(x)+g(x)\)，\(f(x)+h(x)\)，\(g(x)+h(x)\) 均是以 \(T\) 为周期的函数，
\end{circlelist}
则 \(f(x),g(x),h(x)\) 均是以 \(T\) 为周期的函数. 下列判断正确的是（\quad）
...
\bitmapfigure[max width=6.0cm,max totalheight=4.2cm]{img/2016/shanghai_science/q20_fig1.png}
