...
\begin{solution}
短答案：第（1）问为 \(\frac{5}{16}\)；第（2）问获得水杯的概率为 \(\frac{3}{8}\)，获得饮料的概率为 \(\frac{5}{16}\)，所以获得水杯的概率较大.
\end{solution}
...
\begin{solution}
短答案：第（1）问的单调递增区间为 \(\left[-\frac{\pi}{12}+k\pi,\frac{5\pi}{12}+k\pi\right]\)，其中 \(k\in\Z\)；第（2）问为 \(g\left(\frac{\pi}{6}\right)=\sqrt{3}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问证明结论为 \(AC\perp FB\)；第（2）问证明结论为 \(GH\parallel\) 平面 \(ABC\).
\end{solution}
...
\begin{solution}
短答案：第（1）问为 \(b_n=3n+1\)；第（2）问为 \(T_n=3n\cdot2^{n+2}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问当 \(a\leq0\) 时，\(g(x)\) 在 \((0,+\infty)\) 上单调递增；当 \(a>0\) 时，\(g(x)\) 在 \(\left(0,\frac{1}{2a}\right)\) 上单调递增，在 \(\left(\frac{1}{2a},+\infty\right)\) 上单调递减；第（2）问为 \(a\in\left(\frac12,+\infty\right)\).
\end{solution}
...
\begin{solution}
短答案：第（1）问椭圆方程为 \(\dfrac{x^2}{4}+\dfrac{y^2}{2}=1\)；第（2）问（i）为 \(\dfrac{k'}{k}=-3\)，（ii）直线 \(AB\) 的斜率最小值为 \(\dfrac{\sqrt{6}}{2}\).
\end{solution}
