...
\begin{problem}
（\(B_1\)）设 \(\bs{a}=(m+1)\bs{i}-3\bs{j}\)，\(\bs{b}=\bs{i}+(m-1)\bs{j}\)，\(\left(\bs{a}+\bs{b}\right)\perp\left(\bs{a}-\bs{b}\right)\)，则 \(m=\fillinblank{}\).
...
\begin{solution}
（1）【法一】设 \(z_1=a+b\i\)，\(z_2=a-b\i\)（\(a\)，\(b \in \R\) 且 \(b \neq 0\)）. 由 \(z_1^2=z_2\)，得 \(a^2-b^2+2ab\i=a-b\i\)，于是 \(\begin{cases}a^2-b^2=a,\\2ab=-b.\end{cases}\) 解得 \(a=-\frac{1}{2}\)，\(b=\frac{\sqrt{3}}{2}\)，所以 \(z_1=-\frac{1}{2}+\frac{\sqrt{3}}{2}\i\)，\(z_2=-\frac{1}{2}-\frac{\sqrt{3}}{2}\i\)，或 \(z_1=-\frac{1}{2}-\frac{\sqrt{3}}{2}\i\)，\(z_2=-\frac{1}{2}+\frac{\sqrt{3}}{2}\i\).
