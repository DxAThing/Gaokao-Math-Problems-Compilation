...
\begin{problem}
三个数 \(6^{0.7}\)，\(0.7^{0}\)，\(\log_{0.7}6\) 的大小顺序是……（\quad）

\choices
    {\(0.76 < \log_{0.7}6 < 6^{0.7}\).}
    {\(0.76 < 6^{0.7} < \log_{0.7}6\).}
...
\choices
    ...
    {若 \(a\)，\(b\) 是异面直线，则一定存在平面 \(\alpha\) 与 \(\alpha\)，\(b\) 的距离相等.}
...
\begin{problem}
已知 \(\mathrm{tg} = \frac{\alpha}{2} = \frac{1}{3}\)，求 \(\sin \left(\alpha+\frac{\pi}{6}\right)\) 的值.
...
解法一：因为
\[
\sin \alpha=\frac{2 \operatorname{tg} \frac{\alpha}{2}}{1+\operatorname{tg}^2 \frac{\alpha}{2}}=\frac{2 \times \frac{1}{2}}{1+\frac{1}{4}}=\frac{4}{5}
\]
\[
\cos \alpha=\frac{1-\operatorname{tg}^2 \frac{\alpha}{2}}{1+\operatorname{tg}^2 \frac{\alpha}{2}}=\frac{1-\frac{1}{4}}{1+\frac{1}{4}}=\frac{3}{5}
\]
...
解法二：由 \(\operatorname{tg} \frac{\alpha}{2}=\frac{1}{2}, 0 < \frac{3}{2} < 1\)，知 \(\alpha\) 为第一象限角. 又
\[
\operatorname{tg} \alpha=\frac{2 \operatorname{tg} \frac{\alpha}{2}}{1-\operatorname{tg}^2 \frac{\alpha}{2}}=\frac{2 \times \frac{1}{2}}{1-\frac{1}{4}}=\frac{4}{3}
\]
\[
\begin{array}{l}
...
\]
\[
\operatorname{tg} \theta=-\frac{2m}{1+m^2}=-\frac{2}{m+\frac{1}{m}}
\]
由 \(m>0\)，知 \(m+\frac{1}{m} \geqslant 2\). 于是 \(-1 \leqslant \operatorname{tg} \theta < 0\). 又由 \(-(m^2+1)<0\)，\(2m>0\)，得 \(\frac{3\pi}{4} \leqslant \theta < \pi\). 因此，所求 \(\theta\) 的取值范围为 \(\left[\frac{3\pi}{4}, \pi\right)\).
\end{solution}
