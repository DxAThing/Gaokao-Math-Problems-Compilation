...
\bitmapinlinefigure[10.5cm]{img/2007/new_curriculum_science/q17_fig1.png}
\end{problem}

\begin{solution}
短答案：\(\displaystyle \frac{s\sin\beta\tan\theta}{\sin(\alpha+\beta)}\).
\end{solution}
...
\begin{solution}
短答案：\(\displaystyle \frac{1}{\sqrt{3}}\).
\end{solution}
...
\begin{enumerate}
\item \(k\) 的取值范围为 \(\left(-\infty,-\frac{\sqrt{2}}{2}\right)\cup\left(\frac{\sqrt{2}}{2},+\infty\right)\).
\item 不存在.
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(a=\frac{3}{2}\)；在 \(\left(-\frac{3}{2},-1\right)\) 和 \(\left(-\frac{1}{2},+\infty\right)\) 上单调递增，在 \(\left(-1,-\frac{1}{2}\right)\) 上单调递减.
\item \(a>\sqrt{2}\)，且所有极值之和大于 \(\ln\frac{\e}{2}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(x^{2}+y^{2}-4x=0\)，\(x^{2}+y^{2}+4y=0\).
\item \(y=-x\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(x\in\left(-\infty,-7\right)\cup\left(\frac{5}{3},+\infty\right)\).
\item 最小值为 \(-\frac{9}{2}\).
\end{enumerate}
\end{solution}
