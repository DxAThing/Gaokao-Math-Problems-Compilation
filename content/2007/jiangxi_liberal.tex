...
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.0cm]{img/2007/jiangxi_liberal/q16_fig1.png}
...
\begin{problem}
已知函数 \( f(x)=\left\{\begin{aligned}&cx+1,&0<x<c,\\ &2^{-\frac{x}{c^{2}}}+1,&c\leqslant x<1,\end{aligned}\right. \) 在区间 \( (0,1) \) 内连续，且 \( f(c^{2})=\frac{9}{8}. \)
...
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.0cm]{img/2007/jiangxi_liberal/q18_fig1.png}

\begin{enumerate}
\item 求 \( \theta \) 和 \( \omega \) 的值；
\item 已知点 \(A\left(\frac{\pi}{2}, 0\right)\)，点 \(P\) 是该函数图象上的一点，点 \(Q(x_0, y_0)\) 是 \(PA\) 的中点，当 \(y_0 = \frac{\sqrt{3}}{2}, x_0 \in \left[\frac{\pi}{3}, \pi\right]\) 时，求 \(x_0\) 的值.
\end{enumerate}
\fillinblank{}
\end{problem}
...
\bitmapfigure[max width=0.52\linewidth,max totalheight=5.2cm]{img/2007/jiangxi_liberal/q20_fig1.png}
...
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.0cm]{img/2007/jiangxi_liberal/q22_fig1.png}
