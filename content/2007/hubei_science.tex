...
\begin{problem}
已知直线 \(\frac{x}{a} + \frac{y}{b} = 1\)（\(a\)，\(b\) 是非零常数）与圆 \(x^2 + y^2 = 100\) 有公共点，且公共点的横坐标和纵坐标均为整数，那么这样的直线共有（\(\quad\)）
...
\begin{solution}
\begin{enumerate}
\item \(\theta\in\left[\frac{\pi}{4},\frac{\pi}{2}\right]\).
\item 最大值为 \(3\)，最小值为 \(2\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 频率依次为 \(0.04\)，\(0.25\)，\(0.30\)，\(0.29\)，\(0.10\)，\(0.02\)，合计为 \(1.00\).
\item 两个概率分别约为 \(0.69\) 和 \(0.44\).
\item 纤度的期望约为 \(1.4088\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 平面 \(VAB\perp\) 平面 \(VCD\).
\item 直线 \(BC\) 与平面 \(VAB\) 所成的角的取值范围为 \(\left(0,\frac{\pi}{4}\right)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\triangle ANB\) 面积的最小值为 \(2\sqrt{2}p^{2}\).
\item 存在，直线 \(l\) 的方程为 \(y=\frac{p}{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(b=\frac{5}{2}a^{2}-3a^{2}\ln a\)，且 \(b\) 的最大值为 \(\frac{3}{2}\e^{\frac{2}{3}}\).
\item 当 \(x>0\) 时，\(f(x)\geqslant g(x)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 结论成立：当 \(x>-1\) 时，\((1+x)^{m}\geqslant 1+mx\).
\item 结论成立：对 \(m=1,2,\ldots,n\)，有 \(\left(1-\frac{m}{n+3}\right)^{m}<\frac{1}{2}\).
\item \(n=2\) 或 \(n=3\).
\end{enumerate}
\end{solution}
