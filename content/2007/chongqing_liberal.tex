...
\begin{solution}
短答案：第（1）问为 \(\frac{3}{20}\)，第（2）问为 \(\frac{193}{400}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问为 \(x \ne \frac{\pi}{2}+k\pi\)，\(k\in\Z\)；第（2）问为 \(\frac{56}{15}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问为 \(\frac{4}{5}\)，第（2）问为 \(\frac{73}{150}\).
\end{solution}
...
\begin{solution}
短答案：长为 \(2 \mathrm{~m}\)，宽为 \(1 \mathrm{~m}\)，高为 \(1.5 \mathrm{~m}\) 时体积最大，最大体积为 \(3 \mathrm{~m}^{3}\).
\end{solution}
...
\bitmapinlinefigure[9.0cm]{img/2007/chongqing_liberal/q21_fig1.png}
\end{problem}

\begin{solution}
短答案：第（1）问为 \(F=(2,0)\)，准线 \(l\) 的方程为 \(x=-2\)；第（2）问定值为 \(8\).
\end{solution}
...
\begin{solution}
短答案：第（1）问为 \(a_{n}=3n-2\)；第（2）问结论为 \(3T_{n}+1>\log_{2}(a_{n}+3)\).
\end{solution}
