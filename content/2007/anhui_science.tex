...
\(2x-\frac{\pi}{3}=\frac{\pi}{2}+k\pi\)，\((k\in\Z)\)
...
\(\frac{c^2}{4a^2}-\frac{3c^2}{4b^2}=1\)，\(b^2=c^2-a^2=a^2(e^2-1)\).
因此
\[
...
\(P_i=\left(\frac{i}{n},0\right)\)，\(Q_i=\left(\frac{i}{n},1-\frac{i^2}{n^2}\right)\)，\((1\leqslant i\leqslant n-1)\).
...
\(D=(0,0,0)\)，\(A=(2,0,0)\)，\(C=(0,2,0)\)，\(B=(2,2,0)\)
\(D_1=(0,0,2)\)，\(A_1=(1,0,2)\)，\(C_1=(0,1,2)\)，\(B_1=(1,1,2)\).
\begin{enumerate}
\item
\(\overrightarrow{A_1C_1}=(-1,1,0)=\frac12\overrightarrow{AC}\)，\(\overrightarrow{B_1D_1}=(-1,-1,0)=\frac12\overrightarrow{BD}\).
...
\(\overrightarrow{BA}\cdot\overrightarrow{BB_1}=2\)，\(|\overrightarrow{BB_1}|^2=6\)
可得
\[
...
\(\overrightarrow{MA}=\left(\frac13,-\frac53,-\frac23\right)\)，\(\overrightarrow{MC}=\left(-\frac53,\frac13,-\frac23\right)\)
得
\(\overrightarrow{MA}\cdot\overrightarrow{MC}=-\frac23\)，\(|\overrightarrow{MA}|^2=|\overrightarrow{MC}|^2=\frac{10}{3}\).
所以
\[
...
\]
得
\(F(x)=xf'(x)=x-2\ln x+2a\)，\(F'(x)=1-\frac2x=\frac{x-2}{x}\).
...
\(T_n=(1+r)T_{n-1}+a_n=(1+r)T_{n-1}+a_1+(n-1)d\)，\(n\geqslant2\).

\item 令
\(A_n=\frac{(a_1r+d)(1+r)^n}{r^2}\)，\(B_n=-\frac{d}{r}n-\frac{a_1}{r}-\frac{d}{r^2}\).
因为
\(\frac{A_n}{A_{n-1}}=1+r\)，\(B_n-B_{n-1}=-\frac{d}{r}\)
