...
\begin{problem}
如图，\( l_{1} \) 、 \( l_{2} \) 、 \( l_{3} \) 是同一平面网的三条平行直线，\( l_{1} \) 与 \( l_{2} \) 间的距离是 \( l_{1} \) 与 \( l_{3} \) 间的距离是 2，正三角形 \(\triangle ABC\) 的三顶点分别在 \( l_{1} \) 、 \( l_{2} \) 、 \( l_{3} \) 上，则 \( \triangle ABC \) 的边长是（\quad）
...
\begin{problem}
如图，在正三棱柱 \(ABC - A_{1}B_{1}C_{1}\) 中，侧棱长为 \(2\)，底面三角形的边长为 1，
