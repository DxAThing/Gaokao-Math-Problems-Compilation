...
\begin{problem}
设变量 \(x, y\) 满足约束条件 \(\left\{ \begin{array}{l} x - y \geqslant -1, \\ x + y \leqslant 4, \\ y \geqslant 2, \end{array} \right.\) 则目标函数 \(z = 2x + 4y\) 的最大值为（\quad）
...
\begin{problem}
在数列 \(\{a_{n}\}\) 中，\(a_{1} = 2\)，\(a_{n + 1} = 4a_{n} - 3n + 1\)，\(n \in \N^*\). (1) 证明数列 \( \{a_{n}-n\} \) 是等比数列; (2) 求数列 \( \{a_{n}\} \) 的前 n 项和 \( S_{n} \) ; (3) 证明不等式 \(S_{n+1} \leqslant 4S_n\) 对任意 \(n \in \N^*\) 皆成立.
\end{problem}
