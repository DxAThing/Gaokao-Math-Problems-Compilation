...
\texfigure[max width=0.38\linewidth,max totalheight=4.8cm]{img_repaint/2007/hubei_liberal/q6_fig1.tex}
...
\begin{problem}
设变量 \(x\)，\(y\) 满足约束条件 \( \begin{cases}x-y+3&\geqslant0,\\ x+y&\geqslant0,\\ -2&\leqslant x\leqslant3,\end{cases} \)，则目标函数 \(2x+y\) 的最小值为\fillinblank{}.
\end{problem}
