...
\begin{center}
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1996/national_science/q2_optA.png}\hfill
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1996/national_science/q2_optB.png}
\par
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1996/national_science/q2_optC.png}\hfill
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1996/national_science/q2_optD.png}
\end{center}
...
\begin{problem}
等比数列 \(\{a_{n}\}\) 的首项 \(a_1 = -1\)，前 \(n\) 项和为 \(S_{n}\)，若 \(\frac{S_{10}}{S_5} = \frac{31}{32}\)，则 \(\lim\limits_{n\to \infty} S_n\) 等于（\quad）
...
\bitmapfigure[max width=0.38\linewidth,max totalheight=4.4cm]{img/1996/national_science/q19_fig1.png}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.8cm]{img/1996/national_science/q22_fig1.png}
