...
=\frac{1}{6}
\]
得 \(\cos 2\alpha=\frac{1}{3}\). 又 \(2\alpha\in(\pi,2\pi)\)，得 \(\sin 2\alpha=-\frac{2\sqrt{2}}{3}\). 故
\[
...
\begin{center}
\bitmapinclude[page=3,pagebox=mediabox,trim=330pt 322pt 45pt 300pt,clip]{source/普通高考/1996/1996上海文.pdf}
\end{center}
\end{problem}

\begin{solution}
（1）由点 \(A\) 的坐标为 \((0,9)\)，得 \(c=9\)，即轨迹方程为 \(y=ax^2+9\). 令 \(y=0\)，得 \(ax^2+9=0\)，\(x^2=-\frac{9}{a}\). 由题意 \(6<\sqrt{-\frac{9}{a}}<7\)，解得
\[
...
\]
因为 \(a\in\left(-\frac{1}{2},1\right)\)，所以 \(a+1>0\). 从而
\[
w-u^2\ge 2\times2-3=1.
\]
...
\begin{solution}
（1）由 \(y=2x^2\)，得 \(y^\prime=4x\). 当 \(x=-1\) 时，\(y^\prime=-4\). 因此 \(l_1\) 的方程为
\[
y-2=-4(x+1),
\]
即
...
（2）由 \(y=2x^2\) 及 \(x=a\)，解得点 \(B\) 的坐标为 \((a,2a^2)\). 由 \(4x+y+2=0\) 及 \(x=a\)，解得点 \(D\) 的坐标为 \((a,-4a-2)\). 又可求得点 \(A\) 到直线 \(BD\) 的距离为 \(\left|a+1\right|\)，且
\[
\left|BD\right|=2a^2+4a+2=2\left(a+1\right)^2.
\]
因此
\[
S_1=\left|a+1\right|^3.
\]

（3）当 \(a>-1\) 时，
\[
S_2=\int_{-1}^{a}\left(2x^2+4x+2\right)\,\mathrm{d}x
=\frac{2}{3}\left(a+1\right)^3.
\]
当 \(a<-1\) 时，
\[
S_2=\int_{a}^{-1}\left(2x^2+4x+2\right)\,\mathrm{d}x
=-\frac{2}{3}\left(a+1\right)^3.
\]
所以
\[
...
\begin{center}
\bitmapinclude[page=4,pagebox=mediabox,trim=275pt 282pt 80pt 340pt,clip]{source/普通高考/1996/1996上海文.pdf}
\end{center}
\end{problem}

\begin{solution}
（1）由已知得双曲线的渐近线为 \(y=\pm x\)，因而 \(S\) 为等轴双曲线. 因为其一个顶点为 \(A^\prime(0,\sqrt{2})\)，所以双曲线 \(S\) 的方程为
\[
\frac{y^2}{2}-\frac{x^2}{2}=1.
\]

（2）若 \(B\left(x,\sqrt{x^2+2}\right)\) 是双曲线 \(S\) 的上支上到直线 \(l:y=x-\sqrt{2}\) 的距离为 \(\sqrt{2}\) 的点，则
\[
\frac{\left|x-\sqrt{x^2+2}-\sqrt{2}\right|}{\sqrt{2}}=\sqrt{2}.
\]
解得 \(x=\sqrt{2}\)，\(y=2\). 因此点 \(B\) 的坐标是 \((\sqrt{2},2)\).

（3）若直线 \(l^\prime:y=\frac{2\sqrt{5}}{5}x+m\) 与直线 \(l\) 平行，且两线间的距离是 \(\sqrt{2}\)，则点 \(A(\sqrt{2},0)\) 到直线 \(l^\prime\) 的距离为 \(\sqrt{2}\). 解得
\[
m_1=\frac{\sqrt{10}}{5},\qquad m_2=-\sqrt{10}.
\]
设
\[
l_1:y=\frac{2\sqrt{5}}{5}x+\frac{\sqrt{10}}{5},\qquad
l_2:y=\frac{2\sqrt{5}}{5}x-\sqrt{10}.
\]
由 \(y^2-x^2=2\) 及 \(y=\frac{2\sqrt{5}}{5}x+\frac{\sqrt{10}}{5}\)，得
\[
x^2-4\sqrt{2}x+8=0.
\]
因此 \(\Delta_1=0\)，所以直线 \(l_1\) 与双曲线 \(S\) 只有一个公共点.

由 \(y^2-x^2=2\) 及 \(y=\frac{2\sqrt{5}}{5}x-\sqrt{10}\)，得
\[
x^2+20\sqrt{2}x-40=0.
\]
因此 \(\Delta_2=960>0\)，所以直线 \(l_2\) 与双曲线 \(S\) 有两个公共点.
...
（1）由已知
\[
A_n=\frac{3}{2}(a_n-1)\qquad(n\in\N).
\]
当 \(n=1\) 时，
\[
a_1=\frac{3}{2}(a_1-1),
...
=\frac{3}{2}(a_n-a_{n-1}),
\]
由此解得 \(a_n=3a_{n-1}\). 即 \(\frac{a_n}{a_{n-1}}=3\)（\(n\ge2\)），所以数列 \(\{a_n\}\) 是首项为 \(3\)、公比为 \(3\) 的等比数列，故
\[
a_n=3^n\qquad(n\in\N).
\]

（2）先证明形如 \(3^{2n+1}\)（\(n\in\N\)）的数都是数列 \(\{a_n\}\) 与 \(\{b_n\}\) 的公共项. 因为
\[
a_{2n+1}=3^{2n+1},
\]
所以 \(3^{2n+1}\in\{a_1,a_2,\cdots\}\).
...
=4(6t)+3
\]
（其中 \(t\in\N\)），所以 \(3^{2n+1}\in\{b_1,b_2,\cdots\}\). 因此
\[
3^{2n+1}\in\{a_1,a_2,\cdots\}\cap\{b_1,b_2,\cdots\}.
\]
...
于是数列 \(\{a_n\}\) 与 \(\{b_n\}\) 的公共项恰为
\[
a_3,a_5,a_7,\cdots,a_{2n+1},\cdots,
\]
所以
\[
d_n=a_{2n+1}=3^{2n+1}\qquad(n\in\N).
\]
\end{solution}
