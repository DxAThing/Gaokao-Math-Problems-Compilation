...
\begin{problem}
参数方程 \(\begin{cases}x=1-2t,\\ y=2t^2-t\end{cases}\)（\(t\) 为参数）化为普通方程是\fillinblank{}.
...
\begin{problem}
\(\lim\limits_{n\to\infty}\frac{(-2)^{n+1}}{1-2+4-\cdots+(-2)^{n-1}}=\)\fillinblank{}.
...
\choices
    {\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1988/shanghai/q18_optA.png}}
    {\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1988/shanghai/q18_optB.png}}
    {\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1988/shanghai/q18_optC.png}}
    {\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1988/shanghai/q18_optD.png}}
...
【法二】（1）因为 \(\left| BF \right|=\sqrt{(\sqrt{26}-0)^2+(6-5)^2}=\sqrt{26+1}=3\sqrt{3}\). 又 \(\left| AF \right|=\sqrt{x_1^2+(y_1-5)^2}\). 而 \(A(x_1,y_1)\) 在双曲线上，所以 \(x_1^2=\dfrac{13y_1^2-156}{12}\). 从而
