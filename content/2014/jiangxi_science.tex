...
\renewcommand{\bitmapinclude}[2][]{%
    \begingroup
    \adjustbox{max width=\linewidth,max totalheight=9.0cm,#1}{\includegraphics{#2}}%
    \endgroup
}%
\bitmapfigure[max width=0.9\linewidth,max totalheight=9.0cm]{img/2014/jiangxi_science/q10_options.png}
\endgroup
\end{problem}
