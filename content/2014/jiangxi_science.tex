...
\bitmapfigure[max width=0.78\linewidth]{img/2014/jiangxi_science/q5_options.png}
\end{problem}
...
\renewcommand{\bitmapinclude}[2][]{%
    \begingroup
    \adjustbox{max width=\linewidth,#1}{\includegraphics{#2}}%
    \endgroup
}%
\bitmapfigure[max width=0.9\linewidth]{img/2014/jiangxi_science/q10_options.png}
\endgroup
\end{problem}
