...
\begin{minipage}[c]{0.42\linewidth}
    \centering
    \bitmapinclude[max width=\linewidth]{img/2014/guangdong_science/q6_pie_original.png}
\end{minipage}\hspace{0.6em}%
\begin{minipage}[c]{0.46\linewidth}
    \texinclude[max width=\linewidth]{img_repaint/2014/guangdong_science/q6_bar_fig2.tex}
\end{minipage}
\bitmappreparecaption{img/2014/guangdong_science/q6_pie_original.png}
\bitmapinsertcaption
\end{minipage}
\end{center}
