...
\bitmapinlinefigure[0.85\linewidth][max width=0.85\linewidth]{img/2014/guangdong_science/q6_fig1.png}
...
\begin{solution}
短答案：第（1）问 \(A=\sqrt{3}\)；第（2）问 \(f\left(\frac{3}{4}\pi-\theta\right)=\frac{\sqrt{30}}{4}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问 \(n_1=7\)，\(n_2=2\)，\(f_1=0.28\)，\(f_2=0.08\)；第（2）问各组频率除以组距依次为 \(0.024\)，\(0.04\)，\(0.056\)，\(0.064\)，\(0.016\)；第（3）问概率为 \(0.5904\).
\end{solution}
...
\begin{solution}
短答案：第（1）问 \(CF\perp\) 平面 \(ADF\)；第（2）问二面角 \(D-AF-E\) 的余弦值为 \(\frac{2\sqrt{57}}{19}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问 \(a_1=3\)，\(a_2=5\)，\(a_3=7\)；第（2）问 \(a_n=2n+1\).
\end{solution}
...
\begin{solution}
短答案：第（1）问椭圆 \(C\) 的标准方程为 \(\frac{x^2}{9}+\frac{y^2}{4}=1\)；第（2）问点 \(P\) 的轨迹方程为 \(x_0^2+y_0^2=13\).
\end{solution}
...
\begin{solution}
短答案：第（1）问 \(D=\left(-\infty,-1-\sqrt{2-k}\right)\cup\left(-1-\sqrt{-2-k},-1+\sqrt{-2-k}\right)\cup\left(-1+\sqrt{2-k},+\infty\right)\)；第（2）问 \(f(x)\) 在 \(\left(-\infty,-1-\sqrt{2-k}\right)\) 和 \(\left(-1,-1+\sqrt{-2-k}\right)\) 上单调递增，在 \(\left(-1-\sqrt{-2-k},-1\right)\) 和 \(\left(-1+\sqrt{2-k},+\infty\right)\) 上单调递减；第（3）问 \(\left(-1-\sqrt{-2k-4},-1-\sqrt{2-k}\right)\cup\left(-1-\sqrt{-2-k},-3\right)\cup\left(1,-1+\sqrt{2-k}\right)\cup\left(-1+\sqrt{-2-k},-1+\sqrt{-2k-4}\right)\).
\end{solution}
