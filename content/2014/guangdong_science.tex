...
\begin{minipage}[c]{0.42\linewidth}
    \centering
    \bitmapinclude[max width=\linewidth,max totalheight=4.2cm]{img/2014/guangdong_science/q6_pie_original.png}
\end{minipage}\hspace{0.6em}%
\begin{minipage}[c]{0.46\linewidth}
    \texfigure[max width=\linewidth,max totalheight=4.2cm]{img_repaint/2014/guangdong_science/q6_bar_fig2.tex}
\end{minipage}
\end{center}
