...
\bitmapfigure[max width=0.78\linewidth,max totalheight=5.8cm]{img/2014/zhejiang_science/q3_fig1.png}
...
\bitmapfigure[max width=0.88\linewidth,max totalheight=6.8cm]{img/2014/zhejiang_science/q7_options.png}
\end{problem}
...
\item 放入 i 个球后，甲盒中含有红球的个数记为 \( \xi_{i} \) (i = 1, 2);
\item 放入 i 个球后，从甲盒中取 1 个球是红球的概率记为 \( p_{i} \) (i = 1, 2).
\end{enumerate}
...
\bitmapfigure[max width=0.24\linewidth,max totalheight=7.0cm]{img/2014/zhejiang_science/q11_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2014/zhejiang_science/q17_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2014/zhejiang_science/q20_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2014/zhejiang_science/q21_fig1.png}
