...
\begin{solution}
答案：\(C=\frac{\pi}{3}\)，\(S_{\triangle ABC}=\frac{8\sqrt{3}+18}{25}\).
\end{solution}
...
\begin{solution}
答案：\(a_n=2^n\)，\(b_n=n(n+1)\)；\(S_n=\frac{1}{n+1}-\frac{1}{2^n}\)，\(k=4\).
\end{solution}
...
\begin{solution}
答案：\(DE\perp\) 平面 \(ACD\)；二面角 \(B-AD-E\) 的大小为 \(\frac{\pi}{6}\).
\end{solution}
...
\begin{solution}
答案：\(P\left(-\frac{a^2k}{\sqrt{b^2+a^2k^2}},\frac{b^2}{\sqrt{b^2+a^2k^2}}\right)\)；距离最大值为 \(a-b\).
\end{solution}
...
\begin{cases}
8, & a\leqslant -1,\\
-a^3-3a+4, & -1<a\leqslant \frac{1}{3},\\
-a^3+3a+2, & \frac{1}{3}<a<1,\\
4, & a\geqslant 1;
\end{cases}
\]
且 \(3a+b\in[-2,0]\).
