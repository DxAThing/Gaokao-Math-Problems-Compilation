...
\bitmapfigure[max totalheight=7.0cm]{img/2014/jiangsu/q3_fig1.png}
\end{problem}
...
\begin{problem}
在平面直角坐标系 \(xOy\) 中，已知直线 \(l\) 的参数方程为 \(\begin{cases}x = 1 - \frac{\sqrt{2}}{2} t,\\ y = 2 + \frac{\sqrt{2}}{2} t,\end{cases}\)（\(t\) 为参数），直线 \(l\) 与抛物线 \(y^2 = 4x\) 交于 \(A\)，\(B\) 两点，求线段 \(AB\) 的长.
\end{problem}
