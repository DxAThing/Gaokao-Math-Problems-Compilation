...
\begin{problem}
若 \( f(x) = x^{\frac{1}{2}} - x^{-\frac{1}{2}} \)，则满足 \( f(x) < 0 \) 的 \( x \) 的取值范围是 \fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2014/shanghai_science/q16_fig1.png}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.8cm]{img/2014/shanghai_science/q19_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.56\linewidth,max totalheight=3.6cm]{img/2014/shanghai_science/q21_fig1.png}
