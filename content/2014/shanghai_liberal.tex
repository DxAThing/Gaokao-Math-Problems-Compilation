...
\begin{problem}
某校高一，高二，高三分别有学生 1600 名，1200 名，800 名. 为了解该校高中学生的牙齿健康状况，按各年级的学生数进行分层抽样. 若高三抽出 20 名学生，则高一，高二共抽取的学生数为\fillinblank{}.
\end{problem}
...
\begin{problem}
设 \( f(x) = \begin{cases} (x - a)^2, & x \leqslant 0, \\ x + \frac{1}{x} + a, & x > 0, \end{cases} \) 若 \( f(0) \) 是 \( f(x) \) 的最小值，则 \( a \) 的取值范围为\fillinblank{}.
\end{problem}
...
\begin{problem}
已知 \( P_{1}(a_{1}, b_{1}) \) 与 \( P_{2}(a_{2}, b_{2}) \) 是直线 \( y = kx + 1 \)（\(k\) 为常数）上两个不同的点，则关于 \(x\) 和 \(y\) 的方程组 \(\begin{cases} a_{1}x + b_{1}y = 1, a_{2}x + b_{2}y = 1 \end{cases}\)
的解的情况是（\quad）
