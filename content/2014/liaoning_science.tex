...
\bitmapfigure[max width=0.28\linewidth,max totalheight=6.0cm]{img/2014/liaoning_science/q13_fig1.png}
\end{problem}
...
\begin{problem}
对于 \(c > 0\)，当非零实数 \(a, b\) 满足 \(4a^2 - 2ab + 4b^2 - c = 0\) 且使 \(|2a + b|\) 最大时，\(\frac{3}{a} - \frac{4}{b} + \frac{5}{c}\) 的最小值为\fillinblank{}\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2014/liaoning_science/q18_fig1.png}
