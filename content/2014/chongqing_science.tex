...
\bitmapfigure[width=0.42\linewidth,max totalheight=6.5cm]{img/2014/chongqing_science/q5_fig1.png}
...
\begin{problem}
已知函数 \( f(x) = ae^{2x} - be^{-2x} - cx \) （\(a\)，\(b\)，\(c \in \R\)） 的导函数 \( f'(x) \) 为偶函数，且曲线 \( y = f(x) \) 在点\((0, f(0))\)处的切线的斜率为\(4-c\).
