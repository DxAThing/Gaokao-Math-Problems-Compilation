...
\bitmapfigure[max width=0.62\linewidth,max totalheight=4.8cm]{img/2014/new_curriculum_paper_1_science/q6_fig2.png}

\choices
    {\choicebitmap[max width=0.40\linewidth,max totalheight=3.0cm]{img/2014/new_curriculum_paper_1_science/q6_optA.png}}
    {\choicebitmap[max width=0.40\linewidth,max totalheight=3.0cm]{img/2014/new_curriculum_paper_1_science/q6_optB.png}}
    {\choicebitmap[max width=0.40\linewidth,max totalheight=3.0cm]{img/2014/new_curriculum_paper_1_science/q6_optC.png}}
    {\choicebitmap[max width=0.40\linewidth,max totalheight=3.0cm]{img/2014/new_curriculum_paper_1_science/q6_optD.png}}
\end{problem}

\begin{problem}
执行如图的程序框图，若输入的 \(a\)，\(b\)，\(k\) 分别为 1， 2， 3，则输出的 \(M =\)（\quad）

\bitmapfigure[max width=0.56\linewidth,max totalheight=8.0cm]{img/2014/new_curriculum_paper_1_science/q7_fig1.png}
...
\begin{problem}
不等式组 \(\left\{ \begin{array}{l} x + y \geqslant 1, \\ x - 2y \leqslant 4 \end{array} \right.\) 的解集记为 \(D\). 有下面四个命题：\(p_{1}\colon \forall (x,y)\in D\)，\(x + 2y\geqslant -2\)；\(p_2\colon \exists (x,y)\in D\)，\(x + 2y\geqslant 2\)；\(p_{3}\colon \forall (x,y)\in D\)，\(x + 2y\leqslant 3\)；\(p_4\colon \exists (x,y)\in D\)，\(x + 2y\leqslant -1\). 其中真命题是（\quad）
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=3.0cm]{img/2014/new_curriculum_paper_1_science/q12_fig1.png}
...
\texfigure[max width=0.74\linewidth,max totalheight=5.6cm]{img_repaint/2014/new_curriculum_paper_1_science/q18_fig1.tex}
\end{problem}
...
\bitmapfigure[max width=0.62\linewidth,max totalheight=4.8cm]{img/2014/new_curriculum_paper_1_science/q19_fig1.png}
...
\bitmapfigure[max width=0.62\linewidth,max totalheight=5.0cm]{img/2014/new_curriculum_paper_1_science/q22_fig1.png}

\end{problem}

\begin{problem}
已知曲线 \(C: \frac{x^2}{4} + \frac{y^2}{9} = 1\)，直线 \(l: \begin{cases} x = 2 + t, \\ y = 2 - 2t, \end{cases}\) （\(t\) 为参数）.
