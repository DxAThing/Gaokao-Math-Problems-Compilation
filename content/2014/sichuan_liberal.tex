...
\texfigure[max width=5.8cm]{img_repaint/2014/sichuan_liberal/q6_fig1.tex}
...
\bitmapfigure[max width=0.42\linewidth]{img/2014/sichuan_liberal/q8_fig1.png}
...
\begin{solution}
\begin{enumerate}
\item \(\left[\frac{2k\pi}{3} - \frac{\pi}{4},\frac{2k\pi}{3} + \frac{\pi}{12}\right]\)，\(k \in \Z\).
\item \(-\sqrt{2}\) 或 \(-\frac{\sqrt{5}}{2}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item 直线 \(BC \perp\) 平面 \(ACC_{1}A_{1}\).
\item 存在，点 \(M\) 为线段 \(AB\) 的中点.
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item 椭圆 \(C\) 的标准方程为 \(\frac{x^{2}}{6} + \frac{y^{2}}{2} = 1\).
\item 四边形 \(OPTQ\) 的面积为 \(2\sqrt{3}\).
\end{enumerate}
\end{solution}
\end{problem}
