...
\begin{problem}
在函数\circled{1} \( y = \cos |2x| \)，\circled{2} \( y = |\cos x| \)，\circled{3} \( y = \cos \left(2x + \frac{\pi}{6}\right) \)，\circled{4} \( y = \tan \left(2x - \frac{\pi}{4}\right) \) 中，最小正周期为 \( \pi \) 的所有函数为（\quad）
...
\bitmapfigure[max width=0.52\linewidth,max totalheight=8.0cm]{img/2014/new_curriculum_paper_1_liberal/q8_fig1.png}
...
\bitmapfigure[max width=0.50\linewidth,max totalheight=8.0cm]{img/2014/new_curriculum_paper_1_liberal/q9_fig1.png}
...
\begin{problem}
设 \(x\)，\(y\) 满足约束条件 \(\begin{cases} x + y \geqslant a, \\ x - y \leqslant -1, \end{cases}\) 且 \(z = x + ay\) 的最小值为 7，则 \(a =\)（\quad）
...
\begin{problem}
设函数 \( f(x) = \begin{cases} \e^{x - 1}, & x < 1, \\ x^{\frac{1}{3}}, & x \geqslant 1, \end{cases} \) 则使得 \( f(x) \leqslant 2 \) 成立的 \( x \) 的取值范围是\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=0.38\linewidth,max totalheight=5.4cm]{img/2014/new_curriculum_paper_1_liberal/q16_fig1.png}
\end{problem}
...
\begin{problem}
从某企业生产的某种产品中抽取 100 件，测量这些产品的一项质量指标值，由测量结果得如下频数分布表：质量指标值分组 [75,85) [85,95) [95,105) [105,115) [115,125) 频数 6 26 38 22 8.
...
\texfigure[max width=0.38\linewidth,max totalheight=6.8cm]{img_repaint/2014/new_curriculum_paper_1_liberal/q18_fig1.tex}
...
\bitmapfigure[max width=0.38\linewidth,max totalheight=5.2cm]{img/2014/new_curriculum_paper_1_liberal/q19_fig1.png}
...
\bitmapfigure[max width=0.36\linewidth,max totalheight=5.0cm]{img/2014/new_curriculum_paper_1_liberal/q22_fig1.png}
