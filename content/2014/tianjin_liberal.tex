...
\begin{center}
\bitmapinclude[max width=5.8cm,max totalheight=6.2cm]{img/2014/tianjin_liberal/q7_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=7.2cm,max totalheight=6.5cm]{img/2014/tianjin_liberal/q10_fig1.png}
\end{center}
\end{problem}
...
\begin{center}
\bitmapinclude[max width=4.8cm,max totalheight=6.5cm]{img/2014/tianjin_liberal/q11_fig1.png}
\end{center}
\end{problem}
...
\begin{problem}
已知函数 \( f(x) = \begin{cases} |x^2 + 5x + 4|, & x \leqslant 0, \\ 2|x - 2|, & x > 0 \end{cases} \) 若函数 \( y = f(x) - a|x| \) 恰有 \(4\) 个零点，则实数 \(a\) 的取值范围为\fillinblank{}.
\end{problem}
...
\begin{center}
\bitmapinclude[max width=7.3cm,max totalheight=5.8cm]{img/2014/tianjin_liberal/q17_fig1.png}
\end{center}
\end{problem}
