...
\bitmapfigure[max width=5.8cm,max totalheight=6.2cm]{img/2014/tianjin_liberal/q7_fig1.png}
...
\bitmapfigure[max width=7.2cm,max totalheight=6.5cm]{img/2014/tianjin_liberal/q10_fig1.png}
\end{problem}

\begin{problem}
阅读如图的框图，运行相应的程序，输出 \(S\) 的值为\fillinblank{}.

\bitmapfigure[max width=4.8cm,max totalheight=6.5cm]{img/2014/tianjin_liberal/q11_fig1.png}
\end{problem}
...
\bitmapfigure[max width=7.3cm,max totalheight=5.8cm]{img/2014/tianjin_liberal/q17_fig1.png}
\end{problem}
