...
\choices
    {\choicebitmap[max width=0.24\linewidth,max totalheight=3.8cm]{img/2003/jing_meng_wan_liberal_spring/q9_optA.png}}
    {\choicebitmap[max width=0.24\linewidth,max totalheight=3.8cm]{img/2003/jing_meng_wan_liberal_spring/q9_optB.png}}
    {\choicebitmap[max width=0.24\linewidth,max totalheight=3.8cm]{img/2003/jing_meng_wan_liberal_spring/q9_optC.png}}
    {\choicebitmap[max width=0.24\linewidth,max totalheight=3.8cm]{img/2003/jing_meng_wan_liberal_spring/q9_optD.png}}
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.6cm]{img/2003/jing_meng_wan_liberal_spring/q11_fig1.png}
...
\bitmapfigure[max width=0.52\linewidth,max totalheight=4.8cm]{img/2003/jing_meng_wan_liberal_spring/q14_fig1.png}
\end{problem}
...
\begin{problem}
已知 \(F_1\)，\(F_2\) 分别为椭圆 \(\dfrac{x^2}{a^2}+\dfrac{y^2}{b^2}=1\) 的左、右焦点，点 \(P\) 在椭圆上，\(\triangle POF_2\) 是面积为 \(\sqrt{3}\) 的正三角形，则 \(b^2=\)\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=0.54\linewidth,max totalheight=4.8cm]{img/2003/jing_meng_wan_liberal_spring/q19_fig1.png}
\end{problem}
...
\begin{enumerate}
\item 证明 \(\{a_n\}\) 是等比数列；
\item 求 \(\lim\limits_{n\to\infty}(a_1+a_2+\cdots+a_n)\) 的值.
\end{enumerate}

\bitmapfigure[max width=0.48\linewidth,max totalheight=4.8cm]{img/2003/jing_meng_wan_liberal_spring/q22_fig1.png}
\end{problem}
