...
\begin{solution}
定义域为 \((-1,0)\cup(0,1)\)，函数 \(f(x)\) 为奇函数且在定义域内单调递减.
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(l\approx33.3\mathrm{~m}\).
\item 当 \(h\approx6.4\mathrm{~m}\)，\(l\approx31.1\mathrm{~m}\) 时，土方工程量最小.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_{1}(1-q)^2\)，\(a_{1}(1-q)^3\).
\item \(a_{1}\mathrm C_n^0-a_{2}\mathrm C_n^1+a_{3}\mathrm C_n^2-\cdots+(-1)^n a_{n+1}\mathrm C_n^n=a_{1}(1-q)^n\).
\item \(\dfrac{a_{1}q}{q-1}(1-q)^n\).
\end{enumerate}
\end{solution}
