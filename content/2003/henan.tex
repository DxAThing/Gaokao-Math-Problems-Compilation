...
\begin{problem}
设函数 \( f(x)=\begin{cases}2^{-x}-1, & x\leq 0,\\ \frac{1}{x^{2}}, & x>0.\end{cases} \)，若 \( f(x_{0})>1 \)，则 \( x_{0} \) 的取值范围是
...
\begin{center}
\includegraphics[page=2,pagebox=mediabox,trim=150pt 190pt 143pt 470pt,clip,width=0.35\linewidth]{source/普通高考/2003/2003河南.pdf}
\end{center}
\end{problem}
...
\begin{center}
\includegraphics[page=3,pagebox=mediabox,trim=80pt 495pt 63pt 0pt,clip,width=0.60\linewidth]{source/普通高考/2003/2003河南.pdf}
\end{center}
\end{enumerate}
\end{problem}
...
\begin{center}
\includegraphics[page=3,pagebox=mediabox,trim=0pt 96pt 354pt 470pt,clip,width=0.34\linewidth]{source/普通高考/2003/2003河南.pdf}
\end{center}
\end{enumerate}
\end{problem}
