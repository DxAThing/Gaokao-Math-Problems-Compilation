...
\begin{problem}
已知点 \(A\left(0, \frac{2}{n}\right)\)，\(B\left(0, -\frac{2}{n}\right)\)，\(C\left(4 + \frac{2}{n}, 0\right)\)，其中 \(n\) 为正整数. 设 \(S_{n}\) 表示 \(\triangle ABC\) 外接圆的面积，则 \(\lim\limits_{n \to \infty} S_{n} = \)\fillinblank{}.
\end{problem}
