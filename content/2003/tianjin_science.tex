...
\begin{center}
\bitmapinclude[max width=6.0cm,max totalheight=2.8cm]{img/2003/tianjin_science/q15_fig1.png}
\end{center}
\end{problem}
...
\begin{center}
\bitmapinclude[max width=0.82\linewidth,max totalheight=4.8cm]{img/2003/tianjin_science/q16_fig1.png}
\end{center}
\end{problem}
...
\end{enumerate}
\par\vspace{-0.8em}
\noindent\hfill\bitmapinclude[max width=7.0cm,max totalheight=4.8cm]{img/2003/tianjin_science/q17_fig1.png}\hfill\par
\vspace{-0.8em}
\end{problem}
...
\end{enumerate}
\begin{center}
\bitmapinclude[max width=6.0cm,max totalheight=4.8cm]{img/2003/tianjin_science/q18_fig1.png}
\end{center}
\end{problem}
