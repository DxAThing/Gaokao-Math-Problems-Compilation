...
\begin{center}
\bitmapinclude[page=1,pagebox=mediabox,trim=566pt 381pt 552pt 384pt,clip,max width=6.0cm,max totalheight=2.8cm]{source/普通高考/2003/2003天津理.pdf}
\end{center}
\end{problem}
...
\end{enumerate}
\begin{center}
\bitmapinclude[page=1,pagebox=mediabox,trim=888pt 477pt 15pt 77pt,clip,max width=6.0cm,max totalheight=4.8cm]{source/普通高考/2003/2003天津理.pdf}
\end{center}
\end{problem}
