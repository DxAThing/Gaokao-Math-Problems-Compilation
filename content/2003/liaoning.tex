...
\begin{center}
\bitmapfigure[max width=3.05cm,max totalheight=3.0cm]{img/2003/liaoning/q15_fig1.png}
\end{center}
\end{problem}
...
\bitmapfigure[max width=4.8cm,max totalheight=4.8cm]{img/2003/liaoning/q17_fig1.png}
