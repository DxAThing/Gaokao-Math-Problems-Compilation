...
\begin{center}
\includegraphics[page=1,pagebox=mediabox,trim=564pt 364pt 540pt 420pt,clip,width=3.05cm]{source/普通高考/2003/2003辽宁.pdf}
\end{center}
\end{problem}
...
\begin{center}
\includegraphics[page=1,pagebox=mediabox,trim=643pt 12pt 365pt 619pt,clip,width=4.8cm]{source/普通高考/2003/2003辽宁.pdf}
\end{center}
...
\begin{problem}
设 \(\alpha_0\) 为常数，且 \(\alpha_n = 3^{n-1} - 2\alpha_{n-1} (n \in \mathbf{N}^*)\).

\begin{enumerate}
\item 证明对任意 \(n \geqslant 1\)，\(\alpha_n = \frac{1}{5} \bigl[3^n + (-1)^{n-1} \cdot 2^n\bigr] + (-1)^n \cdot 2^n \alpha_0\)；
\item 假设对任意 \(n \geqslant 1\) 有 \(\alpha_n > \alpha_{n-1}\)，求 \(\alpha_0\) 的取值范围.
\end{enumerate}
\end{problem}
