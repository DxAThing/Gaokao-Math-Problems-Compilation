...
\begin{solution}
短答案：\(\left(0,\frac{1}{2}\right]\cup[1,+\infty)\).
\end{solution}
...
\[
\begin{cases}
\text{不存在符合条件的两个定点}, & a^{2}=\frac{1}{2},\\
\text{定点为 }\left(-\sqrt{\frac{1}{2}-a^{2}},a\right)\text{、}\left(\sqrt{\frac{1}{2}-a^{2}},a\right)\text{，距离和为 }\sqrt{2}, & 0<a^{2}<\frac{1}{2},\\
\text{定点为 }\left(0,a-\sqrt{a^{2}-\frac{1}{2}}\right)\text{、}\left(0,a+\sqrt{a^{2}-\frac{1}{2}}\right)\text{，距离和为 }2a, & a^{2}>\frac{1}{2}.
\end{cases}
\]
\end{solution}
...
短答案：
\begin{enumerate}
\item 第四行：\(17,18,20,24\)；第五行：\(33,34,36,40,48\).
\item \(a_{100}=16640\).
\end{enumerate}
\end{solution}
