...
\begin{problem}
设 \(x\)，\(y\) 满足约束条件 \(\begin{cases} 2x - y + 2 \geqslant 0, 8x - y - 4 \leqslant 0, x \geqslant 0, \ y \geqslant 0, \end{cases}\)
...
\bitmapfigure[max width=0.28\linewidth,max totalheight=6.0cm,scale=1.5]{img/2010/anhui_science/q14_fig1.png}
\end{problem}
