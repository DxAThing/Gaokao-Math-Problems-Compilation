...
\[
1-P\left(\overline{A_1}\overline{A_2}\overline{A_3}\right)=1-(1-p)^3=0.999
\]
所以 \(1-p=0.1\)，即 \(p=0.9\).
...
\item 当 \(x>0\) 时，若不等式对一切 \(x\geqslant0\) 成立，则 \(a<0\) 时取充分大的 \(x\)，会有 \(ax+1<0\)，从而 \(\frac{x}{ax+1}<0<1-\e^{-x}\)，矛盾. 因此必须有 \(a\geqslant0\). 此时 \(ax+1>0\)，原不等式等价于
\[
