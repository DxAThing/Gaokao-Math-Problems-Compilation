...
\bitmapfigure[max width=0.72\linewidth,max totalheight=4cm]{img/2010/beijing_science/q11_hist.png}
\end{problem}

\begin{problem}
如图，\(\odot O\) 的弦 \(ED\)，\(CB\) 的延长线交于点 \(A\). 若 \(BD \perp AE\)，\(AB = 4\)，\(BC = 2\)，\(AD = 3\)，则 \(DE = \fillinblank{}\); \(CE = \fillinblank{}\).

\bitmapfigure[max width=0.52\linewidth,max totalheight=4.5cm]{img/2010/beijing_science/q12_circle.png}
\end{problem}

\begin{problem}
已知双曲线 \(\frac{x^2}{a^2} - \frac{y^2}{b^2} = 1 (a > 0, b > 0)\) 的离心率为 2，焦点与椭圆 \(\frac{x^2}{25} + \frac{y^2}{9} = 1\) 的焦点相同，那么双曲线的焦点坐标为 \fillinblank{}；渐近线方程为 \fillinblank{} \fillinblank{}.
\end{problem}
...
\vspace{-2.2em}
\begin{center}
\bitmapinclude[max width=0.24\linewidth]{img/2010/beijing_science/q14_fig1.png}
\end{center}
...
\bitmapfigure[max width=0.56\linewidth,max totalheight=5.5cm]{img/2010/beijing_science/q16_solid.png}
