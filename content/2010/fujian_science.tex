...
\begin{solution}
\begin{enumerate}
\item \((-2,2)\)，\((2,-2)\)，\((-1,1)\)，\((1,-1)\)，\((0,0)\)；
\item \(\xi\) 的取值为 \(0\)，\(1\)，\(4\)，\(9\)，对应概率为 \(\frac{1}{6}\)，\(\frac{1}{3}\)，\(\frac{1}{3}\)，\(\frac{1}{6}\)，且 \(E(\xi)=\frac{19}{6}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\frac{x^2}{16}+\frac{y^2}{12}=1\)；
\item 不存在.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(p_{\max}=\frac{1}{\pi}\).
\item \(\cos\theta=\frac{\sqrt{10}}{5}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(30\sqrt{3}\text{ 海里/小时}\)；
\item 航行方向为北偏东 \(30^{\circ}\)，航行速度为 \(30\text{ 海里/小时}\).
\end{enumerate}
\end{solution}
...
\item
\begin{enumerate}
\item 在 \(\left(-\infty,-\frac{\sqrt{3}}{3}\right)\) 和 \(\left(\frac{\sqrt{3}}{3},+\infty\right)\) 上单调递增，在 \(\left(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3}\right)\) 上单调递减；
\item \(\frac{S_1}{S_2}=\frac{1}{16}\)；
\end{enumerate}
\item 对任意 \(a\neq0\)，相应比值仍为 \(\frac{1}{16}\).
\end{enumerate}
\end{solution}
