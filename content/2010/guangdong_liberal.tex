...
\begin{enumerate}
\item \(f(0)=\frac{3}{2}\)；
\item \(f(x)=3\sin\left(4x+\frac{\pi}{6}\right)\)；
\item \(\sin\alpha=\pm\frac{4}{5}\).
\end{enumerate}
\end{solution}
...
函数在 \([-3,-1]\) 与 \([1,3]\) 上为增函数，在 \([-1,1]\) 上为减函数；
\item
\(k<-1\) 时，最小值为 \(-k^2\)，在 \(x=-3\) 处取得；最大值为 \(-k\)，在 \(x=-1\) 处取得；

\(k=-1\) 时，最小值为 \(-1\)，在 \(x=-3\) 或 \(x=1\) 处取得；最大值为 \(1\)，在 \(x=-1\) 或 \(x=3\) 处取得；

\(-1<k<0\) 时，最小值为 \(-1\)，在 \(x=1\) 处取得；最大值为 \(-\dfrac{1}{k}\)，在 \(x=3\) 处取得.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(l_n:y-y_n=2nx_n(x-x_n)\)，\(Q_n=(0,-nx_n^2)\)；
\item \(P_n\left(\dfrac{1}{2n},\dfrac{1}{4n}\right)\)；
\item 结论成立.
\end{enumerate}
\end{solution}
