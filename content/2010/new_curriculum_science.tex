...
\texfigure[width=0.28\linewidth]{img_repaint/2010/new_curriculum_science/q7_fig1.tex}
...
\item 根据 （2） 的结论，能否提供更好的调查方法来估计该地区老年人中，需要志愿者帮助的老年人的比例？说明理由.
\end{enumerate}
...
\makebox[3.6cm][l]{%
  \rule{0pt}{1.05cm}%
  \rlap{\raisebox{0.5cm}{\rotatebox{-15}{\rule{3.6cm}{0.4pt}}}}%
  \rlap{\raisebox{0.74cm}{\hspace{2.6cm}性别}}%
  \rlap{\raisebox{0.08cm}{\hspace{0.12cm}是否需要志愿者}}%
}
& 男 & 女 \\
\hline
需要 & 40 & 30 \\
