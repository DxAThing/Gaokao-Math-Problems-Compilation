...
因为 \(f(x)\) 取 \(\sin x\) 或 \(\cos x\) 的值，所以 \(-1\leqslant f(x)\leqslant1\). 当 \(x=2k\pi\) 或 \(x=2k\pi+\frac{\pi}{2}\) 时，\(f(x)=1\)；当 \(x=(2k+1)\pi\) 或 \(x=2k\pi+\frac{3\pi}{2}\) 时，\(f(x)=-1\)，其中 \(k\in\Z\). 因而值域为 \([-1,1]\).
