...
\[
A(0,0,0),\quad B(-2,-2,0),\quad C(2,-2,0).
\]
...
\qquad
\overrightarrow{PC}=(2,-2,-2\sqrt2),
\qquad
\overrightarrow{PB}=(-2,-2,-2\sqrt2).
\]
取平面 \(PCD\) 的一个法向量
\[
...
\[
S_{\triangle ACD}=\frac12\left|2\cdot(-1)-(-2)\cdot3\right|=2,
\qquad
S_{\triangle ADE}=\frac12\left|3\cdot0-(-1)\cdot2\right|=1.
\]
...
\[
P(M_1)=\frac34,\quad P(M_2)=\frac12,\quad P(M_3)=\frac13,\quad P(M_4)=\frac14,
\]
且各事件相互独立. 答完第一个问题后，累计分数为 \(11\) 或 \(8\)，均可继续答题. 答完第二个问题后，只有发生 \(N_1N_2\) 时累计分数为 \(6<8\)，会停止答题；其他情形均可继续.

若前三题答题结果为 \(M_1M_2M_3\)，前三题得分为 \(16\)，此时进入下一轮. 到达第四题的四种前三题结果及分数分别为 \(M_1M_2N_3\)、\(M_1N_2M_3\)、\(N_1M_2M_3\)、\(N_1M_2N_3\)，对应分数为 \(11\)、\(12\)、\(13\)、\(8\)，这四种情形只有答对第四题才能进入下一轮. 因而进入下一轮的概率为
\[
\begin{aligned}
...
\]
\[
P(\xi=3)=P(M_1M_2M_3)+P(M_1N_2N_3)=\frac18+\frac14=\frac38,
\]
\[
...
\[
\frac ca=\frac{\sqrt2}{2},
\qquad
c=\frac{a}{\sqrt2},
\qquad
b^2=a^2-c^2=\frac{a^2}{2}.
\]
...
\[
k_1=\frac{v}{u+2},\qquad k_2=\frac{v}{u-2},\qquad k_1k_2=\frac{v^2}{u^2-4}=1.
\]
...
\]
过另一个焦点 \(F_2(2,0)\) 的直线同理也有相同的弦长公式. 令 \(t=k_1^2>0\)，由 \(k_1k_2=1\) 得 \(k_2^2=\frac1t\)，于是
\[
|AB|=\frac{4\sqrt2(t+1)}{2t+1},\qquad |CD|=\frac{4\sqrt2(t+1)}{t+2}.
\]
从而
\[
|AB|+|CD|=\frac{12\sqrt2(t+1)^2}{(2t+1)(t+2)},\qquad
|AB|\cdot|CD|=\frac{32(t+1)^2}{(2t+1)(t+2)}.
\]
