...
\texfigure[max width=0.45\linewidth,max totalheight=4.8cm]{img_repaint/2013/hubei_science/q11_fig1.tex}
\end{problem}
...
\begin{problem}
在直角坐标系 \(xOy\) 中，椭圆 \(C\) 的参数方程为 \(\begin{cases} x = a\cos\varphi, y = b\sin\varphi, \end{cases}\)
