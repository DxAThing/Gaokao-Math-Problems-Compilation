...
\begin{solution}
短答案：\(BC\perp\) 平面 \(PAC\)；\(QG\parallel\) 平面 \(PBC\).
\end{solution}
...
\begin{solution}
短答案：\(p=2\)；点 \(N\) 的轨迹方程为 \(x^2=\frac{4}{3}y\).
\end{solution}
...
\begin{solution}
短答案：第（1）问不等式成立；第（2）问 \(a\in(-\infty,-2]\).
\end{solution}
...
\begin{solution}
短答案：\(\angle FEB=\angle CEB\)；\(EF^{2}=AD\cdot BC\).
\end{solution}
...
\begin{solution}
短答案：\(C_{1}\) 与 \(C_{2}\) 的交点极坐标为 \((4,\frac{\pi}{2})\)，\((2\sqrt{2},\frac{\pi}{4})\)；\(a=-1\)，\(b=2\).
\end{solution}
