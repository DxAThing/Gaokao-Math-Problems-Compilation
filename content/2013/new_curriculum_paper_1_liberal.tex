...
\begin{problem}
已知锐角三角形 \(ABC\) 的内角 \(A\)，\(B\)，\(C\) 的对边分别为 \(a\)，\(b\)，\(c\)，\(2\cos^{2} A + \cos 2A = 0\)，\(a = 7\)，\(c = 6\)，则 \(b =\)（\quad）
...
\begin{solution}
\begin{enumerate}
\item A 药、B 药两组数据的平均数分别为 \(2.3\)，\(1.6\)，从平均数看 A 药疗效更好；
\item 从茎叶图看 A 药疗效更好.
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(AB \perp A_{1}C\)；
\item 三棱柱 \(ABC-A_{1}B_{1}C_{1}\) 的体积为 \(3\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(a=4\)，\(b=4\)；
\item \(f(x)\) 在 \(\left(-\infty,-2\right)\) 和 \(\left(-\ln 2,+\infty\right)\) 上单调递增，在 \(\left(-2,-\ln 2\right)\) 上单调递减；极大值为 \(4\left(1-\e^{-2}\right)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C: \frac{x^2}{4} + \frac{y^2}{3} = 1\)，且 \(x \neq -2\)；
\item \(|AB| = 2\sqrt{3}\) 或 \(\frac{18}{7}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(DB = DC\)；
\item \(\triangle BCF\) 外接圆的半径为 \(\frac{\sqrt{3}}{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\rho^{2} - 8\rho\cos\theta - 10\rho\sin\theta + 16 = 0\)；
\item 交点为 \(\left(\sqrt{2},\frac{\pi}{4}\right)\) 和 \(\left(2,\frac{\pi}{2}\right)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 解集为 \(\left(0,2\right)\)；
\item \(a \in \left(-1,\frac{4}{3}\right]\).
\end{enumerate}
\end{solution}
