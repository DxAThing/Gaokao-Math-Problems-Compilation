...
\begin{solution}
短答案：第（1）问 \(A=\frac{\pi}{3}\)；第（2）问 \(\triangle ABC\) 的面积为 \(\frac{14\sqrt{3}}{3}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问 \(d=-1\) 或 \(d=4\)，对应 \(a_n=-n+11\) 或 \(a_n=4n+6\)；第（2）问
\(\displaystyle \left|a_{1}\right|+\left|a_{2}\right|+\cdots+\left|a_{n}\right|=
\begin{cases}
-\frac{1}{2}n^2+\frac{21}{2}n, & n\leqslant 11,\\
\frac{1}{2}n^2-\frac{21}{2}n+110, & n\geqslant 12.
\end{cases}\)
\end{solution}
...
\begin{solution}
短答案：第（1）问 \(BD\perp\) 平面 \(APC\)；第（2）问正切值为 \(\frac{4\sqrt{3}}{3}\)；第（3）问 \(\frac{PG}{GC}=\frac{3}{2}\).
\end{solution}
...
\begin{solution}
短答案：第（1）问切线方程为 \(y=6x-8\)；第（2）问最小值为
\(\displaystyle
\begin{cases}
3a-1, & a<-1,\\
0, & 1<a\leqslant 3,\\
...
\begin{solution}
短答案：第（1）问抛物线方程为 \(x^2=4y\)；第（2）问 \(|MN|\) 的最小值为 \(\frac{8\sqrt{2}}{5}\).
\end{solution}
