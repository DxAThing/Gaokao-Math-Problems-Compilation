...
\begingroup
\renewcommand{\texfigure}[2][]{\texinclude[#1]{#2}}
\choices
    {\texfigure[max width=0.24\linewidth,max totalheight=3.0cm]{img_repaint/2013/sichuan_liberal/q7_choice_a.tex}}
    {\texfigure[max width=0.24\linewidth,max totalheight=3.0cm]{img_repaint/2013/sichuan_liberal/q7_choice_b.tex}}
    {\texfigure[max width=0.24\linewidth,max totalheight=3.0cm]{img_repaint/2013/sichuan_liberal/q7_choice_c.tex}}
    {\texfigure[max width=0.24\linewidth,max totalheight=3.0cm]{img_repaint/2013/sichuan_liberal/q7_choice_d.tex}}
\endgroup
\end{problem}
...
\begin{problem}
在 \(\triangle ABC\) 中，角 \(A\)，\(B\)，\(C\) 的对边分别为 \(a\)，\(b\)，\(c\)，且 \(\cos\left(A-B\right)\cos B-\sin\left(A-B\right)\sin\left(A+C\right)=-\frac{3}{5}\).
\begin{enumerate}
\item 求 \(\sin A\) 的值；
