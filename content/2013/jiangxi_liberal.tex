...
\begin{solution}
短答案：\(a\)，\(b\)，\(c\) 成等差数列；\(\frac{a}{b} = \frac{3}{5}\).
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(X\) 的所有可能取值为 \(-2\)，\(-1\)，\(0\)，\(1\).
\item 短答案：去下棋的概率为 \(\frac{7}{15}\)，不去唱歌的概率为 \(\frac{11}{15}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
短答案：点 \(B_{1}\) 到平面 \(EA_{1}C_{1}\) 的距离为 \(\frac{\sqrt{10}}{5}\).
\end{solution}
...
\begin{solution}
短答案：椭圆 \(C\) 的方程为 \(\frac{x^{2}}{4} + y^{2} = 1\)；\(2m-k = \frac{1}{2}\).
\end{solution}
...
\begin{enumerate}
\item 短答案：\(\frac{2}{3}\).
\item 短答案：\(x_{1} = \frac{a}{-a^{2}+a+1}\)，\(x_{2} = \frac{1}{-a^{2}+a+1}\).
\item 短答案：最大值为 \(\frac{1}{20}\)，最小值为 \(\frac{1}{33}\).
\end{enumerate}
\end{solution}
