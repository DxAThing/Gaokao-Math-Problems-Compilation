...
\begin{solution}
短答案：\(x=\frac{\pi}{6}\)；\(f(x)\) 的最大值为 \(\frac{3}{2}\).
\end{solution}
...
\begin{solution}
短答案：二面角 \(C-PB-A\) 的余弦值为 \(\frac{\sqrt{6}}{4}\).
\end{solution}
...
\begin{solution}
短答案：至少取到 \(1\) 道乙类题的概率为 \(\frac{5}{6}\)；\(X\) 的分布列为
\(P(X=0)=\frac{4}{125}\)，\(P(X=1)=\frac{28}{125}\)，\(P(X=2)=\frac{57}{125}\)，\(P(X=3)=\frac{36}{125}\)，
且 \(E(X)=2\).
\end{solution}
...
\begin{solution}
短答案：\(p=2\)；线段 \(AB\) 中点 \(N\) 的轨迹方程为 \(x^2=\frac{4}{3}y\).
\end{solution}
...
\begin{solution}
短答案：第（1）问不等式成立；第（2）问 \(a\in(-\infty,-3]\).
\end{solution}
...
\begin{solution}
短答案：\(\angle FEB=\angle CEB\)，且 \(EF^2=AD\cdot BC\).
\end{solution}
...
\begin{solution}
短答案：交点的极坐标为 \(\left(4,\frac{\pi}{2}\right)\) 和 \(\left(2\sqrt{2},\frac{\pi}{4}\right)\)；\(a=-1\)，\(b=2\).
\end{solution}
...
\begin{solution}
短答案：第（1）问解集为 \((-\infty,1]\cup[5,+\infty)\)；第（2）问 \(a=3\).
\end{solution}
