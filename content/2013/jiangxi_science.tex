...
\begin{solution}
短答案：\(B=\frac{\pi}{3}\)；\(b\in\left[\frac{1}{2},1\right)\).
\end{solution}
...
\begin{solution}
短答案：\(P(X=0)=\frac{2}{7}\)；\(X\) 的分布列为
\(P(X=-2)=\frac{1}{14}\)，\(P(X=-1)=\frac{5}{14}\)，\(P(X=0)=\frac{2}{7}\)，\(P(X=1)=\frac{2}{7}\)，且 \(E(X)=\frac{3}{14}\).
\end{solution}
...
\begin{solution}
短答案：\(AD\perp\) 平面 \(CFG\)；平面 \(BCP\) 与平面 \(DCP\) 的夹角的余弦值为 \(\frac{\sqrt{2}}{4}\).
\end{solution}
...
\begin{solution}
短答案：椭圆 \(C\) 的方程为 \(\frac{x^2}{4}+\frac{y^2}{3}=1\)；存在常数 \(\lambda=2\).
\end{solution}
...
\begin{solution}
短答案：函数图象关于直线 \(x=\frac{1}{2}\) 对称；二阶周期点存在时，\(a>\frac{1}{2}\)；当 \(a\in\left(\frac{1}{2},\frac{1+\sqrt{2}}{2}\right)\) 时，\(S(a)\) 单调递减，当 \(a\in\left(\frac{1+\sqrt{2}}{2},+\infty\right)\) 时，\(S(a)\) 单调递增.
\end{solution}
