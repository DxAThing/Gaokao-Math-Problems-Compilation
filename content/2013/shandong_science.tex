...
\begin{center}
\texfigure[float=inline,width=5.5cm,max width=0.50\linewidth]{img_repaint/2013/shandong_science/q13_fig1.tex}
\end{center}
\end{problem}
...
\begin{solution}
短答案：\(a = c = 3\)；\(\sin (A - B) = \frac{10\sqrt{2}}{27}\).
\end{solution}
...
\begin{solution}
短答案：\(AB \parallel GH\)；二面角 \(D - GH - E\) 的余弦值为 \(\frac{4}{5}\).
\end{solution}
...
\begin{solution}
短答案：甲队以 \(3:0\)，\(3:1\)，\(3:2\) 胜利的概率分别为 \(\frac{8}{27}\)，\(\frac{8}{27}\)，\(\frac{4}{27}\)；
\(P(X=0)=\frac{16}{27}\)，\(P(X=1)=\frac{4}{27}\)，\(P(X=2)=\frac{4}{27}\)，\(P(X=3)=\frac{3}{27}\)，且 \(E(X)=\frac{7}{9}\).
\end{solution}
...
\begin{solution}
短答案：\(a_n = 2n - 1\)；\(R_n = \frac{1}{9}\left(4 - \frac{3n + 1}{4^{n-1}}\right)\).
\end{solution}
...
\begin{solution}
短答案：\(f(x)\) 在 \(\left(-\infty, \frac{1}{2}\right)\) 上单调递增，在 \(\left(\frac{1}{2}, +\infty\right)\) 上单调递减，最大值为 \(\frac{1}{2}\e^{-1} + c\)；关于 \(x\) 的方程 \(\lvert\ln x\rvert=f(x)\) 的根的个数按 \(c<-\e^{-2}\)，\(c=-\e^{-2}\)，\(c>-\e^{-2}\) 分别为 \(0\)，\(1\)，\(2\).
\end{solution}
...
\begin{solution}
短答案：椭圆方程为 \(\frac{x^2}{4}+y^2=1\)；\(m\) 的取值范围为 \(\left(-\frac{3}{2},\frac{3}{2}\right)\)；\(\frac{1}{kk_1}+\frac{1}{kk_2}\) 的定值为 \(-8\).
\end{solution}
