...
所以
\[-2T_n=4+4\cdot 3^1+4\cdot 3^2+\cdots+4\cdot 3^{n-1}-4n\cdot 3^n=4+4\cdot \frac{3\left( 1-3^{n-1} \right)}{1-3}-4n\cdot 3^n=4+2\cdot 3\left( 3^{n-1}-1 \right)-4n\cdot 3^n=\left( 2-4n \right)\cdot 3^n-2\].
故
...
（2）
\[|a-2b^2|+|b-2a^2|\ge |a-2b^2+b-2a^2|=|2a^2+2b^2-(a+b)|=2a^2+2b^2-(a+b)\ge (a+b)^2-(a+b)=(a+b)(a+b-1)\ge 3\times 2=6\].
故
\(|a-2b^2|+|b-2a^2|\ge 6\).
\end{solution}
