...
\choices
    {\choicebitmap[max width=4.0cm,max totalheight=4.8cm]{img/2024/national_paper_a_liberal/q8_optA.png}}
    {\choicebitmap[max width=4.0cm,max totalheight=4.8cm]{img/2024/national_paper_a_liberal/q8_optB.png}}
    {\choicebitmap[max width=4.0cm,max totalheight=4.8cm]{img/2024/national_paper_a_liberal/q8_optC.png}}
    {\choicebitmap[max width=4.0cm,max totalheight=4.8cm]{img/2024/national_paper_a_liberal/q8_optD.png}}
\end{problem}
...
\bitmapfigure[max width=0.70\linewidth,max totalheight=5.0cm]{img/2024/national_paper_a_liberal/q19_fig1.png}}
\end{problem}
...
\begin{enumerate}
\item 写出 \(C\) 的直角坐标方程；
\item 设直线 \(l\) 的参数方程为 \(\begin{cases}x=t,\\y=t+a\end{cases}\ (t\text{ 为参数})\)，若 \(C\) 与 \(l\) 相交于 \(A,B\) 两点，且 \(|AB|=2\)，求 \(a\).
\end{enumerate}
\end{problem}
