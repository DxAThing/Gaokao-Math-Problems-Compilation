...
\solutionfigure{\bitmapfigure[max width=0.55\linewidth]{img/2024/shanghai/q17_solution_fig1.png}}
...
（3）根据题意，\(A_1(-1,0)\)，\(A_2(1,0)\). 水平直线 \(y=0\) 与双曲线的交点为 \(A_1\)，\(A_2\)，不满足 \(\overrightarrow{A_1R}\cdot\overrightarrow{A_2P}=1\)，故设
...
\solutionfigure{\bitmapfigure[max width=0.55\linewidth]{img/2024/shanghai/q20_solution_fig1.png}}
