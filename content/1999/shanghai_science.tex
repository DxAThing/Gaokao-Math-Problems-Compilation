...
\begin{solution}
\begin{enumerate}
\item 将 \(y=\dfrac{1}{x}\) 代入椭圆方程，得 \(\dfrac{x^2}{a^2}+\dfrac{1}{b^2x^2}=1\)，化简得 \(b^2x^4-a^2b^2x^2+a^2=0\). 由题意，有 \(\Delta=a^4b^4-4a^2b^2=0\)，故 \(ab=2\). 于是由方程解得 \(x=\dfrac{a}{\sqrt2}\)（舍去 \(x=-\dfrac{a}{\sqrt2}\)），所以 \(P\left(\dfrac{a}{\sqrt2},\dfrac{\sqrt2}{a}\right)\).
