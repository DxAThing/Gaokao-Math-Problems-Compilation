...
\makebox[\linewidth][c]{\problemconsumeinlineblockprefix\originalincludegraphics[width=0.38\linewidth]{img/1999/national_liberal/q1_fig1.png}}
...
\makebox[\linewidth][r]{\problemconsumeinlineblockprefix\originalincludegraphics[width=0.38\linewidth]{img/1999/national_liberal/q10_fig1.png}}
...
\makebox[\linewidth][r]{\problemconsumeinlineblockprefix\originalincludegraphics[width=0.38\linewidth]{img/1999/national_liberal/q22_fig1.png}}
...
\makebox[\linewidth][c]{\problemconsumeinlineblockprefix\originalincludegraphics[width=0.95\linewidth]{img/1999/national_liberal/q23_fig1.png}}
\end{problem}

\begin{problem}
如图，给出定点 \(A(a,0)\)（\(a>0\)）和直线 \(l\colon x=-1\). \(B\) 是直线 \(l\) 上的动点，\(\angle BOA\) 的角平分线交 \(AB\) 于点 \(C\). 求点 \(C\) 的轨迹方程，并讨论方程表示的曲线类型与 \(a\) 值的关系.

\makebox[\linewidth][r]{\problemconsumeinlineblockprefix\originalincludegraphics[width=0.33\linewidth]{img/1999/national_liberal/q24_fig1.png}}
