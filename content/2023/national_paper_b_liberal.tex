...
\begin{center}\bitmapfigure[max width=6.0cm,max height=6.0cm]{img/2023/national_paper_B_liberal/q3_fig1.png}\end{center}
\choices{\(24\)}{\(26\)}{\(28\)}{\(30\)}
\end{problem}
...
\end{enumerate}
\bitmapfigure[max width=6.0cm,max height=6.0cm]{img/2023/national_paper_B_liberal/q19_fig1.png}
\end{problem}
