...
\begin{center}
\bitmapfigure[max width=4.0cm,max totalheight=4.8cm]{img/2023/national_paper_B_science/q3_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=3.8cm,max totalheight=4.8cm]{img/2023/national_paper_B_science/q8_fig1.png}
\end{center}
...
\end{solution}
\begin{problem}
已知等比数列 \(\{a_n\}\) 满足 \(a_2a_4a_5=a_3a_6\)，\(a_9a_{10}=-8\)，则 \(a_7=\)（\quad） \fillinblank{}.
\end{problem}
...
（2）由（1）知 \(\bar z=11\)，且 \(2\sqrt{\frac{s^2}{10}}=2\sqrt{6.1}=\sqrt{24.4}\). 故有 \(\bar z\ge 2\sqrt{\frac{s^2}{10}}\).
...
\bitmapfigure[max width=4.3cm,max totalheight=4.8cm]{img/2023/national_paper_B_science/q19_fig1.png}
