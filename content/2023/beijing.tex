...
\bitmapfigure[max width=6.4cm,max totalheight=4.0cm]{img/2023/beijing/q9_fig1.png}
...
\bitmapfigure[max width=6.6cm,max totalheight=4.0cm]{img/2023/beijing/q9_solution_fig1.png}
...
\item 设 \(P(x_3,f(x_3))(x_3<-a)\)，\(Q(x_4,f(x_4))(x_4\ge -a)\). 若 \(|PQ|\) 存在最小值，则 \(a\) 的取值范围是 \(\left(0,\dfrac{1}{2}\right]\).
\end{circlelist}
...
\bitmapfigure[max width=4.0cm,max totalheight=4.0cm]{img/2023/beijing/q15_solution_fig1.png}
...
\bitmapfigure[max width=4.0cm,max totalheight=4.0cm]{img/2023/beijing/q15_solution_fig2.png}
...
\bitmapfigure[max width=4.3cm,max totalheight=4.0cm]{img/2023/beijing/q15_solution_fig3.png}
...
\bitmapfigure[max width=4.9cm,max totalheight=4.8cm]{img/2023/beijing/q16_fig1.png}
...
\bitmapfigure[max width=4.9cm,max totalheight=4.8cm]{img/2023/beijing/q16_solution_fig1.png}
...
\bitmapfigure[max width=6.0cm,max totalheight=4.2cm]{img/2023/beijing/q19_solution_fig1.png}
