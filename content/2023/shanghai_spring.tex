...
\item 由题意 \(S=\sqrt{\frac{f\cdot n}{T}+\frac{1}{3n}}\) 且 \(f=18\)，\(T=10000\)，故 \(S=\sqrt{\frac{18n}{10000}+\frac{1}{3n}}\). 对 \(n\) 求导可得最小值点满足 \(9\sqrt2\,n^2=200\)，从而 \(n\approx 6.274\). 比较 \(n=6\) 与 \(n=7\) 可知在第 \(6\) 层时该建筑体 \(S\) 最小.
\end{enumerate}
\end{solution}
