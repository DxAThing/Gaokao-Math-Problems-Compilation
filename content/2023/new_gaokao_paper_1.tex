...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q4_solution_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q6_solution_fig1.png}
...
\bitmapfigure[max width=0.62\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q12_solution_fig1.png}
...
\bitmapfigure[max width=0.5\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q14_solution_fig1.png}
...
\bitmapfigure[max width=0.6\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q15_solution_fig1.png}
\end{solution}
...
\bitmapfigure[max width=0.5\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q16_solution_fig1.png}
\end{solution}
\section{解答题}
...
（2）设内角 \(A,B,C\) 的对边分别为 \(a,b,c\)，则 \(c=AB=5\). 如图，\(AB\) 边上的高 \(CD=a\sin B\).
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q17_solution_fig1.png}
\end{solution}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q18_fig1.png}

\end{problem}

\begin{solution}
（1）以 \(C\) 为原点建立空间直角坐标系，如图可取
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/new_gaokao_paper_1/q18_solution_fig1.png}
\end{solution}
...
\begin{solution}
（1）由题意得 \(W\) 为抛物线，且准线为 \(y=0\)，焦点为 \(\left(0,\frac12\right)\). 这是由标准抛物线方程 \(x^2=2py\) 向上平移 \(\frac14\) 个单位得到的，故可设为
\(x^2=2py-\frac14\).
因为焦点到准线的距离为 \(p\)，所以 \(p=\frac12\)，故
\(W:\ x^2=y-\frac14\).

（2）不妨设 \(A,B,C\) 在抛物线上，且 \(AB\perp BC\)，所以
