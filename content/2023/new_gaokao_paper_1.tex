...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q4_solution_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q6_solution_fig1.png}
...
\bitmapfigure[max width=0.62\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q12_solution_fig1.png}
...
\bitmapfigure[max width=0.5\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q14_solution_fig1.png}
...
\bitmapfigure[max width=0.6\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q15_solution_fig1.png}
\end{solution}
\begin{problem}
...
\bitmapfigure[max width=0.5\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q16_solution_fig1.png}
\end{solution}
\section{解答题}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q17_solution_fig1.png}
\end{solution}
\begin{problem}
如图，在正四棱柱 \(ABCD-A_1B_1C_1D_1\) 中，\(AB=2\)，\(AA_1=4\). 点 \(A_2,B_2,C_2,D_2\) 分别在棱 \(AA_1,BB_1,CC_1,DD_1\) 上，且 \(AA_2=1\)，\(BB_2=DD_2=2\)，\(CC_2=3\).

\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q18_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2023/national_paper_1/q18_solution_fig1.png}
\end{solution}
\begin{problem}
已知函数 \(f(x)=a(\e^x+a)-x\).
\begin{enumerate}
