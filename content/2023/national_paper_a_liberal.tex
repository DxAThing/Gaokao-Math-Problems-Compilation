...
\begin{solution}
方法一：设等差数列 \(\{a_n\}\) 的公差为 \(d\)，首项为 \(a_1\)，依题意可得，
...
方法二：\(a_2+a_6=2a_4=10\)，\(a_4a_8=45\)，所以 \(a_4=5\)，\(a_8=9\)，
...
\begin{solution}
方法一：因为 \(\overrightarrow{PF_1}\cdot\overrightarrow{PF_2}=0\)，所以 \(\angle F_1PF_2=90^\circ\)，
...
方法二：因为 \(\overrightarrow{PF_1}\cdot\overrightarrow{PF_2}=0\)，所以 \(\angle F_1PF_2=90^\circ\)，由椭圆方程可知，
...
\bitmapfigure[max width=3.4cm,max totalheight=4.8cm]{img/2023/national_paper_A_liberal/q10_fig1.png}
...
\bitmapfigure[max width=3.8cm,max totalheight=4.8cm]{img/2023/national_paper_A_liberal/q18_fig1.png}
...
（2）（1）依题意，可知这 40 只小鼠体重的中位数是将两组数据合在一起，从小到大排后第 20 位与第 21 位数据的平均数，
