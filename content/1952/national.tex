...
\begin{problem}
若 \(\lg 2x = 2\lg x\)，问 \(x=\)\fillinblank{}.
...
\begin{problem}
\(\begin{vmatrix}1 & 2 & 3 \cr 4 & 5 & 0 \cr 3 & 2 & 1\end{vmatrix}=\)\fillinblank{}.
...
\begin{problem}
两个圆的半径都是 \(4\) 寸，并且一个圆通过另一圆的圆心，则这两个圆的公共弦之长是 \fillinblank{} 寸.
...
\begin{problem}
三角形 \(\triangle ABC\) 的面积是 \(60\) 平方寸，\(M\) 是 \(AB\) 的中点，\(N\) 是 \(AC\) 的中点，则 \(\triangle AMN\) 的面积是 \fillinblank{} 平方寸.
...
\begin{problem}
直圆锥之底之半径为 \(3\) 尺，斜高为 \(5\) 尺，则其体积为 \fillinblank{} 立方尺.
...
\begin{problem}
太阳仰角为 \(30^{\circ}\) 时塔影长 \(5\) 丈，求塔高为 \fillinblank{}.
...
\begin{problem}
三角形 \(\triangle ABC\) 之 \(b\) 边为 \(3\) 寸，\(c\) 边为 \(4\) 寸，\(A\) 角为 \(30^{\circ}\)，则 \(\triangle ABC\) 的面积为 \fillinblank{} 平方寸.
...
\begin{solution}
\(\cos C = \frac{1}{8}\)，\(\sin C = \frac{3}{8}\sqrt{7}\)，\(\sin B = \frac{5}{16}\sqrt{7}\)，\(\sin A = \frac{1}{4}\sqrt{7}\). \(A\)，\(B\)，\(C\) 皆为锐角.
\end{solution}
