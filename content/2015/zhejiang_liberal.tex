...
\begin{problem}
已知 \(e_1\)，\(e_2\) 是平面单位向量，且 \(e_1\cdot e_2=\frac{1}{2}\). 若平面向量 \(\bs{b}\) 满足 \(\bs{b}\cdot e_1=\bs{b}\cdot e_2=1\)，则 \(\lvert\bs{b}\rvert=\)\fillinblank{}.
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(A(2t,t^2)\)，\(B\left(\dfrac{2t}{1+t^2},\dfrac{2t^2}{1+t^2}\right)\)；
\item \(\dfrac{t^3}{2}\).
\end{enumerate}
\end{solution}
