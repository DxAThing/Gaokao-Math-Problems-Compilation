...
\end{enumerate}
\answer{第一次检测出的是次品且第二次检测出的是正品的概率为 \(\frac{3}{10}\)；\(P(X=200)=\frac{1}{10}\)，\(P(X=300)=\frac{3}{10}\)，\(P(X=400)=\frac{6}{10}\)，\(E(X)=350\).}
\end{problem}
...
\end{enumerate}
\answer{\(x_n = \dfrac{n}{n+1}\)；\(T_n \geqslant \dfrac{1}{4n}\).}
\end{problem}
...
\answer{\(EF \parallel B_{1}C\)；二面角 \(E-A_{1}D-B_{1}\) 的余弦值为 \(\dfrac{\sqrt{6}}{3}\).}
\end{problem}
...
\end{enumerate}
\answer{\(e = \dfrac{2\sqrt{5}}{5}\)；\(E: \dfrac{x^2}{45} + \dfrac{y^2}{9} = 1\).}
\end{problem}
...
\end{enumerate}
\answer{第一问：当 \(a \leqslant -2\) 时单调递增且无极值；当 \(a \geqslant 2\) 时单调递减且无极值；当 \(-2 < a < 2\) 时有极小值 \(b - \dfrac{a^2}{4}\). 第二问：\(D = |a-a_0| + |b-b_0|\). 第三问：\(z\) 的最大值为 \(1\).}
\end{problem}
