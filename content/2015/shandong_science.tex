...
\begin{solution}
\begin{enumerate}
\item 递增区间为 \(\left[k\pi-\frac{\pi}{4},k\pi+\frac{\pi}{4}\right]\)，递减区间为 \(\left[k\pi+\frac{\pi}{4},k\pi+\frac{3\pi}{4}\right]\)，其中 \(k\in\Z\).
\item \(\triangle ABC\) 面积的最大值为 \(\frac{2+\sqrt{3}}{4}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(BD \parallel\) 平面 \(FGH\).
\item 平面 \(FGH\) 与平面 \(ACFD\) 所成的角（锐角）为 \(60^{\circ}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_1=3\)，当 \(n\geqslant2\) 时，\(a_n=3^{n-1}\).
\item \(T_n=\frac{13}{12}-\frac{2n+1}{4\cdot3^{n-1}}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 所有个位数字是 \(5\) 的“三位递增数”为 \(125\)，\(135\)，\(145\)，\(235\)，\(245\)，\(345\).
\item \(P(X=-1)=\frac{1}{14}\)，\(P(X=0)=\frac{2}{3}\)，\(P(X=1)=\frac{11}{42}\)，\(E(X)=\frac{4}{21}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C\) 的方程为 \(\frac{x^2}{4}+y^2=1\).
\item
\begin{enumerate}
\item \(\frac{|OQ|}{|OP|}=2\).
\item \(\triangle ABQ\) 面积的最大值为 \(12\).
\end{enumerate}
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 当 \(a<0\) 时，函数有一个极值点；当 \(0\leqslant a\leqslant\frac{8}{9}\) 时，函数无极值点；当 \(a>\frac{8}{9}\) 时，函数有两个极值点.
\item 第二问中 \(a\in[0,1]\).
\end{enumerate}
\end{solution}
