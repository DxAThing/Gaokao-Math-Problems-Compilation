...
\begin{enumerate}
\item \(a_n=2n+1\)；
\item \(\displaystyle\sum_{k=1}^{n}b_k=\frac{1}{6}-\frac{1}{4n+6}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\sqrt{a}x-y-a=0\) 或 \(\sqrt{a}x+y+a=0\)；
\item 存在，\(P(0,-a)\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(a=-\frac{3}{4}\)；
\item 当 \(a<-\frac{5}{4}\) 或 \(a>-\frac{3}{4}\) 时有一个零点；当 \(a=-\frac{5}{4}\) 或 \(a=-\frac{3}{4}\) 时有两个零点；当 \(-\frac{5}{4}<a<-\frac{3}{4}\) 时有三个零点.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C_1:\rho\cos\theta=-2\)，\(C_2:\rho^2-2\rho\cos\theta-4\rho\sin\theta+4=0\)；
\item \(\dfrac{1}{2}\).
\end{enumerate}
\end{solution}
