...
\begin{solution}
短答案：\(\tan\left(\alpha+\frac{\pi}{4}\right)=-3\)；分式的值为 \(1\).
\end{solution}
...
\begin{solution}
短答案：\(x=0.0075\)；众数为 \(230\)，中位数为 \(224\)；应抽取 \(5\) 户.
\end{solution}
...
\begin{solution}
短答案：第（1）问为 \(BC\parallel\) 平面 \(PDA\)，第（2）问为 \(BC\perp PD\)，第（3）问点 \(C\) 到平面 \(PDA\) 的距离为 \(\dfrac{3\sqrt{7}}{2}\).
\end{solution}
...
\begin{solution}
短答案：\(a_{4}=\dfrac{7}{8}\)；数列 \(\left\{a_{n+1}-\dfrac{1}{2}a_{n}\right\}\) 的首项为 \(1\)，公比为 \(\dfrac{1}{2}\)；\(a_{n}=(2n-1)\left(\dfrac{1}{2}\right)^{n-1}\).
\end{solution}
...
\begin{solution}
短答案：圆心为 \((3,0)\)；\(C:\ x^{2}+y^{2}-3x=0\)，其中 \(\dfrac{5}{3}<x\leqslant 3\)；存在，\(k\in\left[-\dfrac{2\sqrt{5}}{7},\dfrac{2\sqrt{5}}{7}\right]\cup\left\{-\dfrac{3}{4},\dfrac{3}{4}\right\}\).
\end{solution}
...
\begin{solution}
短答案：\(a\leqslant\dfrac{1}{2}\)；\(f(x)\) 在 \((-\infty,a)\) 上单调递减，在 \((a,+\infty)\) 上单调递增；当 \(a=2\) 时有一个零点 \(x=2\)，当 \(a>2\) 时有两个零点.
\end{solution}
