...
\begin{center}
\bitmapinclude[max width=0.48\linewidth,max totalheight=7.0cm,scale=1.3]{img/2015/beijing_liberal/q5_fig1.png}
\end{center}
...
\item 在语文和数学两个科目
\end{circlelist}
中，其语文成绩名次比其总成绩名次靠前的学生是\fillinblank{}；
中，丙同学的成绩名次更靠前的科目是\fillinblank{}.
\end{problem}
