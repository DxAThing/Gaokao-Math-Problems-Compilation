...
\begin{solution}
短答案：\(T=\pi\)；最大值为 \(\frac{\sqrt{3}}{4}\)，最小值为 \(-\frac{1}{2}\)
\end{solution}
...
\begin{solution}
短答案：\(P(A)=\frac{6}{35}\)；\(P(X=1)=\frac{1}{14}\)，\(P(X=2)=\frac{3}{7}\)，\(P(X=3)=\frac{3}{7}\)，\(P(X=4)=\frac{1}{14}\)，\(E(X)=\frac{5}{2}\)
\end{solution}
...
\begin{solution}
短答案：\(MN \parallel \text{平面 }ABCD\)；二面角 \(D_{1}-AC-B_{1}\) 的正弦值为 \(\frac{3\sqrt{10}}{10}\)；\(A_{1}E=\sqrt{7}-2\)
\end{solution}
...
\begin{solution}
短答案：\(q=2\)，\(a_{n}=\begin{cases}
2^{\frac{n-1}{2}},&n\text{为奇数},\\
2^{\frac{n}{2}},&n\text{为偶数},
\end{cases}\)；前 \(n\) 项和为 \(4-\frac{n+2}{2^{n-1}}\)
\end{solution}
...
\begin{solution}
短答案：\(\frac{\sqrt{3}}{3}\)；\(\frac{x^{2}}{3}+\frac{y^{2}}{2}=1\)；\(\left(-\infty,-\frac{2\sqrt{3}}{3}\right)\cup\left(\frac{\sqrt{2}}{3},\frac{2\sqrt{3}}{3}\right)\)
\end{solution}
...
\begin{solution}
短答案：当 \(n\) 为奇数时，\(f(x)\) 在 \((-\infty,-1)\)，\((1,+\infty)\) 上单调递减，在 \((-1,1)\) 上单调递增；当 \(n\) 为偶数时，\(f(x)\) 在 \((-\infty,1)\) 上单调递增，在 \((1,+\infty)\) 上单调递减；第（2）问结论为对任意正实数 \(x\)，都有 \(f(x)\leqslant g(x)\)；第（3）问结论为 \(|x_{2}-x_{1}|<\frac{a}{1-n}+2\).
\end{solution}
