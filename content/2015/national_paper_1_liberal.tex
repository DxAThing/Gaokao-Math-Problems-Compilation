...
\begin{solution}
\begin{enumerate}
\item 平面 \(AEC\perp\) 平面 \(BED\).
\item 三棱锥 \(E\text{-}ACD\) 的侧面积为 \(3+2\sqrt{5}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(y=c+d\sqrt{x}\) 适宜作为年销售量 \(y\) 关于年宣传费 \(x\) 的回归方程类型.
\item \(\hat{y}=100.6+68\sqrt{x}\).
\item
\begin{enumerate}
\item 年销售量的预报值为 \(576.6\text{~t}\)，年利润的预报值为 \(66.32\text{~千元}\).
\item 年宣传费为 \(46.24\text{~千元}\) 时，年利润的预报值最大.
\end{enumerate}
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 当 \(a>0\) 时，\(f'(x)\) 有且只有一个零点.
\item \(f(x)\geqslant 2a+a\ln\frac{2}{a}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\frac{4-\sqrt{7}}{3}<k<\frac{4+\sqrt{7}}{3}\).
\item \(|MN|=2\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(DE\) 是 \(\odot O\) 的切线.
\item \(\angle ACB=60^{\circ}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C_{1}\) 的极坐标方程为 \(\rho\cos\theta=-2\)，\(C_{2}\) 的极坐标方程为 \(\rho^{2}-2\rho\cos\theta-4\rho\sin\theta+4=0\).
\item \(S_{\triangle C_{2}MN}=\frac{1}{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 解集为 \(\left(\frac{2}{3},2\right)\).
\item \(a\in(2,+\infty)\).
\end{enumerate}
\end{solution}
