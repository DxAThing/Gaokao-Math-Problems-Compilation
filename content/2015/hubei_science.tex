...
\bitmapfigure[max width=0.38\linewidth,max totalheight=4.8cm]{img/2015/hubei_science/q4_fig1.png}
...
\begin{problem}
已知符号函数 \(\operatorname{sgn}x=\left\{\begin{array}{ll}1, & x>0,\\0, & x=0,\\-1, & x<0,\end{array}\right.\)，\(f(x)\) 是 \(\R\) 上的增函数，\(g(x)=f(x)-f(ax)\)（\(a>1\)），则（\quad）
...
\bitmapfigure[max width=0.46\linewidth,max totalheight=4.8cm]{img/2015/hubei_science/q13_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.30\linewidth,max totalheight=4.8cm]{img/2015/hubei_science/q14_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.44\linewidth,max totalheight=4.8cm]{img/2015/hubei_science/q19_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.68\linewidth,max totalheight=4.8cm]{img/2015/hubei_science/q21_fig1.png}
\end{problem}
