...
\begin{center}
\bitmapinclude[max width=0.38\linewidth]{img/2017/beijing_science/q7_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=0.44\linewidth]{img/2017/beijing_science/q14_fig1.png}
\end{center}

\begin{circlelist}
\item 记 \(Q_i\) 为第 \(i\) 名工人在这一天中加工的零件总数，
\item 记 \(p_i\) 为第 \(i\) 名工人在这一天中平均每小时加工的零件数，
\end{circlelist}
则 \(Q_1\)，\(Q_2\)，\(Q_3\) 中最大的是\fillinblank{}.
则 \(p_1\)，\(p_2\)，\(p_3\) 中最大的是\fillinblank{}.
...
\begin{center}
\bitmapinclude[max width=0.52\linewidth]{img/2017/beijing_science/q16_fig1.png}
\end{center}
\end{problem}
...
\bitmapfigure[max width=0.7\linewidth]{img/2017/beijing_science/q17_fig1.png}
...
\examdisplayaligned{
y_1+\frac{y_2y_1}{x_2}-2x_1
&=\frac{y_1y_2+y_2y_1-2x_1x_2}{x_2}\\
&=\frac{\left(kx_1+\dfrac12\right)x_2+\left(kx_2+\dfrac12\right)x_1-2x_1x_2}{x_2}\\
&=\frac{(2k-2)x_1x_2+\dfrac12(x_2+x_1)}{x_2}\\
&=\frac{(2k-2)\cdot \dfrac{1}{4k^2}+\dfrac{1-k}{2k^2}}{x_2}\\
&=0
}
...
\(1^{\odot}\) 当 \(d_1>0\) 时，取正整数 \(m>\dfrac{d_2}{d_1}\)，则当 \(n\ge m\) 时，\(nd_1>d_2\)，因此 \(c_n=b_1-a_1n\).
此时，\(c_m\)，\(c_{m+1}\)，\(c_{m+2}\)，\(\dots\) 是等差数列.

\(2^{\odot}\) 当 \(d_1=0\) 时，对任意 \(n\ge1\)，\(c_n=b_1-a_1n+(n-1)\max\{d_2,0\}=b_1-a_1+(n-1)\bigl(\max\{d_2,0\}-a_1\bigr)\).
此时，\(c_1\)，\(c_2\)，\(c_3\)，\(\dots\)，\(c_n\)，\(\dots\) 是等差数列.

\(3^{\odot}\) 当 \(d_1<0\) 时，当 \(n>\dfrac{d_2}{d_1}\) 时，有 \(nd_1<d_2\)，所以
\examdisplayaligned{
\frac{c_n}{n}
&=\frac{b_1-a_1n+(n-1)(d_2-nd_1)}{n}\\
