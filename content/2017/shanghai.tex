...
短答案：
\begin{enumerate}
\item \(\left(\dfrac\pi2,\pi\right)\).
\item \(\dfrac{15\sqrt3}{4}\).
\end{enumerate}
\end{solution}
...
短答案：
\begin{enumerate}
\item \(P\left(\dfrac{2\sqrt3}{3},\dfrac{\sqrt6}{3}\right)\).
\item \(M\left(\dfrac{29}{20},0\right)\)，\(M\left(\dfrac35,0\right)\)，\(M(1,0)\).
\item \(y=\dfrac{\sqrt5}{10}x+1\).
\end{enumerate}
\end{solution}
...
\item \(a\ge0\).
\item \(f(x)\) 是常值函数.
\item “\(h(x)\) 是周期函数”的充要条件是“\(f(x)\) 是常值函数”.
\end{enumerate}
\end{solution}
