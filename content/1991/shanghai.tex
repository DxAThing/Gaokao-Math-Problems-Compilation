...
[解二] 设 \(z = 2\sin\theta(\cos\theta + \i\sin\theta)\)（\(0 < \theta < \frac{\pi}{2}\) 或 \(\frac{\pi}{2} < \theta < \pi\)），则 \(z - 2\i = 2\cos\theta\left[\cos\left(\theta - \frac{\pi}{2}\right) + \i\sin\left(\theta - \frac{\pi}{2}\right)\right]\)，
