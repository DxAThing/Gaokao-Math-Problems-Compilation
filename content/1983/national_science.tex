...
\begin{solution}
\begin{enumerate}
\item 两图形的交点坐标为 \(\left(0,0\right)\)，\(\left(1,-1\right)\).
\item 曲线为圆.
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(\mathrm{d}y=\e^{-x}\left(2\cos 2x-\sin 2x\right)\mathrm{d}x\).
\item \(100\) 种.
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(r\leqslant\sqrt[4]{2}\).
\item \(k\pi-\frac{\pi}{4}\leqslant t\leqslant k\pi+\frac{\pi}{4}\)，其中 \(k\in\Z\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\(\alpha=\frac{\pi}{6}\) 或 \(\alpha=\frac{5\pi}{6}\).
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(a_{2},a_{3},\ldots\) 是公比为 \(p\) 的等比数列.
\item \(\displaystyle\lim_{n\to\infty}W_{n}=\frac{b^{2}}{1+p}\).
\end{enumerate}
\end{solution}
\end{problem}
