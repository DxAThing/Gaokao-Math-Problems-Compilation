...
\begin{center}
\begin{tabular}{@{}cc@{}}
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1998/national_science/q2_optA.png} &
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1998/national_science/q2_optB.png} \\
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1998/national_science/q2_optC.png} &
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1998/national_science/q2_optD.png}
\end{tabular}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.30\linewidth,max totalheight=3.0cm]{img/1998/national_science/q10_fig1.png}
\begin{tabular}{@{}cc@{}}
\choicebitmap[max width=0.28\linewidth,max totalheight=2.8cm]{img/1998/national_science/q10_optA.png} &
\choicebitmap[max width=0.28\linewidth,max totalheight=2.8cm]{img/1998/national_science/q10_optB.png} \\
\choicebitmap[max width=0.28\linewidth,max totalheight=2.8cm]{img/1998/national_science/q10_optC.png} &
\choicebitmap[max width=0.28\linewidth,max totalheight=2.8cm]{img/1998/national_science/q10_optD.png}
\end{tabular}
\end{center}
...
\bitmapfigure[max width=5.6cm,max totalheight=4.8cm]{img/1998/national_science/q21_fig1.png}

\end{problem}

\begin{problem}
如图，为处理含有某种杂质的水污染，要制造一底宽为 2 米的无盖长方体沉淀箱，污水从 \(A\) 汇流入，经沉淀后从 \(B\) 汇流出. 设箱体的长度为 \(a\) 米，高度为 \(b\) 米. 已知流出的水中该杂质的质量分数与 \(a\)，\(b\) 的乘积 \(ab\) 成反比. 现有制箱材料 60 平方米. 问当 \(a\)，\(b\) 各为多少米时，经沉淀后流出的水中该杂质的质量分数最小. （\(A\)，\(B\) 孔的面积忽略不计）

\bitmapfigure[max width=6.2cm,max totalheight=4.8cm]{img/1998/national_science/q22_fig1.png}
...
\bitmapfigure[max width=6.2cm,max totalheight=4.8cm]{img/1998/national_science/q23_fig1.png}
\end{problem}
