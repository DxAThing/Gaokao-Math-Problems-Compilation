...
\texfigure[max width=0.72\linewidth]{img_repaint/1998/shanghai_liberal/q6_fig1.tex}
...
\item 设有抛物线列 \(C_{1}\)，\(C_{2}\)，\(\cdots\)，\(C_{n}\)，\(\cdots\)，抛物线 \(C_{n}\)（\(n \in \mathbf{N}^{*}\)）的对称轴平行于 \(y\) 轴，顶点为 \((a_{n}, b_{n})\)，且通过点 \(D_{n}(0, n^{2} + 1)\)，过点 \(D_{n}\) 且与抛物线 \(C_{n}\) 相切的直线斜率为 \(k_{n}\)，求极限 \(\displaystyle \lim\limits_{n \to \infty} \frac{k_1 + k_2 + k_3 + \cdots + k_n}{a_n b_n}\).
