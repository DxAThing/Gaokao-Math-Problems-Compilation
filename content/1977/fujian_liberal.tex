...
\begin{enumerate}[label=（\arabic*），leftmargin=*]
    ...
    \item 如图，在 \( \triangle ABC \) 中，\( MN // BC \)，\( MN=1\ \mathrm{cm} \)，\( BC=3\ \mathrm{cm} \)，\( BM=AM+2 \)，求 \( AM \) 的长.

    \bitmapfigure[max width=4.3cm,max totalheight=4.2cm]{img/1977/fujian_liberal/q1_fig1.png}
...
\circled{1} 求十一月、十二月份每月增长率；

\circled{2} 原计划年产拖拉机多少台？
