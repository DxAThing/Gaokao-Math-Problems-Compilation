...
因为 \(E\) 是斜边 \(AB\) 的中点，且 \(\tan3\theta>\tan\theta\)，所以 \(D\) 位于 \(A\) 与 \(E\) 之间，从而 \(DE=\frac{DB-AD}{2}\). 又 \(\tan\frac{\pi}{8}=\sqrt{2}-1\)，\(\tan\frac{3\pi}{8}=\cot\frac{\pi}{8}=\sqrt{2}+1\)，所以 \(\tan3\theta-\tan\theta=2\). 因此 \(DE=\frac{h\left(\tan3\theta-\tan\theta\right)}{2}=h=CD\)，即证得 \(CD=DE\).
\end{solution}
