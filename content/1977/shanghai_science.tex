...
\begin{problem}
解不等式: \(\left\{\begin{array}{l}16-x^2\ge0\\x^2-x-6>0\end{array}\right.\)，并在数轴上把它的解表示出来.
...
\begin{problem}
当 \(k\) 为何值时，方程组 \(\left\{\begin{array}{l}x-\sqrt{y-2}=0\\kx-y-2k-10=0\end{array}\right.\) 有两组相同的解？并求出它的解.
