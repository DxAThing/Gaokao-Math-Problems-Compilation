...
\begin{solution}
（1）\( \sqrt{(-3)^2}=\sqrt{3^2}=3 \)；\( \sqrt[3]{(-27)^3}=-27 \).
...
（5）因为 \( m\le 1 \)，所以 \( m-1\le 0 \)，故 \(\sqrt{(m-1)^2}=1-m\).
...
（7）在有理式范围内可作如下因式分解：\( x^4+x^2y^2+y^4=\left( x^2+y^2 \right)^2-x^2y^2=\left( x^2+y^2-xy \right)\left( x^2+y^2+xy \right)\).
...
\begin{problem}
解方程组：\(\left\{\begin{aligned} \log_2 x-\log_4 y &= 0,\\ y^2-13x^2+36 &= 0 \end{aligned}\right.\).
...
把（1）代入（2），得 \( y^2-13y+36=0 \)，即 \((y-9)(y-4)=0\).
