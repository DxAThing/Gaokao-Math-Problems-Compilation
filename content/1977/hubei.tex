...
（1）\( \sqrt{(-3)^2} \)；\( \sqrt[3]{(-27)^3} \).

（2）\( \log_2 2+\log_5 1-\log_{\frac{1}{3}}\left( \frac{1}{27} \right) \).

（3）\( \left( \sqrt{\frac{2}{3}} \right)^3 \cdot \sqrt[3]{\left( \frac{3}{2} \right)^2} \cdot \left( \frac{2}{3} \right)^{-\frac{5}{6}} \).

（4）解方程：\( x-\sqrt{8-x^2}=0 \).

（5）当 \( m\le 1 \) 时，计算 \( \sqrt{(m-1)^2} \).

（6）求函数 \( y=\frac{\sqrt{2-x}}{x+4} \) 的定义域.

（7）分解因式：\( x^4+x^2y^2+y^4 \).

（8）证明：\( \tan 22^\circ30'=\sqrt{2}-1 \)（不查表）.
...
经验根，知 \( x=-2 \) 不适合原方程，是增根舍去，故原方程的解为 \( x=2 \).
...
\begin{problem}
解方程组：\(\left\{ \log_2 x-\log_4 y=0,\ y^2-13x^2+36=0 \right.\).
