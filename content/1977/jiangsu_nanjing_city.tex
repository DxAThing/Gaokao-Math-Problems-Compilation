...
\begin{problem}
\(\tan 10^\circ\tan 20^\circ\tan 70^\circ\tan 80^\circ\).
\end{problem}

\begin{problem}
\(\log_2\frac{3.14}{\pi}\) 与 \(0\)；
\end{problem}

\begin{problem}
\(\cos40^\circ\) 与 \(\sin40^\circ\)；
\end{problem}

\begin{problem}
\(\left(\frac{2}{5}\right)^{-2/3}\) 与 \(\left(\frac{2}{5}\right)^{-1/2}\)；
\end{problem}
...
\begin{enumerate}
    \item \(\lim\limits_{x\to2}\frac{2x^2-3x-2}{x-2}\)；
    \item \(\lim\limits_{x\to\infty}\frac{3x^2-4x+5}{2x^2+x-1}\).
\end{enumerate}
\end{problem}
