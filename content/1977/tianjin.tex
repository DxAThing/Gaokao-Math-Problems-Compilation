...
\bitmapfigure[max width=4.6cm]{img/1977/tianjin/q2_1_fig1.png}
\end{problem}

\begin{problem}
如图，已知 \(AB\)，\(DE\) 是圆 \(O\) 的直径，\(AC\) 是弦，\(AC\parallel DE\)，求证：\(CE=EB\).

\bitmapfigure[max width=6.0cm]{img/1977/tianjin/q2_2_fig1.png}
\end{problem}
...
\bitmapfigure[max width=5.0cm]{img/1977/tianjin/q4_fig1.png}
\end{problem}
