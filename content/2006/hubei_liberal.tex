...
\begin{solution}
\begin{enumerate}
\item 函数 \(f(x)\) 的最大值为 \(\frac{3}{2} + \frac{\sqrt{2}}{2}\)，最小正周期为 \(\pi\).
\item \(x\) 的取值集合为 \(\left\{x \mid k\pi - \frac{\pi}{8} \leqslant x \leqslant k\pi + \frac{3\pi}{8},\ k \in \Z\right\}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 游泳组中，青年人、中年人、老年人分别占 \(40\%\)，\(50\%\)，\(10\%\).
\item 游泳组中，青年人、中年人、老年人分别应抽取 \(60\) 人、\(75\) 人、\(15\) 人.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 二面角 \(B_{1} - AM - N\) 的平面角的余弦值为 \(\frac{\sqrt{5}}{5}\).
\item 点 \(B_{1}\) 到平面 \(AMN\) 的距离为 \(1\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\(a=-c\)，\(b=-2c-3\)，且 \(c\ne -3\). 当 \(c<-3\) 时，\(f(x)\) 在 \((-\infty,1]\) 和 \(\left[-\frac{2c+3}{3},+\infty\right)\) 上单调增加，在 \(\left[1,-\frac{2c+3}{3}\right]\) 上单调减少；当 \(c>-3\) 时，\(f(x)\) 在 \(\left(-\infty,-\frac{2c+3}{3}\right]\) 和 \([1,+\infty)\) 上单调增加，在 \(\left[-\frac{2c+3}{3},1\right]\) 上单调减少.
\end{solution}
...
\begin{solution}
\(a_n=6n-5\ (n\in\N^{*})\)，使条件对所有 \(n\in\N^{*}\) 成立的最小正整数为 \(m=10\).
\end{solution}
...
\begin{solution}
椭圆方程为 \(\frac{x^2}{4}+\frac{y^2}{3}=1\)，点 \(B\) 在以 \(MN\) 为直径的圆内.
\end{solution}
