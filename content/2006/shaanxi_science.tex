...
\begin{problem}
甲、乙、丙 3 人投篮，投进的概率分别是 \(\frac{1}{3}, \frac{2}{5}, \frac{1}{2}\). (1) 现 3 人各投篮 1 次，求 3 人都没有投进的概率; (2) 用 \( \xi \) 表示乙投篮 3 次的进球数，求随机变量 \( \xi \) 的概率分布及数学期望 \( E\xi \) .
\end{problem}
...
\begin{problem}
已知函数 \( f(x) = x^3 - x^2 + \frac{x}{2} + \frac{1}{4} \)，且存在 \( x_0 \in \left(0, \frac{1}{2}\right) \)，使 \( f(x_0) = x_0 \). (1) 证明： \( f(x) \) 是 R 上的单调增函数； (2) 设 \(x_{1} = 0, x_{n + 1} = f(x_{n}), y_{1} = \frac{1}{2}, y_{n + 1} = f(y_{n})\)，其中 \(n = 1, 2, \dots\) 证明：\(x_{n} < x_{n + 1} < x_0 < y_{n + 1} < y_{n}\); (3) 证明： \( \frac{y_{n+1}-x_{n+1}}{y_{n}-x_{n}}<\frac{1}{2}. \)
\end{problem}
