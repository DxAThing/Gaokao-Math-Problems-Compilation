...
\bitmapinlinefigure[0.42\linewidth][]{img/2006/anhui_liberal/q9_fig1.png}
...
\bitmapinlinefigure[0.46\linewidth][]{img/2006/anhui_liberal/q19_fig1.png}
\end{problem}

\begin{solution}
\begin{enumerate}
\item \(PA \perp BF\).
\item 二面角的大小为 \(\arccos\frac{\sqrt{105}}{35}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(b=3\)，\(c=0\).
\item \(g(x)\) 在 \((-\infty,-\sqrt{2})\) 和 \((\sqrt{2},+\infty)\) 上单调递增，在 \((-\sqrt{2},\sqrt{2})\) 上单调递减；在 \(x=-\sqrt{2}\) 处取得极大值 \(4\sqrt{2}\)，在 \(x=\sqrt{2}\) 处取得极小值 \(-4\sqrt{2}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(a_n=n\).
\item \(T_n=\frac{n(n+1)}{2}\)（\(p=1\)），\(T_n=\frac{p^2(1-p^{2n})}{(1-p^2)^2}-\frac{n p^{2n+2}}{1-p^2}\)（\(p\ne1\)）.
\end{enumerate}
\end{solution}
...
\bitmapinlinefigure[8.1cm][]{img/2006/anhui_liberal/q22_fig1.png}
\end{problem}

\begin{solution}
\begin{enumerate}
\item \(e^2-\lambda e-2=0\).
\item 双曲线方程为 \(x^2-\frac{y^2}{3}=1\).
\end{enumerate}
\end{solution}
