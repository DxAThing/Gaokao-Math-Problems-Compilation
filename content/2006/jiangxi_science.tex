...
\begin{solution}
\begin{enumerate}
\item \(a=-\frac{1}{2}\)，\(b=-2\)；函数在 \(\left(-\infty,-\frac{2}{3}\right)\) 和 \((1,+\infty)\) 上单调递增，在 \(\left(-\frac{2}{3},1\right)\) 上单调递减.
\item \(c<-1\) 或 \(c>2\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(P(\xi=0)=\frac{729}{1000}\)，\(P(\xi=10)=\frac{243}{1000}\)，\(P(\xi=20)=\frac{18}{1000}\)，\(P(\xi=50)=\frac{9}{1000}\)，\(P(\xi=60)=\frac{1}{1000}\).
\item \(E\xi=3.3\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(S_{1}=\dfrac{\sin\alpha}{12\sin\left(\alpha+\frac{\pi}{6}\right)}\)，\(S_{2}=\dfrac{\sin\alpha}{12\sin\left(\alpha-\frac{\pi}{6}\right)}\).
\item 最大值为 \(240\)，此时 \(\alpha=\frac{\pi}{3}\) 或 \(\frac{2\pi}{3}\)；最小值为 \(216\)，此时 \(\alpha=\frac{\pi}{2}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(AD\perp BC\).
\item 二面角 \(B-AC-D\) 的大小为 \(\arccos\frac{\sqrt{6}}{3}\).
\item 存在这样的点 \(E\)，且 \(CE=1\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 点 \(P\) 的轨迹方程为 \(b^{2}x^{2}+a^{2}y^{2}-b^{2}c^{2}=0\).
\item \(\theta=\frac{\pi}{4}\)；当直线 \(m\perp x\) 轴时，三角形 \(ABD\) 的面积最大.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_{n}=\dfrac{n3^{n}}{3^{n}-1}\).
\item 对一切正整数 \(n\)，均有 \(a_{1}a_{2}\cdots a_{n}<2\cdot n!\).
\end{enumerate}
\end{solution}
