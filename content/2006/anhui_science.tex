...
\begin{solution}
\begin{enumerate}
\item 短答案：\(\tan\alpha=-\frac{1}{3}\).
\item 短答案：\(-\frac{5\sqrt{2}}{6}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item 短答案：\(PA \perp BF\).
\item 短答案：设二面角为 \(\theta\)，则 \(\theta=\pi-\arctan\frac{8\sqrt{21}}{9}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item 短答案：\(f(0)=0\).
\item 短答案：\(f(x)=\begin{cases}
kx, & x\geqslant 0,\\
hx, & x<0,
\end{cases}\)，其中 \(k\) 和 \(h\) 均为常数.
\item 短答案：当 \(0<x<1\) 时，\(g(x)\) 单调递减；当 \(x\geqslant 1\) 时，\(g(x)\) 单调递增，极小值为 \(k+\frac{1}{k}\)，在 \(x=1\) 时取得.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(\frac{n+1}{n}S_{n}-2S_{n-1}=n-1\)，\(S_{n}=\frac{n^{2}}{n+1}\).
\item 短答案：\(b_{n}=np^{n}\)，且
\[
T_{n}=\begin{cases}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(e^{2}-\lambda e-2=0\).
\item 短答案：当 \(\lambda=1\) 时，双曲线方程为
\(\displaystyle\frac{x^{2}}{9}-\frac{y^{2}}{27/4}=1\).
\end{enumerate}
\end{solution}
