...
\begin{problem}
设向量 \(a\) 与 \(b\) 的夹角为 \(\theta\)，且 \(a = (3, 3)\)，\(2b - a = (-1, 1)\)，则 \(\cos \theta = \fillinblank{}.\)
\end{problem}
...
\begin{center}
\bitmapinclude[max width=0.32\linewidth,max totalheight=4.9cm]{img/2006/tianjin_liberal/q13_fig1.png}
\end{center}
\end{problem}
...
\begin{center}
\bitmapinclude[max width=0.44\linewidth,max totalheight=5.3cm]{img/2006/tianjin_liberal/q19_fig1.png}
\end{center}
\end{problem}
...
\begin{center}
\bitmapinclude[max width=0.42\linewidth,max totalheight=5.6cm]{img/2006/tianjin_liberal/q22_fig1.png}
\end{center}
\end{problem}
