...
\begin{solution}
\(\displaystyle -\frac{13\sqrt{2}}{14}\).
\end{solution}
...
\begin{enumerate}
\item \(45^\circ\).
\item \(\displaystyle \frac{\sqrt{6}}{2}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_n=2048\left(\dfrac{1}{2}\right)^{n-1}\).
\item 从第 \(46\) 项起.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\displaystyle \frac{x^2}{4}+y^2=1\).
\item \(\displaystyle \left(x-\frac{1}{2}\right)^2+4\left(y-\frac{1}{4}\right)^2=1\).
\item \(\sqrt{2}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(b=4\).
\item 最小值为 \(2\sqrt{c}\)，最大值为
\(\begin{cases}
2+\dfrac{c}{2},&1\leqslant c\leqslant 2,\\
1+c,&2\leqslant c\leqslant 4.
\end{cases}\)
\item 令 \(r=\sqrt[2n]{c}\). 在 \(x>0\) 时，函数在 \((0,r]\) 上是减函数，在 \([r,+\infty)\) 上是增函数；当 \(n\) 为奇数时，函数在 \((-\infty,-r]\) 上是增函数，在 \([-r,0)\) 上是减函数；当 \(n\) 为偶数时，函数在 \((-\infty,-r]\) 上是减函数，在 \([-r,0)\) 上是增函数.
\end{enumerate}
\end{solution}
