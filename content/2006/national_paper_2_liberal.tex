...
\bitmapfigure[max width=0.28\linewidth,max totalheight=4.8cm]{img/2006/national_paper_2_liberal/q7_fig1.png}
...
为了分析居民的收入与年龄，学历，职业等方面的关系，要从这\(10000\text{ 人}\)中再用分层抽样方法抽出\(100\text{ 人}\)作进一步调查，则在 \([2500, 3000)\)（\(\text{元}\)）月收入段应抽出\fillinblank{} 人.

\texfigure[max width=0.78\linewidth,max totalheight=6.0cm]{img_repaint/2006/national_paper_2_liberal/q16_fig1.tex}
\end{problem}
...
\bitmapfigure[max width=0.30\linewidth,max totalheight=4.8cm]{img/2006/national_paper_2_liberal/q20_fig1.png}
\end{problem}
