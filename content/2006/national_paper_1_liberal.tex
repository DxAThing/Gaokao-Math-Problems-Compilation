...
\begin{problem}
设 \(z = 2y - x\)，式中变量 \(x\)，\(y\) 满足下列条件：\(\begin{cases} 2x - y \geqslant -1, \\ 3x + 2y \leqslant 23, \\ y \geqslant 1, \end{cases}\)，则 \(z\) 的最大值为\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=0.46\linewidth,max totalheight=7cm]{img/2006/national_paper_1_liberal/q20_fig1.png}
\end{problem}
