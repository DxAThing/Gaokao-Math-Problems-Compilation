...
\begin{problem}
设向量 \(\bs{a} = (1, -3)\)，\(\bs{b} = (-2, 4)\)，若表示向量 \(4\bs{a}\)，\(3\bs{b} - 2\bs{a}\)，\(\bs{c}\) 的有向线段首尾相接能构成三边线，则向量 \(\bs{c}\) 为（\quad）
...
\begin{problem}
已知函数 \( f(x) = A \sin^2 (\omega x + \varphi) \)（\(A > 0\)，\(\omega > 0\)，\(0 < \varphi < \frac{\pi}{2}\)），且 \( y = f(x) \) 的最大值为2，其图象相邻两对称轴间的距离为2，并过点 \((1,2)\).
...
\bitmapfigure[max width=0.42\linewidth]{img/2006/shandong_liberal/q20_fig1.png}
\end{problem}
