...
\begin{problem}
计算： \( \lim\limits_{n\to\infty}\left(\frac{n}{n+2}\right)^n = \)\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=4.0cm,max totalheight=4.8cm]{img/2000/shanghai_science/q8_fig1.png}
\end{problem}
...
\bitmapfigure[max width=3.7cm,max totalheight=4.8cm]{img/2000/shanghai_science/q18_fig1.png}
\end{problem}
...
\bitmapfigure[max width=4.6cm,max totalheight=4.8cm]{img/2000/shanghai_science/q20_fig1.png}
\end{problem}
