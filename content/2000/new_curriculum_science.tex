...
\begin{problem}
设 \(\bs{a}\)，\(\bs{b}\)，\(\bs{c}\) 是任意的非零平面向量，且相互不共线，则 \circled{1} \((\bs{a} \cdot \bs{b})\bs{c} - (\bs{c} \cdot \bs{a})\bs{b} = 0\)；\circled{2} \(|\bs{a}| - |\bs{b}| < |\bs{a} - \bs{b}|\)；\circled{3} \((\bs{b} \cdot \bs{c})\bs{a} - (\bs{c} \cdot \bs{a})\bs{b}\) 不与 \(\bs{c}\) 垂直；\circled{4} \((3\bs{a} + 2\bs{b}) \cdot (3\bs{a} - 2\bs{b}) = 9|\bs{a}|^{2} - 4|\bs{b}|^{2}\) 中，是真命题的有（\quad）
