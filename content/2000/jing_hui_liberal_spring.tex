...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.8cm]{img/2000/jing_hui_liberal_spring/q14_fig1.png}
...
\begin{circlelist}
\item 如果两直线 \(a\)，\(b\) 分别与直线 \(l\) 平行，
\item 如果直线 \(a\) 与平面 \(\beta\) 内的一条直线 \(b\) 平行，
\item 如果直线 \(a\) 与平面 \(\beta\) 内的两条直线 \(b\)，\(c\) 都有垂直，
\item 如果平面 \(\beta\) 内的一条直线 \(a\) 垂直平面 \(\gamma\)，
\end{circlelist}
那么 \(a \parallel b\)；
那么 \(a \parallel \beta\)；
那么 \(a \perp \beta\)；
...
\bitmapfigure[max width=0.95\linewidth,max totalheight=4.8cm]{img/2000/jing_hui_liberal_spring/q21_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.36\linewidth,max totalheight=4.8cm]{img/2000/jing_hui_liberal_spring/q23_fig1.png}
