...
\begin{problem}
圆锥曲线 \(\frac{(x-1)^2}{16}-\frac{y^2}{9}=1\\fillinblank{}lank{}\fillinblank{}.
\end{problem}
...
\begin{problem}
图中阴影部分的点满足不等式组 \(\left\{\begin{aligned}x+y&\leqslant 5,\\ 2x+y&\leqslant 6,\\ x&\geqslant 0,\ y\geqslant 0,\end{aligned}\right.\) 在这�\fil\fillinblank{}��大值的点的坐标是\fillinblank{}.
