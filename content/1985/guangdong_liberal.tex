...
（3）【法一】因为 \(ED\perp AB_{1}\)，\(CE\perp\) 侧面 \(ABB_{1}A_{1}\)，连结 \(CD\)，根据三垂线定理有 \(CD\perp AB_{1}\)，故 \(\angle CDE\) 是截面 \(CAB_{1}\) 和侧面 \(ABB_{1}A_{1}\) 所成的较小的二面角的平面角. \(CE\) 是 \(\mathrm{Rt}\triangle ABC\) 的斜边上的中线，故 \(CE=\frac{1}{2}AB=\sqrt{2}\). 又 \(ED=\frac{2\sqrt{3}}{3}\)，于是在 \(\mathrm{Rt}\triangle CED\) 中，
\[
...
【法二】因为 \(CE\perp\) 侧面 \(ABB_{1}A_{1}\)，所以 \(\triangle CAB_{1}\) 在侧面上的射影是 \(\triangle EAB_{1}\). 设 \(\triangle CAB_{1}\) 的面积为 \(S_{1}\)，\(\triangle EAB_{1}\) 的面积为 \(S_{2}\)，则有 \(S_{2}=S_{1}\cos\alpha\). 在 \(\mathrm{Rt}\triangle CBB_{1}\) 中，\(B_{1}C=\sqrt{BB_{1}^{2}+BC^{2}}=\sqrt{4^{2}+2^{2}}=2\sqrt{5}\). 又 \(AB_{1}=2\sqrt{6}\)，\(AC=2\)，由海伦公式得 \(S_{1}=2\sqrt{5}\). 另一方面，
\[
