...
\bitmapfigure[max width=4.2cm,max totalheight=4.8cm]{img/1985/guangdong_science/q10_fig1.png}
...
\bitmapfigure[max width=6cm,max totalheight=5.8cm]{img/1985/guangdong_science/q10_solution_fig1.png}
\end{answer}
...
\choicesfive
    {\choicebitmap[max width=3.2cm,max totalheight=4cm]{img/1985/guangdong_science/q1_optA.png}}
    {\choicebitmap[max width=3.2cm,max totalheight=4cm]{img/1985/guangdong_science/q1_optB.png}}
    {\choicebitmap[max width=3.2cm,max totalheight=4cm]{img/1985/guangdong_science/q1_optC.png}}
    {\choicebitmap[max width=3.2cm,max totalheight=4cm]{img/1985/guangdong_science/q1_optD.png}}
    {\choicebitmap[max width=3.2cm,max totalheight=4cm]{img/1985/guangdong_science/q1_optE.png}}
...
在直角坐标系中，有椭圆 \(I\) 和抛物线 \(II\)，它们的参数方程分别是 \(I\)：\(\begin{cases} x = m + 2\cos\phi,\\ y = \sqrt{3}\sin\phi \end{cases}\)（\(m\) 是常数，\(\phi\) 是参数）；\(II\)：\(\begin{cases} x = \frac{3}{2}+t^{2},\\ y = \sqrt{6}t \end{cases}\)（\(t\) 是参数）.
