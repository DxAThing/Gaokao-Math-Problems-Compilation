...
\bitmapfigure[max width=0.82\textwidth,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q3_fig1.png}
...
\bitmapfigure[max width=4.2cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q7_solution_fig1.png}
...
\bitmapfigure[max width=4.0cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q10_solution_fig1.png}
设直线 \(AB\) 的斜率为 \(k\)，则
...
\bitmapfigure[max width=6.0cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q11_fig1.png}
...
\bitmapfigure[max width=4.2cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q11_solution_fig1.png}
...
\begin{solution}
\bitmapfigure[max width=6.0cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q14_solution_fig1.png}
...
\begin{solution}
\bitmapfigure[max width=5.4cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q16_solution_fig1.png}
...
\texfigure[max width=5.0cm,max totalheight=4.8cm]{img_repaint/2022/new_gaokao_paper_2/q19_fig1.tex}
...
\bitmapfigure[max width=4.6cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q20_fig1.png}

\end{problem}

\begin{solution}
（1）连接 \(BO\) 并延长交 \(AC\) 于点 \(D\)，连接 \(OA\)，\(PD\).
\bitmapfigure[max width=4.8cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q20_solution_fig1.png}
...
\bitmapfigure[max width=7.8cm,max totalheight=4.8cm]{img/2022/new_gaokao_paper_2/q20_solution_fig2.png}
由
\(PO=3\)，\(PA=5\)
得
\(OA=\sqrt{PA^2-PO^2}=4\).
