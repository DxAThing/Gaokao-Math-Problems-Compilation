...
\begin{problem}
已知双曲线 \(\dfrac{x^2}{a^2}-\dfrac{y^2}{b^2}=1\)（\(a>0,b>0\)）的左，右焦点分别为 \(F_1\)，\(F_2\)，抛物线 \(y^2=4\sqrt{5}x\) 的准线经过 \(F_1\)，且与双曲线的一条渐近线交于点 \(A\). 若 \(\angle F_1F_2A=\dfrac{\pi}{4}\)，则双曲线的方程为（\quad）
...
\begin{problem}
“十字歇山”是中国古代建筑屋顶的经典样式之一，图 1 中的故宫角楼的顶部即为十字歇山屋顶. 其上部和屋顶部分是由两个相同的直三棱柱交叠而成的几何体（图 2）. 这两个直三棱柱有一个公共侧面 \(ABCD\)，在底面 \(BCE\) 中，若 \(BE=CE=3\)，\(\angle BEC=120^{\circ}\)，则该几何体的体积为（\quad）
...
\begin{problem}
如图，在直三棱柱 \(ABC-A_1B_1C_1\) 中，\(AC\perp AB\)，点 \(D\)，\(E\)，\(F\) 分别为 \(A_1B_1\)，\(AC\)，\(AA_1\) 的中点，\(AB=AC=AA_1=2\).
