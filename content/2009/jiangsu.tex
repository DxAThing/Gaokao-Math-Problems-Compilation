...
\bitmapfigure[max width=0.36\linewidth,max totalheight=3.2cm]{img/2009/jiangsu/q4_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=6.2cm]{img/2009/jiangsu/q7_flow.png}
\end{problem}
...
\bitmapfigure[max width=0.52\linewidth,max totalheight=3.6cm]{img/2009/jiangsu/q13_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=5.8cm]{img/2009/jiangsu/q16_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=5.6cm]{img/2009/jiangsu/q18_fig1.png}
...
\noindent\textbf{A.} 如图，在四边形 \(ABCD\) 中，\(\triangle ABC\cong\triangle BAD\). 求证：\(AB\parallel CD\).

\bitmapfigure[max width=0.40\linewidth,max totalheight=3.0cm]{img/2009/jiangsu/q21_a_fig1.png}

\medskip
\noindent\textbf{B.} 求矩阵 \(A=\begin{bmatrix}3&2\\2&1\end{bmatrix}\) 的逆矩阵.

\medskip
\noindent\textbf{C.} 已知曲线 \(C\) 的参数方程为 \(x=\sqrt t-\frac{1}{\sqrt t}\)，\(y=3\left(t+\frac1t\right)\)（\(t\) 为参数，\(t>0\)），求曲线 \(C\) 的普通方程.

\medskip
\noindent\textbf{D.} 设 \(a\ge b>0\)，求证：\(3a^3+2b^3\ge3a^2b+2ab^2\).
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=5.2cm]{img/2009/jiangsu/q22_fig1.png}
