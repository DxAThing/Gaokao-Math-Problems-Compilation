...
\bitmapinlinefigure[0.34\linewidth][max width=0.34\linewidth]{img/2009/tianjin_science/q5_fig1.png}
...
\begin{enumerate}
\item \(AB=2\sqrt{5}\).
\item \(\sin\left(2A-\frac{\pi}{4}\right)=\frac{\sqrt{2}}{10}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(P(X=k)=\dfrac{\mathrm C_3^k\mathrm C_7^{3-k}}{\mathrm C_{10}^3}\)（\(k=0,1,2,3\)），即 \(P(X=0)=\frac{7}{24}\)，\(P(X=1)=\frac{21}{40}\)，\(P(X=2)=\frac{7}{40}\)，\(P(X=3)=\frac{1}{120}\)，\(E(X)=\frac{9}{10}\).
\item 所求概率为 \(\frac{31}{120}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 异面直线 \(BF\) 与 \(DE\) 所成的角为 \(60^\circ\).
\item 平面 \(AMD \perp\) 平面 \(CDE\).
\item 二面角 \(A-CD-E\) 的余弦值为 \(\frac{\sqrt{3}}{3}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 当 \(a=0\) 时，切线的斜率为 \(3\e\).
\item 当 \(a>\frac{2}{3}\) 时，\(f(x)\) 在 \(\left(-\infty,-2a\right)\)，\(\left(a-2,+\infty\right)\) 上单调递增，在 \(\left(-2a,a-2\right)\) 上单调递减，在 \(x=-2a\) 处取得极大值 \(3a\e^{-2a}\)，在 \(x=a-2\) 处取得极小值 \((4-3a)\e^{a-2}\)；当 \(a<\frac{2}{3}\) 时，\(f(x)\) 在 \(\left(-\infty,a-2\right)\)，\(\left(-2a,+\infty\right)\) 上单调递增，在 \(\left(a-2,-2a\right)\) 上单调递减，在 \(x=a-2\) 处取得极大值 \((4-3a)\e^{a-2}\)，在 \(x=-2a\) 处取得极小值 \(3a\e^{-2a}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 椭圆的离心率为 \(\frac{\sqrt{3}}{3}\).
\item 直线 \(AB\) 的斜率为 \(\pm\frac{\sqrt{2}}{3}\).
\item 当斜率为 \(\frac{\sqrt{2}}{3}\) 时，\(\frac{n}{m}=-\frac{2\sqrt{2}}{5}\)；当斜率为 \(-\frac{\sqrt{2}}{3}\) 时，\(\frac{n}{m}=\frac{2\sqrt{2}}{5}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(S_{3}=55\).
\item \((1-q)S_{2n}-(1+q)T_{2n}=\dfrac{2dq\left(1-q^{2n}\right)}{1-q^{2}}\).
\item \(c_{1}\neq c_{2}\).
\end{enumerate}
\end{solution}
