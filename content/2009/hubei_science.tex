...
\begin{problem}
已知向量 \(a = (\cos \alpha, \sin \alpha)\)，\(b = (\cos \beta, \sin \beta)\)，\(c = (-1, 0)\).

\begin{enumerate}
\item 求向量 \(b + c\) 的长度的最大值;
\item 设 \(\alpha = \frac{\pi}{4}\)，且 \(a \perp (b + c)\)，求 \(\cos \beta\) 的值.
\end{enumerate}
\end{problem}
...
\begin{enumerate}
\item 若函数 \(f(x)\) 在 \(x = 1\) 处有极值 \(-\frac{4}{3}\)，试确定 \(b, c\) 的值；
