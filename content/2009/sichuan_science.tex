...
\bitmapfigure[max width=0.44\linewidth,max totalheight=4.6cm]{img/2009/sichuan_science/q5_fig1.png}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=3.4cm]{img/2009/sichuan_science/q8_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2009/sichuan_science/q15_fig1.png}
\end{problem}
...
\item 对 \(a \in V\)，设 \(f(a) = 2a\)，则 \(f\) 是平面 \(M\) 上的线性变换；
\item 若 \(e\) 是平面 \(M\) 上的单位向量，对 \(a \in V\)，设 \(f(a) = a - e\)，则 \(f\) 是平面 \(M\) 上的线性变换；
\item 设 \(f\) 是平面 \(M\) 上的线性变换，\(a, b \in V\)，若 \(a, b\) 共线，则 \(f(a), f(b)\) 也共线.
\end{circlelist}
...
\bitmapfigure[max width=0.40\linewidth,max totalheight=4.6cm]{img/2009/sichuan_science/q19_fig1.png}
...
\item 若 \(n \in \mathbf{N}^*\)，求 \(\lim_{n \to +\infty} \frac{a^{f(n)}}{a^n + a}\)；
