...
\bitmapfigure[max width=0.46\linewidth,max totalheight=9.5cm,width=0.46\linewidth]{img/2009/liaoning_liberal/q10_fig1.png}
...
\begin{problem}
在平面直角坐标系 \(xOy\) 中，四边形 \(ABCD\) 的边 \(AB // DC\)，\(AD // BC\). 已知点 \(A(-2,0)\)，\(B(6,8)\)，\(C(8,6)\)，则 \(D\) 点的坐标为\fillinblank{}.
\end{problem}
