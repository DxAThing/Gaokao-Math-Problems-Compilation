...
\choices
    ...
    {\( y = \frac{1 - 2x}{1 + 2x} \) \(\left(x \in \R, x \neq -\frac{1}{2}\right)\)}
    {\( y = \frac{1 + x}{2(1 - x)} \) \(\left(x \in \R, x \neq 1\right)\)}
    {\( y = \frac{1 - x}{2(1 + x)} \) \(\left(x \in \R, x \neq -1\right)\)}
\end{problem}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.8cm]{img/2009/hubei_liberal/q6_fig1.png}
...
\bitmapfigure[max width=0.28\linewidth,max totalheight=2.2cm]{img/2009/hubei_liberal/q10_fig1.png}

\bitmapfigure[max width=0.30\linewidth,max totalheight=2.2cm]{img/2009/hubei_liberal/q10_fig2.png}

他们研究过图1中的1,3,6,10,\(\cdots\)，由于这些数能够表示成三角形，将其称为三角形数；类似地，称图2中的1,4,9,16\(\cdots\)这样的数成为正方形数. 下列数中既是三角形数又是正方形数的是（\quad）
...
\texfigure[max width=0.36\linewidth,max totalheight=4.8cm]{img_repaint/2009/hubei_liberal/q15_fig1.tex}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2009/hubei_liberal/q17_fig1.png}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.8cm]{img/2009/hubei_liberal/q18_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2009/hubei_liberal/q20_fig1.png}
