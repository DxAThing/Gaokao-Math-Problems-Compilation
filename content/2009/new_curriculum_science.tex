...
\bitmapfigure[max width=0.82\linewidth,max totalheight=4.8cm]{img/2009/new_curriculum_science/q3_fig1.png}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.6cm]{img/2009/new_curriculum_science/q8_fig1.png}
...
\bitmapfigure[max width=0.44\linewidth,max totalheight=5.4cm]{img/2009/new_curriculum_science/q10_fig1.png}
...
\bitmapfigure[max width=0.48\linewidth,max totalheight=3.6cm]{img/2009/new_curriculum_science/q11_fig1.png}
...
\bitmapfigure[max width=0.40\linewidth,max totalheight=3.2cm]{img/2009/new_curriculum_science/q14_fig1.png}
\end{problem}

\begin{problem}
7名志愿者中安排6人在周六，周日两天参加社区公益活动. 若每天安排3人，则不同的安排方案共有\fillinblank{} 种.（用数字作答）
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=3.8cm]{img/2009/new_curriculum_science/q17_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.90\linewidth,max totalheight=4.8cm]{img/2009/new_curriculum_science/q18_fig1.png}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.6cm]{img/2009/new_curriculum_science/q19_fig1.png}
...
\bitmapfigure[max width=0.34\linewidth,max totalheight=4.6cm]{img/2009/new_curriculum_science/q22_fig1.png}

\end{problem}

\begin{problem}
已知曲线 \(C_{1}: \left\{ \begin{array}{l} x = -4 + \cos t, \\ y = 3 + \sin t, \end{array} \right.\)（\(t\) 为参数），\(C_{2}: \left\{ \begin{array}{l} x = 8\cos \theta, \\ y = 3\sin \theta. \end{array} \right.\)（\(\theta\) 为参数）.

\begin{enumerate}
\item 化 \(C_1, C_2\) 的方程为普通方程，并说明它们分别表示什么曲线；
\item 若 \(C_1\) 上的点 \(P\) 对应的参数为 \(t = \frac{\pi}{2}\)，\(Q\) 为 \(C_2\) 上的动点，求 \(PQ\) 中点 \(M\) 到直线 \(C_{3}: \left\{ \begin{array}{l} x = 3 + 2t, \\ y = -2 + t, \end{array} \right.\)（\(t\) 为参数）距离的最小值.
\end{enumerate}
\end{problem}
...
\bitmapfigure[max width=0.44\linewidth,max totalheight=2.6cm]{img/2009/new_curriculum_science/q24_fig1.png}
