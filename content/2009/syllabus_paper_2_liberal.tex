...
\begin{solution}
\begin{enumerate}
\item \(f(x)\) 在 \((-\infty, 2)\) 和 \((2a, +\infty)\) 上单调递增，在 \((2, 2a)\) 上单调递减.
\item \(1 < a < 6\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a = \sqrt{3}\)，\(b = \sqrt{2}\).
\item 存在. 当 \(P\left(\frac{3}{2}, -\frac{\sqrt{2}}{2}\right)\) 时，\(l: x = \frac{\sqrt{2}}{2}y + 1\)；当 \(P\left(\frac{3}{2}, \frac{\sqrt{2}}{2}\right)\) 时，\(l: x = -\frac{\sqrt{2}}{2}y + 1\).
\end{enumerate}
\end{solution}
