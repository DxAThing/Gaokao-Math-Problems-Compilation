...
\begin{problem}
已知函数：\circled{1} \(y=\arctan x\)，\circled{2} \(y=\frac{\pi}{2}-\operatorname{arccot} x\). 那么（\quad）
...
\begin{problem}
已知椭圆的焦点为 \(F_1(0,-1)\) 和 \(F_2(0,1)\)，直线 \(y=4\) 是椭圆的一条准线. （1）求椭圆的方程；（2）又设点 \(P\) 在这个椭圆上，且 \(\left| PF_1 \right|-\left| PF_2 \right|=1\)，求 \(\tan\angle F_1PF_2\) 的值.
