...
\item \(\log_3\left( 4+3x-x^2 \right)-\log_3\left( 2x-1 \right)>\log_3 2\)，
...
\item 取平面 \(BDE\) 的一个法向量 \(\bs{n}_1=\overrightarrow{DB}\times\overrightarrow{DE}=\frac{a^2}{6}(-\sqrt{2},-2,\sqrt{2})\)，平面 \(BDO\) 的一个法向量为 \(\bs{n}_2=(0,0,1)\). 设二面角为 \(\theta\)，则 \(\cos\theta=\frac{|\bs{n}_1\cdot\bs{n}_2|}{|\bs{n}_1||\bs{n}_2|}=\frac12\).
...
\begin{solution}
\begin{enumerate}
\item 设椭圆方程为 \(\frac{x^2}{a^2}+\frac{y^2}{b^2}=1\)，焦距参数为 \(c\). 由焦点坐标知 \(c=1\)，又由准线 \(x=4\) 知 \(\frac{a^2}{c}=4\)，故 \(a=2\)，\(b^2=a^2-c^2=3\). 所以椭圆方程为
\(\frac{x^2}{4}+\frac{y^2}{3}=1\).

\item 设 \(d_1=|PF_1|\)，\(d_2=|PF_2|\). 由椭圆定义及题设，得 \(d_1+d_2=2a=4\)，\(d_1-d_2=1\)，
