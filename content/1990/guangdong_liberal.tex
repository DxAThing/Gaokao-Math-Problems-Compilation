...
取平面 \(BDE\) 的一个法向量 \(\bs{n}_1=\overrightarrow{DB}\times\overrightarrow{DE}=\frac{a^2}{6}(-\sqrt{2},-2,\sqrt{2})\)，平面 \(BDO\) 的一个法向量为 \(\bs{n}_2=(0,0,1)\). 设二面角为 \(\theta\)，则 \(\cos\theta=\frac{|\bs{n}_1\cdot\bs{n}_2|}{|\bs{n}_1||\bs{n}_2|}=\frac12\).
