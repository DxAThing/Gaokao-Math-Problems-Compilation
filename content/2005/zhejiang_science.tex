...
\choicebitmap[max width=0.42\linewidth,max totalheight=3.3cm]{img/2005/zhejiang_science/q7_optA.png}\hfill
\choicebitmap[max width=0.42\linewidth,max totalheight=3.3cm]{img/2005/zhejiang_science/q7_optB.png}

\choicebitmap[max width=0.42\linewidth,max totalheight=3.3cm]{img/2005/zhejiang_science/q7_optC.png}\hfill
\choicebitmap[max width=0.42\linewidth,max totalheight=3.3cm]{img/2005/zhejiang_science/q7_optD.png}
\end{problem}
...
\begin{enumerate}
\item 从 \(A\) 中有放回地摸球，每次摸出一个，有 3 次摸到红球即停止.  \circled{1}  求恰好摸 5 次停止的概率； \circled{2}  记 5 次之内（含 5 次）摸到红球的次数为 \(\xi\)，求随机变量 \(\xi\) 的分布列及数学期望 \(E\xi\)；
