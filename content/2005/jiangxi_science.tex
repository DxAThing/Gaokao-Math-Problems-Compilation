...
\begin{center}
\begin{tabular}{@{}cc@{}}
\choicebitmap[max width=0.38\linewidth,max totalheight=4.6cm]{img/2005/jiangxi_science/q7_optA.png} &
\choicebitmap[max width=0.38\linewidth,max totalheight=4.6cm]{img/2005/jiangxi_science/q7_optB.png} \\
\choicebitmap[max width=0.38\linewidth,max totalheight=4.6cm]{img/2005/jiangxi_science/q7_optC.png} &
\choicebitmap[max width=0.38\linewidth,max totalheight=4.6cm]{img/2005/jiangxi_science/q7_optD.png}
\end{tabular}
\end{center}
\end{problem}

\begin{problem}
若 \(\lim\limits_{x\to 1}\frac{f(x-1)}{x-1}=1\)，则 \(\lim\limits_{x\to 1}\frac{x-1}{f(2-2x)}=\)（\quad）
