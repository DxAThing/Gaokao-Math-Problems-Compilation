...
\begin{solution}
\begin{enumerate}
\item \(\varphi=-\dfrac{3\pi}{4}\).
\item \(\left[k\pi+\dfrac{\pi}{8},\,k\pi+\dfrac{5\pi}{8}\right]\)，\(k\in\Z\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 面 \(PAD\perp\) 面 \(PCD\).
\item \(AC\) 与 \(PB\) 所成的角为 \(\arccos\dfrac{\sqrt{10}}{5}\).
\item 面 \(AMC\) 与面 \(BMC\) 所成二面角的大小为 \(\arccos\left(-\dfrac{2}{3}\right)\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(f(x)=-\dfrac{1}{5}x^{2}-\dfrac{6}{5}x-\dfrac{3}{5}\).
\item \(a\in(-\infty,-2-\sqrt{3})\cup(-2+\sqrt{3},0)\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(\dfrac{7}{8}\).
\item \(\mathrm C_3^1\cdot\dfrac{7}{8}\cdot\left(\dfrac{1}{8}\right)^{2}=0.041\).
\item \(0.330\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_{n}=\dfrac{1}{2^{n}}\).
\item \(T_{n}=\dfrac{n(n+1)}{2}+\dfrac{1}{2^{n+1}}+\dfrac{n}{2^{n}}-2\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 椭圆的离心率为 \(\dfrac{\sqrt{6}}{3}\).
\item \(\lambda^{2}+\mu^{2}=1\).
\end{enumerate}
\end{solution}
