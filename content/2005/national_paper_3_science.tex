...
\begin{problem}
设三棱柱 \(ABC - A_{1}B_{1}C_{1}\) 的体积为 \(V\)，\(P\text{，}Q\) 分别是侧棱 \(AA_{1}\text{，}CC_{1}\) 上的点，且 \(PA = QC_{1}\)，则四棱锥 \(B - APQC\) 的体积为（\quad）
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=6.0cm]{img/2005/sichuan_science/q18_fig1.png}
\end{problem}
