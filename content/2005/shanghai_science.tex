...
\begin{problem}
有两个相同的直三棱柱，高为 \(\frac{2}{a}\)，底面三角形的三边长分别为 \(3a, 4a, 5a (a > 0)\). 用它们拼成一个三棱柱或四棱柱，在所有可能的情形中，全面积最小的是一个四棱柱，则 \(a\) 的取值范围是 \fillinblank{} \fillinblank{}.
...
\bitmapfigure[max width=0.30\linewidth,max totalheight=4.0cm]{img/2005/shanghai_science/q12_fig1.png}
\end{problem}
