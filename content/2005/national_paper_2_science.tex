...
\begin{problem}
设 \(a, b, c, d \in \R\)，若 \(\frac{a + bi}{c + di}\) 为实数，则（\quad）
...
\begin{problem}
已知双曲线 \(\frac{x^2}{4} - \frac{y^2}{2} = 1\) 的焦点为 \(F_1, F_2\)，点 \(M\) 在双曲线上且 \(MF_1 \perp x\) 轴，则 \(F_1\) 到直线 \(F_2M\) 的距离为（\quad）
...
\begin{problem}
如果 \(a_{1}, a_{2}, \cdots, a_{n}\) 为各项都大于零的等差数列，公差 \(d \neq 0\)，则（\quad）
...
\begin{center}
\bitmapinclude[max width=0.45\linewidth,max totalheight=6.0cm]{img/2005/jilin_science/q20_fig1.png}
\end{center}
\end{problem}
