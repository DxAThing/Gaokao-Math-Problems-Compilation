...
\begin{solution}
\begin{enumerate}
\item 由对数定义知，必须 \(x-1>0\). 当 \(a=2\) 时，\(\lg(2x)=2\lg(x-1)=\lg(x-1)^2\)，所以 \(2x=(x-1)^2\)，即 \(x^2-4x+1=0\). 解得 \(x_1=2+\sqrt{3}\)，\(x_2=2-\sqrt{3}\). 经检验，只有 \(x=2+\sqrt{3}\) 满足定义域条件.
...
\begin{solution}
\begin{enumerate}
\item 在平面 \(SAC\) 内作 \(SD\perp AC\)，垂足为 \(D\). 因为平面 \(SAC\perp ABC\)，且平面 \(SAC\cap ABC=AC\)，所以 \(SD\perp\) 平面 \(ABC\). 连 \(BD\)，则 \(BD\) 为 \(SB\) 在平面 \(ABC\) 上的射影，故 \(\angle SBD\) 为 \(SB\) 与平面 \(ABC\) 所成的角. 由 \(SA=SC=b\)，\(AB=AC=a\)，\(\angle CAB=90^{\circ}\)，得 \(SD=\sqrt{b^2-\frac{a^2}{4}}\). 又 \(BD=\sqrt{AD^2+AB^2}=\sqrt{\frac{a^2}{4}+a^2}=\frac{\sqrt{5}}{2}a\). 因为 \(SD\perp BD\)，所以 \(\tan\angle SBD=\frac{SD}{BD}=\frac{\sqrt{5-4b^2-a^2}}{5a}=\frac{\sqrt{20b^2-5a^2}}{5a}\).

\item 在平面 \(SBC\) 内过 \(S\) 作 \(SE\perp BC\)，垂足为 \(E\)，连 \(DE\). 因为 \(SD\perp\) 平面 \(ABC\)，所以 \(SD\perp BC\). 又 \(SD\cap SE=S\)，所以 \(BC\perp\) 平面 \(SDE\). 故直角三角形 \(SDE\) 为所求截面. 因为 \(DE\perp BC\)，\(D\) 为 \(AC\) 的中点，且 \(\angle CAB=90^{\circ}\)，所以 \(DE=CE=\frac{CD}{\sqrt{2}}=\frac{\sqrt{2}}{4}a\). 因此截面面积为 \(S_{\triangle SDE}=\frac{1}{2}SD\cdot DE=\frac{a}{16}\sqrt{8b^2-2a^2}\).
\end{enumerate}
