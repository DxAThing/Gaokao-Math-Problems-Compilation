...
\begin{solution}
解法一. 自 \(A\) 作 \(AD\perp CP\) 于 \(D\)，自 \(B\) 作 \(BE\perp CP\) 于 \(E\). 连 \(BD\). 因为平面 \(ACP\perp\) 平面 \(BCP\)，且 \(AD\perp CP\)，所以 \(AD\perp\) 平面 \(BCP\)，则 \(\triangle ADB\) 为直角三角形. 设 \(\angle BCP=\alpha\)，则 \(\angle CAD=\alpha\).

因此 \(AD=2\cos\alpha\)，\(CD=2\sin\alpha\)，\(BE=3\sin\alpha\)，\(CE=3\cos\alpha\)，从而 \(DE=CE-CD=3\cos\alpha-2\sin\alpha\). 由
\[
\sqrt{7}=\sqrt{BE^2+ED^2+AD^2}=\sqrt{13\sin^2\alpha+13\cos^2\alpha-12\sin\alpha\cos\alpha}=\sqrt{13-6\sin 2\alpha}
\]
得 \(7=13-6\sin 2\alpha\)，即 \(\sin 2\alpha=1\). 由 \(0^\circ<\alpha<90^\circ\)，得 \(\alpha=45^\circ\)，所以 \(\angle BCD=\angle CAD=\angle ACP=45^\circ\).

解法二. 在 \(\triangle ACB\) 中，\(BC=3\)，\(AC=2\)，\(AB=\sqrt{7}\). 因此 \(\cos \angle ACB=\dfrac{3^2+2^2-7}{2\times 3\times 2}=\dfrac{1}{2}\)，从而 \(\angle ACB=60^\circ\).
...
\solutionfigure{\bitmapfigure[max width=0.38\linewidth]{img/1986/shanghai_science/q7_solution_fig2.png}}
