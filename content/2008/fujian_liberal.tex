...
\]
\item 三人都未破译出密码的概率为 \(P(\text{密码未被破译})=\left(1-\frac{1}{5}\right)\left(1-\frac{1}{4}\right)\left(1-\frac{1}{3}\right)=\frac{2}{5}\). 所以 \(P(\text{密码被破译})=1-\frac{2}{5}=\frac{3}{5}>\frac{2}{5}\)，
故“密码被破译”的概率较大.
\end{enumerate}
\end{solution}
