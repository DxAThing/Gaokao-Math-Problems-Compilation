...
\bitmapfigure[max width=0.84\linewidth]{img/2008/beijing_science/q8_fig1.png}
...
\bitmapfigure[max width=6.0cm]{img/2008/beijing_science/q12_fig1.png}
...
\begin{enumerate}
\item \(\omega = 1\).
\item 函数 \( f(x) \) 在区间 \( \left[0, \frac{2\pi}{3}\right] \) 上的取值范围为 \(\left[0, \frac{3}{2}\right]\).
\end{enumerate}
\end{solution}
\end{problem}
...
\bitmapfigure[max width=6.0cm]{img/2008/beijing_science/q16_fig1.png}

\begin{solution}
\begin{enumerate}
\item \(PC \perp AB\).
\item 二面角 \(B - AP - C\) 的大小为 \(\arcsin\frac{\sqrt{6}}{3}\).
\item 点 \(C\) 到平面 \(APB\) 的距离为 \(\frac{2\sqrt{3}}{3}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\item \(\dfrac{1}{40}\).
\item \(\dfrac{9}{10}\).
\item \(P(\xi=1)=\dfrac{3}{4}\)，\(P(\xi=3)=\dfrac{1}{4}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\[
f'(x)=-\frac{2\bigl[x-(b-1)\bigr]}{(x-1)^3}.
\]
当 \(b<2\) 时，\(f(x)\) 在 \((-\infty,b-1)\)、\((1,+\infty)\) 上单调递减，在 \((b-1,1)\) 上单调递增；当 \(b>2\) 时，\(f(x)\) 在 \((-\infty,1)\)、\((b-1,+\infty)\) 上单调递减，在 \((1,b-1)\) 上单调递增；当 \(b=2\) 时，\(f(x)=\frac{2}{x-1}\)，在 \((-\infty,1)\)、\((1,+\infty)\) 上单调递减.
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item 直线 \(AC\) 的方程为 \(x+y+2=0\).
\item 菱形 \(ABCD\) 面积的最大值为 \(4\sqrt{3}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(A_1\) 为 \(4\)，\(3\)，\(2\)，\(1\)，\(A_2\) 为 \(4\)，\(3\)，\(2\)，\(1\).
\end{enumerate}
\end{solution}
\end{problem}
