...
\[
\overrightarrow{P_{1}P}=(-3,-2),\qquad \overrightarrow{PP_{2}}=(9,6),
\]
...
\bitmapfigure[max width=0.42\linewidth]{img/2008/chongqing_science/q9_fig1.png}
...
\bitmapfigure[max width=0.38\linewidth]{img/2008/chongqing_science/q16_fig1.png}
...
又由余弦定理的变形，
\[
\cot B=\frac{a^{2}+c^{2}-b^{2}}{4S},\qquad
...
\[
P(\xi=2)=\frac{1}{2},\quad P(\xi=3)=\frac{1}{4},\quad P(\xi=4)=\frac{1}{8},\quad P(\xi=5)=\frac{1}{16},\quad P(\xi=6)=\frac{1}{16}.
\]
分布列为
\begin{center}
...
\bitmapfigure[max width=0.62\linewidth]{img/2008/chongqing_science/q19_fig1.png}
\end{problem}
...
\[
D(0,0,0),\quad E(3,0,0),\quad A(0,4,0),\quad B(0,0,-2),\quad C\left(\frac{9}{2},0,-2\right).
\]
...
在平面 \(AEC\) 中，取
\[
\overrightarrow{EA}=(-3,4,0),\qquad \overrightarrow{EC}=\left(\frac{3}{2},0,-2\right),
\]
其法向量可取
\[
...
\[
b=-\frac{3}{2},\qquad c=\frac{3}{2},
\]
从而
\[
f(x)=-\frac{3}{4}x^{2}-\frac{3}{2}x+\frac{3}{2},\qquad
g(x)=\frac{3}{4}(x^{2}+2x-2)\e^{-x}.
\]
求导得
\[
...
\bitmapfigure[max width=0.42\linewidth]{img/2008/chongqing_science/q21_fig1.png}
\end{problem}

\begin{solution}
由 \(|PM|+|PN|=6\)，可知点 \(P\) 的轨迹是以 \(M(-2,0)\)，\(N(2,0)\) 为焦点的椭圆. 设其长半轴为 \(a_{0}\)，焦距的一半为 \(c_{0}\)，则
\[
2a_{0}=6,\qquad c_{0}=2,\qquad a_{0}=3.
\]
...
\[
p\left(2-\frac{10}{p}\right)=2,\qquad p=6.
\]
因此 \(r\)，\(s\) 是方程
\[
t^{2}-6t+6=0
...
\[
\left(\frac{3\sqrt{3}}{2},\frac{\sqrt{5}}{2}\right),
\left(\frac{3\sqrt{3}}{2},-\frac{\sqrt{5}}{2}\right),
\left(-\frac{3\sqrt{3}}{2},\frac{\sqrt{5}}{2}\right),
\left(-\frac{3\sqrt{3}}{2},-\frac{\sqrt{5}}{2}\right).
\]
...
\[
x_3=x_1-\frac{3}{2}x_2=4,\qquad x_4=x_2-\frac{3}{2}x_3=-8.
\]
...
由 \(x_1=1\)，\(x_2=t\)，得
\[
u+v=1,\qquad \frac{u}{2}-2v=t,
\]
从而
\[
u=\frac{2(t+2)}{5},\qquad v=\frac{1-2t}{5}.
\]
