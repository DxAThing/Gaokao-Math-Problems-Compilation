...
\begin{enumerate}
\item 求 \(a\)，\(b\) 的值；
\item 设 \(M\)，\(N\) 是右准线 \(l\) 上两个动点，满足 \(\overrightarrow{F_{1}M} \cdot \overrightarrow{F_{2}N} = 0\). 证明：当 \(|MN|\) 取最小值时，\(\overrightarrow{F_{2}F_{1}} + \overrightarrow{F_{2}M} + \overrightarrow{F_{2}N} = 0\).
\end{enumerate}
\end{problem}
...
\item 由上问，\(F_{1}(-\sqrt{2},0)\)，\(F_{2}(\sqrt{2},0)\)，右准线 \(l\) 的方程为 \(x=\frac{a}{e}=2\sqrt{2}\). 设 \(M(2\sqrt{2},y_{1})\)，\(N(2\sqrt{2},y_{2})\). 由题设条件 \(\overrightarrow{F_{1}M}\cdot\overrightarrow{F_{2}N}=0\)，得 \((3\sqrt{2},y_{1})\cdot(\sqrt{2},y_{2})=0\)，即 \(y_{1}y_{2}=-6\). 因而 \(y_{2}=-\frac{6}{y_{1}}\)，且 \(|MN|=|y_{1}-y_{2}|=\left|y_{1}+\frac{6}{y_{1}}\right|=|y_{1}|+\frac{6}{|y_{1}|}\geqslant2\sqrt{6}\). 当且仅当 \(|y_{1}|=\sqrt{6}\) 时取等号，此时 \(y_{2}=-y_{1}\). 又 \(\overrightarrow{F_{2}F_{1}}=(-2\sqrt{2},0)\)，\(\overrightarrow{F_{2}M}=(\sqrt{2},y_{1})\)，\(\overrightarrow{F_{2}N}=(\sqrt{2},y_{2})\)，所以 \(\overrightarrow{F_{2}F_{1}}+\overrightarrow{F_{2}M}+\overrightarrow{F_{2}N}=(0,y_{1}+y_{2})=\mathbf{0}\).
\end{enumerate}
\end{solution}
