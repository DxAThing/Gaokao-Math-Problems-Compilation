...
\begin{problem}
函数 \(y = \ln(2x + 1)\) \(\left(x > -\frac{1}{2}\right)\) 的反函数是（\quad）
...
\bitmapfigure[max width=0.52\linewidth,max totalheight=5.2cm]{img/2008/sichuan_ordinary_liberal/q19_fig1.png}
\end{problem}
