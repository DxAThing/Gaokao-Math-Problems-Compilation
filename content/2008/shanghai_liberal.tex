...
当 \(0<k\leqslant\frac{1}{2}\) 时，直线的另一侧与边 \(DM\) 相交. 由于 \(DM\) 的方程为 \(y=x+1\)，交点到原点的长度为 \(\frac{\sqrt{1+k^2}}{1-k}\)，于是
\[
s(k)=\frac{\sqrt{1+k^2}}{k+1}+\frac{\sqrt{1+k^2}}{1-k}=\frac{2\sqrt{1+k^2}}{1-k^2}.
\]

当 \(\frac{1}{2}<k<\frac{\sqrt{2}}{2}\) 时，直线的另一侧与边 \(DE\) 相交. 交点满足 \(y=-1\)，到原点的长度为 \(\frac{\sqrt{1+k^2}}{k}\)，于是
\[
