...
\bitmapfigure[max width=0.62\linewidth,max totalheight=4.8cm]{img/2008/shanghai_liberal/q15_fig1.png}
...
\bitmapfigure[max width=0.52\linewidth,max totalheight=5cm]{img/2008/shanghai_liberal/q16_fig1.png}
\end{problem}
...
\bitmapfigure[max width=0.5\linewidth,max totalheight=4.8cm]{img/2008/shanghai_liberal/q17_fig1.png}
\end{problem}
...
\begin{enumerate}
\item 若 \(f(x) = 2\)，求 \(x\) 的值；
\item 若 \(2^{x}f(2t) + mf(t) \geqslant 0\) 对于 \(t \in [1,2]\) 恒成立，求实数 \(m\) 的取值范围.
\end{enumerate}
\end{problem}
