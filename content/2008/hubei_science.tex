...
\begin{problem}
水库的蓄水量随时间而变化. 用 \(t\) 表示时间，以月为单位，年初为起点. 根据历年数据，某水库的蓄水量 (单位：亿立方米) 关于 \(t\) 的近似函数关系式为 \(V(t) = \left\{ \begin{array}{ll} (-t^2 + 14t - 40)\e^{\frac14 t} + 50,  0 < t \leqslant 10, 4(t - 10)(3t - 41) + 50,  10 < t \leqslant 12. \end{array} \right.\)
\begin{enumerate}[label={（\arabic*）},itemsep=0.2em]
