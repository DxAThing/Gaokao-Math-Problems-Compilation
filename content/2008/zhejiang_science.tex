...
\begin{problem}
如图，已知球 \(O\) 的表面上四点 \(A\text{，}B\text{，}C\text{，}D\)，\(DA \perp\) 平面 \(ABC\)，\(AB \perp BC\)，\(DA = AB = BC = \sqrt{3}\)，则球 \(O\) 的体积等于\fillinblank{}.
...
\item \(E(\xi)=\frac{3}{2}\).
\end{enumerate}
\item 至少得到 1 个黑球的概率不大于 \(\frac{7}{10}\)，红球个数最少.
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(C\) 的方程为 \(y=\frac{1}{2}(x^2+x)\).
\item \(l\) 的方程为 \(2x-y+2=0\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item 当 \(a\leqslant0\) 时，\(f(x)\) 在 \([0,+\infty)\) 上单调递增；当 \(a>0\) 时，\(f(x)\) 在 \(\left[0,\frac{a}{3}\right]\) 上单调递减，在 \(\left(\frac{a}{3},+\infty\right)\) 上单调递增.
\item
\begin{enumerate}
\item \(g(a)=\begin{cases}
0,&a\leqslant0,\\
-\frac{2a}{3}\sqrt{\frac{a}{3}},&0<a<6,\\
\sqrt{2}(2-a),&a\geqslant6.
\end{cases}\)
\item \(3\leqslant a\leqslant2+3\sqrt{2}\).
\end{enumerate}
\end{enumerate}
\end{solution}
\end{problem}
