...
\begin{problem}
在体积为 \(4\sqrt{3}\pi\) 的球的表面上有 \(A, B, C\) 三点，\(AB = 1, BC = \sqrt{2}, A, C\) 两点的球面距离为 \(\frac{\sqrt{3}}{3}\pi\)，则球心到平面 \(ABC\) 的距离为 \fillinblank{} \fillinblank{}.
\end{problem}
...
\begin{problem}
某批发市场对某种商品的周销售量（单位：吨）进行统计，最近 100 周的统计结果如下表所示：周销售量 2 3 4 频数 20 50 30。
...
\item 该种商品 4 周的销售总量和至少为 15 吨的概率。
\end{circlelist}
\end{enumerate}
\end{problem}
...
\makebox[\linewidth][r]{\includegraphics[width=4.6cm]{img/2008/liaoning_liberal/q19_fig1.png}}
\end{problem}
