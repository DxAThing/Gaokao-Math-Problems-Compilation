...
\begin{enumerate}
\item \(\omega=2\).
\item 函数 \(f(x)\) 的最大值为 \(2+\sqrt{2}\)，此时 \(x\) 的集合为
\[
\left\{x\mathrel{\left|\right.}x=\frac{\pi}{16}+\frac{k\pi}{2},\ k\in\Z\right\}.
\]
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 乙投球的命中率为 \(\frac{3}{4}\).
\item 甲投球 2 次，至少命中 1 次的概率为 \(\frac{3}{4}\).
\item 两人共命中 2 次的概率为 \(\frac{11}{32}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(AD \perp\) 平面 \(PAB\).
\item 异面直线 \(PC\) 与 \(AD\) 所成的角为 \(\arctan\frac{\sqrt{7}}{2}\).
\item 二面角 \(P-BD-A\) 的大小为 \(\arctan\frac{\sqrt{39}}{4}\).
\end{enumerate}
\end{solution}
...
\end{cases}
\)
\item \(q=-\sqrt[3]{2}\)，且对任意 \(n\in\N^*\)，\(a_n\) 是 \(a_{n+3}\) 与 \(a_{n+6}\) 的等差中项.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 函数在 \((0,\frac{1}{2})\)，\((2,+\infty)\) 上单调递增，在 \((-\infty,0)\)，\((\frac{1}{2},2)\) 上单调递减.
\item \(a\in\left[-\frac{8}{3},\frac{8}{3}\right]\).
\item \(b\leqslant -4\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 双曲线 \(C\) 的方程为 \(\dfrac{x^2}{4}-\dfrac{y^2}{5}=1\).
\item \(k\in\left(-\infty,-\frac{5}{4}\right)\cup\left(-\frac{\sqrt{5}}{2},0\right)\cup\left(0,\frac{\sqrt{5}}{2}\right)\cup\left(\frac{5}{4},+\infty\right)\).
\end{enumerate}
\end{solution}
