...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.2cm]{img/2008/beijing_liberal/q13_fig1.png}
...
其中能使 \( f(x_1) > f(x_2) \) 恒成立的条件序号是 \fillinblank{}. \( T(a) \) 表示非负实数 \( a \) 的整数部分，例如 \( T(2.6) = 2 \)，\( T(0.2) = 0 \). 按此方案，第6棵树种植点的坐标应为 \fillinblank{}；第2008棵树种植点的坐标应为 \fillinblank{} \fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.2cm]{img/2008/beijing_liberal/q16_fig1.png}
...
\begin{problem}
已知 \(\triangle ABC\) 的顶点 \(A, B\) 在椭圆 \(x^{2} + 3y^{2} = 4\) 上，\(C\) 在直线 \(l: y = x + 2\) 上，且 \(AB // l\).
