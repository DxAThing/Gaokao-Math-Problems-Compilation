...
\begin{center}
\bitmapfigure[max width=0.42\linewidth]{img/2020/national_paper_2/q4_fig1.png}
\end{center}
...
\solutionfigure{\bitmapfigure[max width=0.62\linewidth]{img/2020/national_paper_2/q4_solution_fig1.png}}
...
\begin{center}
\bitmapfigure[max width=0.88\linewidth]{img/2020/national_paper_2/q9_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.42\linewidth]{img/2020/national_paper_2/q11_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.52\linewidth]{img/2020/national_paper_2/q13_solution_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.52\linewidth]{img/2020/national_paper_2/q14_solution_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.88\linewidth]{img/2020/national_paper_2/q16_fig1.png}
\end{center}
...
\solutionfigure{\bitmapfigure[max width=0.60\linewidth]{img/2020/national_paper_2/q20_solution_fig1.png}}
...
\(1^{\odot}\) 若选 \(1^{\odot}\) \(ac=\sqrt3\)，则
\(\sqrt3\,m\cdot m=\sqrt3\)，解得 \(m=1\)，所以
\(c=1\).
\(2^{\odot}\) 若选 \(2^{\odot}\) \(c\sin A=3\)，则
\(\sin A=\sin\frac{2\pi}{3}=\frac{\sqrt3}{2}\)，故
\(c\cdot \frac{\sqrt3}{2}=3\)，解得
\(c=2\sqrt3\).
\(3^{\odot}\) 若选 \(3^{\odot}\) \(c=\sqrt3\,b\)，则
\(\frac cb=\frac mm=1\)，即 \(c=b\)，与条件 \(c=\sqrt3\,b\) 矛盾，所以问题中的三角形不存在.

\text{【法二】} 因为 \(\sin A=\sqrt3\sin B\)，\(C=\dfrac{\pi}{6}\)，\(B=\pi-\left( A+C \right)\)，
...
若选 \(1^{\odot}\)，因为 \(ac=\sqrt3\)，\(a=\sqrt3\,b=\sqrt3\,c\)，所以
\(\sqrt3\,c^2=\sqrt3\)，故
\(c=1\).
若选 \(2^{\odot}\)，因为 \(c\sin A=3\)，所以
\(\frac{\sqrt3 c}{2}=3\)，故
\(c=2\sqrt3\).
若选 \(3^{\odot}\)，则与条件 \(c=\sqrt3\,b\) 矛盾.
\end{solution}
...
\begin{solution}
（1）设等比数列 \(\{a_n\}\) 的公比为 \(q(q>1)\)，首项为 \(a_1\)，则
\(a_1q+a_1q^3=20\) \(\circled{1}\)，\(a_1q^2=8\) \(\circled{2}\).
由\circled{2}得 \(a_1=\dfrac8{q^2}\)，代入\circled{1}得
...
\bitmapfigure[max width=0.88\linewidth]{img/2020/national_paper_2/q20_fig1.png}
...
\bitmapfigure[max width=0.52\linewidth]{img/2020/national_paper_2/q21_solution_fig1.png}
