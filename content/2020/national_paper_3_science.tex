...
\examdisplayarray{A\cap B=\{(x,y)\mid \left\{}
{l}
{
y\ge x\\
x+y=8
}
{\right.,\ x,y\in \mathbf N^*\}=\{(7,1),(6,2),(5,3),(4,4)\}.}
...
\begin{center}
\bitmapinclude[max width=3.4cm,max totalheight=3cm]{img/2020/national_paper_3_science/q8_fig1.png}
\end{center}
...
\begin{center}
\vspace{-1em}
\bitmapinclude[max width=3.8cm,max totalheight=4.2cm]{img/2020/national_paper_3_science/q19_fig1.png}
\vspace{-1em}
\end{center}
\end{problem}
...
联立 \circled{1}\circled{2}\circled{3}，得 \(\left\{
\begin{array}{l}
s=3,\\
t=1,\\
n=2
\end{array}
\right.\quad\text{或}\quad\left\{
\begin{array}{l}
s=-3,\\
t=1,\\
n=8.
