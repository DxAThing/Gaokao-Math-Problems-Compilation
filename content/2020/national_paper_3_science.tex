...
\begin{center}
\bitmapinclude[max width=6.0cm]{img/2020/national_paper_3_science/q8_fig1.png}
\end{center}
...
\bitmapfigure[max width=3.2cm]{img/2020/national_paper_3_science/q8_solution_fig1.png}
...
\begin{problem}
若 \(x\)，\(y\) 满足 \(\begin{cases} x+y\ge0\\ 2x-y\ge0\\ x\le1 \end{cases}\)
...
先根据约束条件画出可行域，由 \(\begin{cases} x=1\\ 2x-y=0 \end{cases}\)
解得 \(A(1,2)\)，

\bitmapfigure[max width=4.2cm]{img/2020/national_paper_3_science/q13_solution_fig1.png}
...
\bitmapfigure[max width=4.2cm]{img/2020/national_paper_3_science/q15_solution_fig1.png}
...
\begin{solution}
（1）该市一天的空气质量等级为 \(1\) 的概率为 \(\frac{43}{100}\)，等级为 \(2\) 的概率为 \(\frac{27}{100}\)，等级为 \(3\) 的概率为 \(\frac{21}{100}\)，等级为 \(4\) 的概率为 \(\frac{9}{100}\).
...
\begin{center}
\vspace{-1em}
\bitmapinclude[max width=6.0cm]{img/2020/national_paper_3_science/q19_fig1.png}
\vspace{-1em}
\end{center}
\end{problem}
...
（2）在长方体 \(ABCD-A_1B_1C_1D_1\) 中，以 \(C_1\) 为坐标原点，分别以 \(C_1D_1\)，\(C_1B_1\)，\(C_1C\) 所在直线为 \(x\)，\(y\)，\(z\) 轴建立空间直角坐标系.
