...
\bitmapfigure[float=inline,width=5.4cm]{img/2020/national_paper_3_liberal/q9_fig1.png}
...
\begin{solution}
\begin{enumerate}
    \item 该市一天的空气质量等级为 \(1\)，\(2\)，\(3\)，\(4\) 的概率分别为 \(0.43\)，\(0.27\)，\(0.21\)，\(0.09\).
    \item 一天中到该公园锻炼的平均人次的估计值为 \(350\).
    \item 列联表为
...
\begin{solution}
\begin{enumerate}
    \item 当 \(k\le 0\) 时，\(f(x)\) 在 \(\R\) 上单调递增；当 \(k>0\) 时，\(f(x)\) 在 \(\left(-\infty,-\dfrac{\sqrt{3k}}{3}\right)\) 和 \(\left(\dfrac{\sqrt{3k}}{3},+\infty\right)\) 上单调递增，在 \(\left(-\dfrac{\sqrt{3k}}{3},\dfrac{\sqrt{3k}}{3}\right)\) 上单调递减.
    \item \(k\in\left(0,\dfrac{4}{27}\right)\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
    \item \(C\) 的方程为
    \(\dfrac{x^2}{25}+\dfrac{16y^2}{25}=1\).
    \item \(\triangle APQ\) 的面积为 \(\dfrac{5}{2}\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
    \item \(|AB|=4\sqrt{10}\).
    \item 直线 \(AB\) 的极坐标方程为 \(3\rho\cos\theta-\rho\sin\theta+12=0\).
\end{enumerate}
\end{solution}
