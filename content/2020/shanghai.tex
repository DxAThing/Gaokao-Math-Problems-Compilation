...
\end{solution}
\begin{problem}
计算：\(\displaystyle\lim_{n\to\infty}\frac{n+1}{3n-1}=\)\fillinblank{}. 
...
\begin{solution}
因为
\(\lim_{n\to\infty}\frac{n+1}{3n-1} =\lim_{n\to\infty}\frac{1+\frac1n}{3-\frac1n} =\frac13\)，
故答案为 \(\frac13\).
\end{solution}
\begin{problem}
...
\begin{center}
\bitmapinclude[max width=3.5cm,max totalheight=3.2cm]{img/2020/shanghai/q5_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=3.2cm,max totalheight=3.2cm]{img/2020/shanghai/q10_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=3.4cm,max totalheight=3cm]{img/2020/shanghai/q12_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=3.2cm,max totalheight=3.2cm]{img/2020/shanghai/q15_fig1.png}
\end{center}
...
\begin{solution}
如图，
\bitmapfigure[max width=3.8cm,max totalheight=3.8cm]{img/2020/shanghai/q15_solution_fig1.png}
...
\begin{center}
\bitmapinclude[max width=3.3cm,max totalheight=3.2cm]{img/2020/shanghai/q17_fig1.png}
\end{center}

\end{problem}

\begin{solution}
（1）该圆柱的表面由上下两个半径为 \(1\) 的圆面和一个长为 \(2\pi\)、宽为 \(1\) 的矩形组成，
\(S=2\times\pi\times1^2+2\pi\times1=4\pi\).
故该圆柱的表面积为 \(4\pi\).

（2）因为正方形 \(ABC_1D_1\)，所以 \(AD_1\perp AB\).
...
\begin{solution}
（1）按实际情况而言，交通流量 \(v\) 随着道路密度 \(x\) 的增大而减小，故 \(v=f(x)\) 是单调递减函数，所以 \(k>0\).
...
（2）由题意可得 \(F_1,F_2\) 为曲线 \(\Gamma_1\) 的两个焦点.
由双曲线的定义可得
\(|PF_1|-|PF_2|=2a\)，
又 \(|PF_1|=8\)，\(2a=4\)，所以
\(|PF_2|=8-4=4\).
...
（3）设直线 \(l:y=-\frac{b}{2}x+\frac{b^2}{2}+2\)，可得原点 \(O\) 到直线 \(l\) 的距离
...
（3）设 \(a_1=p\)，\(p\in\{3,4,\ldots,m-3,m-2\}\).
因为 \(a_1=p\)，\(a_2\) 可以取 \(p-1\) 或 \(p+1\)，\(a_3\) 可以取 \(p-2\) 或 \(p+2\).
如果 \(a_2\) 或 \(a_3\) 取了 \(p-3\) 或 \(p+3\)，将使 \(\{a_n\}\) 不满足性质 \(P\)；所以 \(\{a_n\}\) 的前 \(5\) 项有以下组合：

（i）\(a_1=p\)，\(a_2=p-1\)，\(a_3=p+1\)，\(a_4=p-2\)，\(a_5=p+2\)；
（ii）\(a_1=p\)，\(a_2=p-1\)，\(a_3=p+1\)，\(a_4=p+2\)，\(a_5=p-2\)；
（iii）\(a_1=p\)，\(a_2=p+1\)，\(a_3=p-1\)，\(a_4=p-2\)，\(a_5=p+2\)；
（iv）\(a_1=p\)，\(a_2=p+1\)，\(a_3=p-1\)，\(a_4=p+2\)，\(a_5=p-2\).

对于（1），\(b_1=p-1\)，\(|b_2-b_1|=2\)，\(|b_3-b_1|=1\)，与 \(\{b_n\}\) 满足性质 \(P\) 矛盾，舍去；

对于（2），\(b_1=p-1\)，\(|b_2-b_1|=2\)，\(|b_3-b_1|=3\)，\(|b_4-b_1|=1\)，与 \(\{b_n\}\) 满足性质 \(P\) 矛盾，舍去；

对于（3），\(b_1=p+1\)，\(|b_2-b_1|=2\)，\(|b_3-b_1|=3\)，\(|b_4-b_1|=1\)，与 \(\{b_n\}\) 满足性质 \(P\) 矛盾，舍去；

对于（4），\(b_1=p+1\)，\(|b_2-b_1|=2\)，\(|b_3-b_1|=1\)，与 \(\{b_n\}\) 满足性质 \(P\) 矛盾，舍去.
