...
\(2x-\dfrac\pi{12}=\dfrac\pi2+k\pi\)，\(k\in\Z\)
...
\(EF=160+\dfrac{x^3}{800}-6x\)，\(CD=160-\dfrac{(80-x)^2}{40}\).
总造价除以正数 \(k\) 后为
\[
...
\(x_1+x_2=t^3-t\)，\((x_2-x_1)^2=t^6-5t^4+3t^2+8=P(u)\)
...
\(c=\dfrac{x_1+x_2}{2}=\dfrac{t(u-1)}2\)，\(w=\dfrac{x_2-x_1}{2}=\dfrac{\sqrt{P(u)}}2\)，\(qquad r=\sqrt{2-2u}\).
...
\(a_1=1\)，\(a_n=S_n-S_{n-1}=3\cdot4^{n-2}\)，\((n\ge2)\).
...
\(A=(0,0,2)\)，\(B=(1,0,0)\)，\(C=(0,2,0)\)，\(D=(-1,0,0)\).
...
\(\bs n_1\cdot\bs n_2=-6\)，\(|\bs n_1|=\sqrt6\)，\(|\bs n_2|=\sqrt{78}\).
二面角取两平面锐角，故
\[
...
\(p_2=\dfrac13p_1+\dfrac29q_1=\dfrac7{27}\)，\(q_2=\dfrac23p_1+\dfrac59q_1=\dfrac{16}{27}\)
