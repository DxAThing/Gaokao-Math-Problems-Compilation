...
\begin{center}
\bitmapfigure[max width=0.80\linewidth,max totalheight=4.8cm]{img/2020/beijing/q15_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.60\linewidth,max totalheight=4.8cm]{img/2020/beijing/q16_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.60\linewidth,max totalheight=4.8cm]{img/2020/beijing/q16_solution_fig1.png}
\end{center}
...
\begin{center}
\bitmapfigure[max width=0.60\linewidth,max totalheight=4.8cm]{img/2020/beijing/q16_solution_fig2.png}
\end{center}
...
（2）\(3\text{ 人}\) 中恰有 \(2\text{ 人}\) 支持方案一分两种情况：（1）仅有两个男生支持方案一，（2）仅有一个男生支持方案一，一个女生支持方案一，所以 \(P=\left(\frac13\right)^2\left(1-\frac34\right)+\mathrm C_2^1\cdot\frac13\left(1-\frac13\right)\cdot\frac34=\frac{13}{36}\).
