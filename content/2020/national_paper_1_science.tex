...
\begin{solution}
由题意可知图形如图：
\solutionfigure{\bitmapfigure[max width=5.2cm]{img/2020/national_paper_1_science/q10_solution_fig1.png}}
...
\begin{solution}
如图示：
\solutionfigure{\bitmapfigure[max width=5.0cm]{img/2020/national_paper_1_science/q20_solution_fig1.png}}
（1）由题意可得
...
所以
\(4x-16y+3=0\).
联立 \(\left( x-y \right)^2-2\left( x+y \right)+1=0\) 和 \(4x-16y+3=0\)，解得 \(\begin{cases}
x=\dfrac{169}{36},\\
y=\dfrac{49}{36}
\end{cases}\)（舍去），或 \(\begin{cases}
x=\dfrac{1}{4},\\
y=\dfrac{1}{4}
\end{cases}\).
故 \(C_1\) 与 \(C_2\) 的公共点的直角坐标为
...
\solutionfigure{\bitmapfigure[max width=4.6cm]{img/2020/national_paper_1_science/q23_solution_fig2.png}}
其中直线
\(y=5x-1\)
向左平移 \(1\) 个单位后可表示为
