...
\begin{center}
\bitmapinclude[max width=6.6cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q3_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=5.6cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q5_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=0.7\linewidth,max totalheight=4.8cm]{img/2020/national_paper_1_science/q7_fig1.png}
\end{center}
...
\bitmapfigure[max width=5.2cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q10_solution_fig1.png}
...
\begin{center}
\bitmapinclude[max width=5.2cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q16_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=5.2cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q18_fig1.png}
\end{center}
\end{problem}
...
第一种，比赛四场结束且丙最终获胜，其概率为 \(\frac{1}{8}\).

第二种，比赛五场结束且丙最终获胜. 从第二场开始的四场比赛，按丙的胜、负、轮空结果有三种情况：\(\text{胜胜负胜}\)，\(\text{胜负空胜}\)，\(\text{负空胜胜}\)，其对应概率分别为 \(\frac{1}{16}\)，\(\frac{1}{8}\)，\(\frac{1}{8}\).
...
\bitmapfigure[max width=5.0cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q20_solution_fig1.png}
...
联立 \(\left( x-y \right)^2-2\left( x+y \right)+1=0\) 和 \(4x-16y+3=0\)，解得 \(\left\{ \begin{array}{l} x=\dfrac{169}{36},\\ y=\dfrac{49}{36} \end{array} \right.\)（舍去），或 \(\left\{ \begin{array}{l} x=\dfrac{1}{4},\\ y=\dfrac{1}{4} \end{array} \right.\).
...
\bitmapfigure[max width=5.3cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q23_solution_fig1.png}

（2）因为 \(f(x+1)\) 的图象是函数 \(f(x)\) 的图象向左平移 \(1\) 个单位所得，如图所示：

\bitmapfigure[max width=4.6cm,max totalheight=4.8cm]{img/2020/national_paper_1_science/q23_solution_fig2.png}
