...
\begin{solution}
由题意可知所求圆在第一象限. 设圆心为 \((a,a)\)，半径为 \(a\)（\(a>0\)），则圆的方程为 \(\left( x-a \right)^2+\left( y-a \right)^2=a^2\). 把点 \((2,1)\) 代入，得 \(\left( 2-a \right)^2+\left( 1-a \right)^2=a^2\)，解得 \(a=1\) 或 \(a=5\). 所以圆心为 \((1,1)\) 或 \((5,5)\). 圆心到直线 \(2x-y-3=0\) 的距离分别为 \(\frac{|2-1-3|}{\sqrt5}=\frac{2}{\sqrt5}\) 和 \(\frac{|10-5-3|}{\sqrt5}=\frac{2}{\sqrt5}\). 故所求距离为 \(\frac{2}{\sqrt5}=\frac{2\sqrt5}{5}\). 故选 B.
\end{solution}
...
\begin{center}
\bitmapinclude[max width=6.0cm]{img/2020/national_paper_2_science/q7_fig1.png}
\end{center}
...
\begin{center}
\bitmapinclude[max width=6.0cm]{img/2020/national_paper_2_science/q20_fig1.png}
\end{center}
\end{problem}
