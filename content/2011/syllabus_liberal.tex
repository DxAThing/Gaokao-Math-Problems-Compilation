...
\begin{problem}
设向量 \(a, b\) 满足 \(|a| = |b| = 1, a \cdot b = -\frac{1}{2}\)，则 \(|a + 2b| =\)（\quad）
...
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.5cm]{img/2011/syllabus_liberal/q20_fig1.png}
...
\bitmapfigure[max width=0.38\linewidth,max totalheight=6cm]{img/2011/syllabus_liberal/q22_fig1.png}
