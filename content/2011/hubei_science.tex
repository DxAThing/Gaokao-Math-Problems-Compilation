...
\begin{solution}
\begin{enumerate}
\item \(\triangle ABC\) 的周长为 \(5\).
\item \(\cos(A-C)=\frac{11}{16}\).
\end{enumerate}
\end{solution}
...
60,&0\leqslant x\leqslant 20,\\
\frac{200-x}{3},&20<x\leqslant 200.
\end{cases}\)
\item 当 \(x=100\) 时，车流量达到最大，最大值为 \(\frac{10000}{3}\text{ 辆/小时}\)，约为 \(3333\text{ 辆/小时}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 当 \(CF=1\) 时，\(EF\perp A_{1}C_{1}\).
\item \(\tan\theta\) 的最小值为 \(\frac{\sqrt{6}}{3}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(a_1=a\)，且当 \(n\geqslant 2\) 时，\(a_n=ar(1+r)^{n-2}\).
\item 对任意 \(m\geqslant 2\)，\(a_{m+1}\)，\(a_m\)，\(a_{m+2}\) 成等差数列.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C\) 的方程为 \(mx^2-y^2=ma^2\). 当 \(m<-1\) 时为焦点在 \(y\) 轴上的椭圆；当 \(m=-1\) 时为圆；当 \(-1<m<0\) 时为焦点在 \(x\) 轴上的椭圆；当 \(m>0\) 时为焦点在 \(x\) 轴上的双曲线.
\item 当 \(m\in\left[\frac{1-\sqrt{5}}{2},0\right)\cup\left(0,\frac{1+\sqrt{5}}{2}\right]\) 时存在这样的点 \(N\)；当 \(m\in\left[\frac{1-\sqrt{5}}{2},0\right)\) 时，\(\tan\angle F_1NF_2=2\)；当 \(m\in\left(0,\frac{1+\sqrt{5}}{2}\right]\) 时，\(\tan\angle F_1NF_2=-2\). 其他情形不存在.
\end{enumerate}
\end{solution}
...
\item
\begin{enumerate}
\item \(a_1^{b_1}a_2^{b_2}\cdots a_n^{b_n}\leqslant 1\).
\item \(\frac{1}{n}\leqslant b_1^{b_1}b_2^{b_2}\cdots b_n^{b_n}\leqslant b_1^2+b_2^2+\cdots+b_n^2\).
\end{enumerate}
\end{enumerate}
\end{solution}
