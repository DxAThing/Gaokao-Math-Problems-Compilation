...
\bitmapfigure[max width=0.56\linewidth,max totalheight=4.8cm]{img/2011/hubei_science/q15_fig1.png}
\end{problem}
...
\begin{problem}
已知函数 \( f(x) = \ln x - x + 1, x \in (0, +\infty) \)，求函数 \( f(x) \) 的最大值.
\end{problem}

\begin{problem}
设 \(a_k, b_k\)（\(k = 1, 2, \dots, n\)）均为正数，证明：
