...
\begin{solution}
\begin{enumerate}
\item 当 \(a=\frac{4}{3}\) 时，极大值点为 \(x=\frac{1}{2}\)，极小值点为 \(x=\frac{3}{2}\).
\item 若 \(f(x)\) 为 \(\R\) 上的单调函数，则 \(0<a\leqslant 1\).
\end{enumerate}
\end{solution}
...
\begin{enumerate}
\item \(a_n=n+2\).
\item \(S_n=\dfrac{\tan(n+3)-\tan 3}{\tan 1}-n\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 任务能被完成的概率为 \(1-(1-p_1)(1-p_2)(1-p_3)\)，改变派出顺序不改变该概率.
\item \(P(X=1)=q_1\)，\(P(X=2)=(1-q_1)q_2\)，\(P(X=3)=(1-q_1)(1-q_2)\)，\(E(X)=3-2q_1-q_2+q_1q_2\).
\item 按 \(p_1,p_2,p_3\) 递减顺序派出，即先甲、再乙、后丙.
\end{enumerate}
\end{solution}
