...
\texfigure[max width=0.44\linewidth]{img_repaint/2011/beijing_science/q4_fig1.tex}
...
\bitmapfigure{img/2011/beijing_science/q5_fig1.png}
...
\(f(x) = \begin{cases} \dfrac{c}{\sqrt{x}}, & x < A, \\ \dfrac{c}{\sqrt{A}}, & x \geqslant A, \end{cases}\)
...
\begin{problem}
若数列 \(A_n : a_1\)，\(a_2\)，\(\cdots\)，\(a_n\)（\(n \geqslant 2\)）满足 \(|a_{n+1} - a_k| = 1\)（\(k = 1\)，\(2\)，\(\cdots\)，\(n - 1\)），则称 \(A_n\) 为 \(E\) 数列. 记 \(S(A_n) = a_1 + a_2 + \cdots + a_n\).
