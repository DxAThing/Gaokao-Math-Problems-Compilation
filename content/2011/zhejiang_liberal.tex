...
\texfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img_repaint/2011/zhejiang_liberal/q13_fig1.tex}
\end{problem}

\begin{problem}
\needspace{13cm}
某程序框图如图所示，则该程序运行后输出的 k 的值是\fillinblank{}.
\bitmapfigure[width=5.3cm,max width=0.70\linewidth]{img/2011/zhejiang_liberal/q14_fig1.png}
\end{problem}
