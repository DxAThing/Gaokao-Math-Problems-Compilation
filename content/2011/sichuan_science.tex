...
\begin{solution}
\begin{enumerate}
\item 短答案：最小正周期为 \(2\pi\)，最小值为 \(-2\).
\item 短答案：\(\beta=\frac{\pi}{2}\)，且 \(\left[f(\beta)\right]^2-2=0\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：两人所付租车费用相同的概率为 \(\frac{5}{16}\).
\item 短答案：\(\xi\) 的分布列为
\begin{center}
\begin{tabular}{c|ccccc}
\(\xi\)&\(0\)&\(2\)&\(4\)&\(6\)&\(8\)\\ \hline
\(P\)&\(\frac18\)&\(\frac{5}{16}\)&\(\frac{5}{16}\)&\(\frac{3}{16}\)&\(\frac{1}{16}\)
\end{tabular}
\end{center}
数学期望为 \(E(\xi)=3\).
\end{enumerate}
...
\begin{enumerate}
\item 短答案：\(CD=C_{1}D\).
\item 短答案：二面角 \(A-A_{1}D-B\) 的平面角余弦值为 \(\frac{2}{3}\).
\item 短答案：点 \(C\) 到平面 \(B_{1}DP\) 的距离为 \(\frac{1}{3}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(a_{1}=d\)，\(a_{2}=d(d+1)\)，\(a_{3}=d(d+1)^2\). 当 \(d\neq-1\) 时，\(\{a_n\}\) 是首项为 \(d\)、公比为 \(d+1\) 的等比数列；当 \(d=-1\) 时不是等比数列.
\item 短答案：当 \(d=-1\) 时，\(S_n=1\)；当 \(d\neq-1\) 时，\(S_n=(d+1)^n(nd-1)+1\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：直线 \(l\) 的方程为 \(y=\sqrt{2}x+1\) 或 \(y=-\sqrt{2}x+1\).
\item 短答案：\(\overrightarrow{OP}\cdot\overrightarrow{OQ}=1\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(F(x)\) 在 \(\left(0,\frac{9}{16}\right)\) 上单调递减，在 \(\left(\frac{9}{16},+\infty\right)\) 上单调递增，极小值为 \(\frac{1}{8}\).
\item 短答案：当 \(1<a\leqslant4\) 时，\(x=3-\sqrt{5-a}\)；当 \(4<a<5\) 时，\(x=3\pm\sqrt{5-a}\)；当 \(a=5\) 时，\(x=3\)；当 \(a\leqslant1\) 或 \(a>5\) 时，无解.
\item 短答案：\(f(100)h(100)-\displaystyle\sum_{k=1}^{100}h(k)>\frac{1}{6}\).
\end{enumerate}
\end{solution}
