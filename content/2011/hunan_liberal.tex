...
\bitmapfigure[max width=0.6\linewidth]{img/2011/hunan_liberal/q4_fig1.png}
...
\begin{problem}
通过随机询问 110 名性别不同的大学生是否爱好某项运动，得到如下的列联表：男 女 总计 爱好 40 20 60 不爱好 20 30 50 总计 60 50 110 由 \(K^2 = \frac{n(ad-bc)^2}{(a + b)(c + d)(a + c)(b + d)}\) 算得， \[ K ^{2} = \frac {110 \times (40 \times 30 - 20 \times 20) ^{2}}{60 \times 50 \times 60 \times 50} \approx 7.8 \] 附表： \(\begin{array}{c|ccc}P(K^2 \geqslant k) & 0.050 & 0.010 & 0.001\\ \hline k & 3.841 & 6.635 & 10.828 \end{array}\) 参照附表，得到的正确结论是（\quad）
...
\texfigure[max width=0.30\linewidth]{img_repaint/2011/hunan_liberal/q11_fig1.tex}
\end{problem}
