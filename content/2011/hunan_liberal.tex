...
\begin{solution}
短答案：\(C = \frac{\pi}{4}\)；最大值为 \(2\)，此时 \(A = \frac{\pi}{3}\)，\(B = \frac{5\pi}{12}\).
\end{solution}
...
\begin{solution}
短答案：频率依次为 \(\frac{3}{20}\)，\(\frac{7}{20}\)，\(\frac{3}{20}\)；概率为 \(\frac{3}{10}\).
\end{solution}
...
\begin{solution}
短答案：证明结论为 \(AC \perp\) 平面 \(POD\)；正弦值为 \(\frac{\sqrt{2}}{3}\).
\end{solution}
...
70\left(\frac{3}{4}\right)^{n-6}, & n \geqslant 7,
\end{cases}\)；须在第\(9\)年初对 \(M\) 更新.
\end{solution}
...
\begin{solution}
短答案：轨迹为 \(y^2 = 4x\)（\(x \geqslant 0\)）和 \(y = 0\)（\(x < 0\)）；最小值为 \(16\).
\end{solution}
