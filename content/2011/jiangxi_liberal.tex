...
\begin{solution}
短答案：\(\cos A=\frac{1}{3}\)；\(c=\frac{\sqrt{3}}{2}\).
\end{solution}
...
\begin{solution}
短答案：\(PA=\frac{2\sqrt{3}}{3}\)；\(A'B\perp DE\).
\end{solution}
...
\begin{solution}
短答案：\(f(x)=\frac{1}{3}x^{3}+3x^{2}+2x\)；\((m,n)=(2,3)\) 或 \((3,5)\).
\end{solution}
