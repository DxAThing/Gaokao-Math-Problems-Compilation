...
\begin{enumerate}
\item \(PQ \perp\) 平面 \(DCQ\).
\item 棱锥 \(Q-ABCD\) 的体积与棱锥 \(P-DCQ\) 的体积比值为 \(1\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 第一大块地都种植品种甲的概率为 \(\dfrac{1}{6}\).
\item 品种甲的样本平均数和样本方差分别为 \(400\) 和 \(57.25\)，品种乙的样本平均数和样本方差分别为 \(412\) 和 \(56\)，应选择种植品种乙.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C_{1}\) 是圆，\(C_{2}\) 是椭圆，且 \(a=3\)，\(b=1\).
\item 四边形 \(A_{1}A_{2}B_{2}B_{1}\) 的面积为 \(\dfrac{2}{5}\).
\end{enumerate}
\end{solution}
