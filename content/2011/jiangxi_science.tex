...
\begin{optionlist}
\item[\textbf{A.}] 若曲线的极坐标方程为 \(\rho = 2 \sin \theta + 4 \cos \theta\)，以极点为原点，极轴为 \(x\) 轴正半轴建立直角坐标系，则该曲线的直角坐标方程为\fillinblank{}.

\item[\textbf{B.}] 对于实数 \(x, y\)，若 \(|x - 1| \leqslant 1\)、\(|y - 2| \leqslant 1\)，则 \(|x - 2y + 1|\) 的最大值为\fillinblank{}.
\end{optionlist}
\end{problem}
