...
\begin{solution}
\begin{enumerate}
\item 平面 \(PQC\perp\) 平面 \(DCQ\).
\item 二面角 \(Q-BP-C\) 的余弦值为 \(-\dfrac{\sqrt{15}}{5}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(P(X=0)=\dfrac{1}{70}\)，\(P(X=1)=\dfrac{8}{35}\)，\(P(X=2)=\dfrac{18}{35}\)，\(P(X=3)=\dfrac{8}{35}\)，\(P(X=4)=\dfrac{1}{70}\)，且 \(E(X)=2\).
\item 品种甲的样本平均数为 \(400\)，样本方差为 \(57.25\)；品种乙的样本平均数为 \(412\)，样本方差为 \(56\)，应种植品种乙.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 当 \(a\leqslant0\) 时，\(f(x)\) 在 \((0,+\infty)\) 上单调增加；当 \(a>0\) 时，\(f(x)\) 在 \((0,\frac{1}{a})\) 上单调增加，在 \((\frac{1}{a},+\infty)\) 上单调减少.
\item \(f(\frac{1}{a}+x)>f(\frac{1}{a}-x)\).
\item \(f'(x_{0})<0\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(\dfrac{|BC|}{|AD|}=\dfrac{3}{4}\).
\item 当 \(0<e\leqslant\dfrac{\sqrt{2}}{2}\) 时不存在；当 \(\dfrac{\sqrt{2}}{2}<e<1\) 时存在.
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item \(C_1\) 是圆，\(C_2\) 是椭圆，且 \(a=3\)，\(b=1\).
\item 四边形 \(A_1A_2B_2B_1\) 的面积为 \(\dfrac{2}{5}\).
\end{enumerate}
\end{solution}
