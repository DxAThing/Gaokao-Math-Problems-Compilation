...
\begin{solution}
\begin{enumerate}
\item 定义域为 \(\left\{x \in \R \middle| x \ne \frac{\pi}{8} + \frac{k\pi}{2},\ k \in \Z\right\}\)，最小正周期为 \(\frac{\pi}{2}\).
\item \(\alpha = \frac{\pi}{12}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\item \(\frac{7}{10}\).
\end{enumerate}
\item \(P(X=0)=\frac{9}{100}\)，\(P(X=1)=\frac{21}{50}\)，\(P(X=2)=\frac{49}{100}\)，\(E(X)=\frac{7}{5}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item 在 \(\left(0,\frac{\sqrt{2a}}{2a}\right)\) 上单调递增，在 \(\left(\frac{\sqrt{2a}}{2a},+\infty\right)\) 上单调递减.
\item 存在 \(x_{0} \in (2,+\infty)\)，使 \(f(x_{0})=f\left(\frac{3}{2}\right)\).
\item \(\frac{\ln 3 - \ln 2}{5} \leqslant a \leqslant \frac{\ln 2}{3}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item \(a_{3}=-3\)，\(a_{4}=-5\)，\(a_{5}=4\).
\item \(c_{n}=(-1)^{n}\)，故 \(\{c_{n}\}\) 是等比数列.
\item \(\displaystyle\sum_{k=1}^{n}\frac{S_{k}}{a_{k}}<\frac{7}{6}\).
\end{enumerate}
\end{solution}
\end{problem}
...
\begin{enumerate}
\item \(e=\frac{1}{2}\).
\item \(18x^{2}-16\sqrt{3}xy-15y^{2}-15=0\)，且 \(x>0\).
\end{enumerate}
\end{solution}
\end{problem}
