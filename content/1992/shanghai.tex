...
\begin{center}
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1992/shanghai/q11_optA.png}\hfill
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1992/shanghai/q11_optB.png}
\par
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1992/shanghai/q11_optC.png}\hfill
\choicebitmap[max width=0.42\linewidth,max totalheight=3.6cm]{img/1992/shanghai/q11_optD.png}
\end{center}
...
所以 \(\lim_{n \to \infty} \frac{S_n}{G_n} = \frac{\lim_{n \to \infty} S_n}{\lim_{n \to \infty} G_n} = \frac{1 + q}{a}\). 综上，当 \(q = 1\) 时，\(\lim_{n \to \infty} \frac{S_n}{G_n} = \frac{1}{a}\)；当 \(0 < q < 1\) 时，\(\lim_{n \to \infty} \frac{S_n}{G_n} = \frac{1 + q}{a}\).
