...
\bitmapfigure[max width=0.42\linewidth,max totalheight=4.8cm]{img/2026/shanghai_spring/q10_fig1.png}
...
\begin{problem}
已知椭圆 \(\Gamma_1:\dfrac{x^2}{a^2}+y^2=1\,(a>1)\) 与椭圆 \(\Gamma_2:\dfrac{x^2}{b^2+2}+\dfrac{y^2}{b^2}=1\) 相交于 \(A\)，\(B\)，\(C\)，\(D\) 四点，且 \(\Gamma_1\) 和 \(\Gamma_2\) 的四个焦点在同一个圆上，则 \(b^2=\fillinblank{}.\)
...
\[
\frac{x^2}{b^2+2}+\frac{y^2}{b^2}=1,\qquad x^2+y^2=2
\]
从而 \(b^2=3\).
\end{solution}
...
\bitmapfigure[max width=0.55\linewidth,max totalheight=4.8cm]{img/2026/shanghai_spring/q12_fig1.png}
...
\begin{solution}
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.0cm]{img/2026/shanghai_spring/q12_solution_fig1.png}
...
\choices
    {\choicebitmap[max width=3.0cm,max totalheight=3.2cm]{img/2026/shanghai_spring/q15_choice_a.png}}
    {\choicebitmap[max width=3.0cm,max totalheight=3.2cm]{img/2026/shanghai_spring/q15_choice_b.png}}
    {\choicebitmap[max width=3.0cm,max totalheight=3.2cm]{img/2026/shanghai_spring/q15_choice_c.png}}
    {\choicebitmap[max width=3.0cm,max totalheight=3.2cm]{img/2026/shanghai_spring/q15_choice_d.png}}
...
\begin{solution}
原图形上下两条边分别是两条开口向下的抛物线，平移对称后应保持关于 \(x\) 轴的对应关系. 对照四个选项，只有 \(\mathrm{A}\) 与“中点在 \(x\) 轴上”的平移对称结果一致，故选 \(\mathrm{A}\).
\end{solution}
...
\begin{solution}
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.0cm]{img/2026/shanghai_spring/q18_solution_fig1.png}
...
\[
\frac{\pi}{4}+2\pi\cdot675<\frac{4052\pi}{3}+\varphi,\qquad
\frac{3\pi}{4}+2\pi\cdot675\ge\frac{4052\pi}{3}+\varphi
\]
解得 \(0<\varphi\le\dfrac{\pi}{12}\). 当 \(\dfrac{\pi}{4}<\varphi\le\dfrac{3\pi}{4}\) 时，同理需满足
\[
\frac{3\pi}{4}+2\pi\cdot675<\frac{4052\pi}{3}+\varphi,\qquad
\frac{9\pi}{4}+2\pi\cdot675\ge\frac{4052\pi}{3}+\varphi
\]
...
\bitmapfigure[max width=0.55\linewidth,max totalheight=5.0cm]{img/2026/shanghai_spring/q20_solution_fig1.png}
...
\[
y_1+y_2=\frac{-2nm}{n^2-1},\qquad y_1y_2=\frac{m^2-2}{n^2-1}
\]
