...
\begin{problem}
\(\displaystyle\lim_{n\to\infty}\frac{5n^2-1}{2n^2-n+5}\) 的值为（\quad）
...
\begin{problem}
参数方程 \(x=\cos\frac{\theta}{2}+\sin\frac{\theta}{2},\ y=\frac{1}{2}(1+\sin\theta)\)（\(0<\theta<2\pi\)）表示（\quad）
...
\bitmapfigure[max width=0.62\linewidth,max totalheight=4.8cm]{img/1993/jing_xiang_e_yun_qiong_gui_science/q23_fig1.png}
