...
\begin{problem}
不等式 \((x - 1)(x - 3) < 0\) 的解集为\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=6.0cm,max totalheight=4.8cm]{img/2025/shanghai/q7_fig1.png}
...
\begin{problem}
已知 \(a,b>0,\ a+b=1\)，则 \(\frac1a+\frac1b\) 的最小值为\fillinblank{}.
\end{problem}
...
\begin{problem}
已知复数 \(z\) 满足 \(z^2=(\bar z)^2\)，\(|z|\le1\)，则 \(|z-2-3\i|\) 的最小值是\fillinblank{}.
\end{problem}
...
\bitmapfigure[max width=6.0cm,max totalheight=4.8cm]{img/2025/shanghai/q11_fig1.png}
...
\bitmapfigure[max width=6.0cm,max totalheight=4.8cm]{img/2025/shanghai/q18_fig1.png}
