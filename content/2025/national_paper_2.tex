...
\(y^2=4x\)，
其准线方程为 \(x=-1\).
\bitmapfigure[max width=3.8cm]{img/2025/national_paper_2/q6_solution_fig1.png}
...
\bitmapfigure[max width=3.8cm]{img/2025/national_paper_2/q11_solution_fig1.png}
由双曲线的中心对称性，四边形 \(A_1MA_2N\) 是平行四边形，所以
\[
\angle A_1MA_2=\pi-\angle NA_1M=\pi-\frac{5\pi}{6}=\frac{\pi}{6}
\]
故 A 正确.
\bitmapfigure[max width=3.6cm]{img/2025/national_paper_2/q11_solution_fig2.png}
...
\bitmapfigure[max width=4.2cm]{img/2025/national_paper_2/q14_fig1.png}
\end{solution}
\section{解答题}
...
\(x=t(y+2)\)，
\bitmapfigure[max width=4.0cm]{img/2025/national_paper_2/q16_solution_fig1.png}
...
\bitmapfigure[max width=4.0cm]{img/2025/national_paper_2/q17_solution_fig1.png}
由题意可得
