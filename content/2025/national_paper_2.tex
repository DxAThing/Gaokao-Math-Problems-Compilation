...
\(y^2=4x\)，
其准线方程为 \(x=-1\).
\solutionfigure{\bitmapfigure[max width=3.8cm]{img/2025/national_paper_2/q6_solution_fig1.png}}
...
此时 \(a_5=a_1q^4=4\cdot\left(\frac12\right)^4=\frac14\)，故 B 错误.
又
\[
...
\solutionfigure{\bitmapfigure[max width=3.8cm]{img/2025/national_paper_2/q11_solution_fig1.png}}
由双曲线的中心对称性，四边形 \(A_1MA_2N\) 是平行四边形，所以
\[
\angle A_1MA_2=\pi-\angle NA_1M=\pi-\frac{5\pi}{6}=\frac{\pi}{6}
\]
故 A 正确.
\FigureLayoutDeclare{img/2025/national_paper_2/q11_solution_fig2.png}{5.2cm}{7.002bp 7.002bp 7.002bp 7.002bp}
\solutionfigure{\bitmapfigure[max width=3.6cm]{img/2025/national_paper_2/q11_solution_fig2.png}}
...
\solutionfigure{\bitmapfigure[max width=4.2cm]{img/2025/national_paper_2/q14_fig1.png}}
\end{solution}
\section{解答题}
...
\begin{solution}
\begin{enumerate}
\item 由 \(f(0)=\cos\varphi=\frac12\)，且 \(0\le \varphi<\pi\)，可得
\(\varphi=\frac{\pi}{3}\).
...
\begin{solution}
\begin{enumerate}
\item 由长轴长为 4，得 \(a=2\). 又离心率为 \(\frac{\sqrt2}{2}\)，所以
...
\item 由题设直线 \(AB\) 的斜率不为 0，设直线 \(l\) 的方程为
\(x=t(y+2)\)，
\solutionfigure{\bitmapfigure[max width=4.0cm]{img/2025/national_paper_2/q16_solution_fig1.png}}
...
\begin{solution}
\begin{enumerate}
\item 设 \(AD=1\)，则 \(AB=3\)，\(CD=2\). 因为 \(F\) 为 \(CD\) 的中点，所以 \(DF=1\). 又因为 \(EF//AD\)，\(AB//CD\)，所以 \(AEFD\) 是平行四边形，从而 \(AE//DF\). 翻折后仍有 \(A'E//D'F\).
...
\item 以 \(F\) 为原点，\(FE\)，\(FC\) 以及垂直于平面 \(EFCB\) 的直线分别为 \(x\)，\(y\)，\(z\) 轴，建立空间直角坐标系.
\solutionfigure{\bitmapfigure[max width=4.0cm]{img/2025/national_paper_2/q17_solution_fig1.png}}
由题意可得
...
\item 由（1）知 \(g(t)\) 在 \((0,x_1)\) 上单调递减，所以
\(g(0)>g(x_1)\).
即
\(0>f(2x_1)\).
...
\begin{solution}
\begin{enumerate}
\item 打完 3 个球后甲比乙至少多得 2 分，只能是甲胜 3 场，所以
\(p_3=p^3\).
...
\item 打完 3 个球后乙比甲至少多得 2 分，只能是乙胜 3 场，所以
\(q_3=q^3\).
...
\[
\begin{gathered}
p_{2m+2}-p_{2m}=(p_{2m+2}-p_{2m+1})-(p_{2m}-p_{2m+1})=\binom{2m+1}{m}p^{m+2}q^m-\binom{2m}{m-1}p^{m+1}q^m,\\
p_{2m+2}-p_{2m}=p^mq^m\cdot p\left(p\binom{2m+1}{m}-\binom{2m}{m-1}\right)=\frac{(2m+1)!}{m!(m+1)!}p^mq^m\cdot p\left(p-\frac{m}{2m+1}\right)
\end{gathered}
\]
同理
...
\[
\begin{gathered}
(p_{2m+2}-p_{2m})-(q_{2m+2}-q_{2m})=\frac{(2m+1)!}{m!(m+1)!}p^mq^m\left[p\left(p-\frac{m}{2m+1}\right)-q\left(q-\frac{m}{2m+1}\right)\right],\\
(p_{2m+2}-p_{2m})-(q_{2m+2}-q_{2m})=\frac{(2m+1)!}{m!(m+1)!}p^mq^m\cdot \frac{m+1}{2m+1}(p-q)>0
\end{gathered}
\]
因此
