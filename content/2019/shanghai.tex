...
\begin{center}
\bitmapinclude[max width=3.6cm,max totalheight=4.2cm]{img/2019/shanghai/q5_fig1.png}
\end{center}
...
\end{solution}
\begin{problem}
已知数列 \(\{a_n\}\) 满足 \(a_n<a_{n+1}\)（\(n\in\N^*\)），\(P_n(n,a_n)\) 在双曲线 \(\frac{x^2}{6}-\frac{y^2}{2}=1\) 上，则 \(\lim_{n\to\infty}|P_nP_{n+1}|=\)\fillinblank{}. 
...
于是 \(|P_nP_{n+1}|=\sqrt{1+(a_{n+1}-a_n)^2}\). 当 \(n\to\infty\) 时，\(a_{n+1}-a_n\to\frac1{\sqrt3}\)，故 \(\lim_{n\to\infty}|P_nP_{n+1}|=\sqrt{1+\frac13}=\frac{2\sqrt3}{3}\).
故答案为 \(\frac{2\sqrt3}{3}\).
\end{solution}
\begin{problem}
...
\begin{center}
\bitmapinclude[max width=4.2cm,max totalheight=4.8cm]{img/2019/shanghai/q17_fig1.png}
\end{center}
\end{problem}
...
\begin{center}
\bitmapinclude[max width=4.2cm,max totalheight=4.8cm]{img/2019/shanghai/q19_fig1.png}
\end{center}
\end{problem}
