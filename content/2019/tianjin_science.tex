...
\begingroup
\bitmapfigure[float=inline,max width=7.8cm]{img/2019/tianjin_science/q14_fig1.png}
\endgroup
\FloatBarrier
\begin{answer}
\(-1\)
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(\cos B=\dfrac14\).
\item 短答案：\(\sin\left(2B+\dfrac\pi6\right)=\dfrac{3\sqrt5+7}{16}\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(P(X=0)=\dfrac1{27}\)，\(P(X=1)=\dfrac29\)，\(P(X=2)=\dfrac49\)，\(P(X=3)=\dfrac8{27}\)，\(E(X)=2\).
\item 短答案：\(P(M)=\dfrac{20}{243}\).
\end{enumerate}
\end{solution}
...
\FigureLayoutDeclare{img/2019/tianjin_science/q17_fig1.png}{10.5cm}{37bp 45bp 42bp 27bp}
\begingroup
\bitmapfigure[float=inline,max width=8.5cm]{img/2019/tianjin_science/q17_fig1.png}
\endgroup
\FloatBarrier
\end{problem}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(BF\parallel\) 平面 \(ADE\).
\item 短答案：直线 \(CE\) 与平面 \(BDE\) 所成角的正弦值为 \(\dfrac49\).
\item 短答案：\(CF=\dfrac87\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：椭圆方程为 \(\dfrac{x^2}{5}+\dfrac{y^2}{4}=1\).
\item 短答案：直线 \(PB\) 的斜率为 \(\dfrac{2\sqrt{30}}5\) 或 \(-\dfrac{2\sqrt{30}}5\).
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(a_n=3n+1\)，\(b_n=3\cdot2^n\).
\item
\begin{enumerate}
\item 短答案：\(a_{2^n}(c_{2^n}-1)=9\cdot4^n-1\).
\item 短答案：\(\displaystyle\sum_{i=1}^{2^n}a_ic_i=27+2^{2n-1}+5\cdot2^{n-1}-n-12\).
\end{enumerate}
\end{enumerate}
\end{solution}
...
\begin{solution}
\begin{enumerate}
\item 短答案：\(f(x)\) 的单调递增区间为 \(\left[2k\pi-\dfrac{3\pi}{4},2k\pi+\dfrac\pi4\right]\)（\(k\in\Z\)），单调递减区间为 \(\left[2k\pi+\dfrac\pi4,2k\pi+\dfrac{5\pi}{4}\right]\)（\(k\in\Z\)）.
\item 短答案：题中不等式成立.
\item 短答案：题中不等式成立.
\end{enumerate}
\end{solution}
