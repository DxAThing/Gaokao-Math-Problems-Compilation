...
\bitmapfigure[float=inline,max width=5.0cm]{img/2019/national_paper_1_science/q4_fig1.png}
...
\bitmapfigure[float=inline,max width=6.0cm]{img/2019/national_paper_1_science/q8_fig1.png}
...
\end{enumerate}
\bitmapfigure[max width=3.5cm]{img/2019/national_paper_1_science/q18_fig1.png}
\end{problem}
