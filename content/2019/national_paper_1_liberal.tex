...
\[
S_n=\frac{n}{2}\bigl(2a_1+(n-1)d\bigr)=\frac{d}{2}n(n-9),
\qquad a_n=a_1+(n-1)d=(n-5)d.
\]
因此
\[
S_n\ge a_n
...
\item 建立空间直角坐标系，使
\[
A=(0,0,0),\quad B=(2,0,0),\quad D=(1,\sqrt3,0),\quad C=(3,\sqrt3,0).
\]
因为四棱柱为直四棱柱且 \(AA_1=4\)，所以
\[
C_1=(3,\sqrt3,4),\quad E=\left(\frac52,\frac{\sqrt3}{2},0\right),\quad M=(2,0,2),\quad N=\left(\frac12,\frac{\sqrt3}{2},2\right).
\]
于是
\[
\overrightarrow{DE}=\left(\frac32,-\frac{\sqrt3}{2},0\right),\qquad
\overrightarrow{MN}=\left(-\frac32,\frac{\sqrt3}{2},0\right)=-\overrightarrow{DE}.
\]
...
\[
g\left(\frac\pi2\right)=\frac\pi2-1>0,
\qquad g(\pi)=-2<0.
\]
...
同理可得
\[
(b+c)^3\ge8(bc)^{3/2},\qquad (c+a)^3\ge8(ca)^{3/2}.
\]
相加得
\[
(a+b)^3+(b+c)^3+(c+a)^3
